...
public class GlobalVariable {
    ...
    /**
     * <p>Profile CCDC_PROD : This variable holds the location of the input excel file which has the locators to be read from
...
Profile CCDC_STAGE : This variable holds the location of the input excel file which has the locators to be read from</p>
    ...
    /**
     * <p>Profile CCDC_PROD : This is the path where the browserdriver is stored - for Chromedriver, Geckodrive, IEdriver etc
