...
public class GlobalVariable {
    ...
    /**
     * <p>Profile CDS_QA : This variable holds the location of the input excel file which has the locators to be read from</p>
     */
    public static Object G_InputExcelFileName
     
    /**
     * <p>Profile CDS_QA : This is the path where the browserdriver is stored - for Chromedriver, Geckodrive, IEdriver etc</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This can be modified to any environment - qa&#47;dev&#47;staging</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This variable stores the Neo4J database's server url at runtime</p>
     */
    public static Object G_server
     
    /**
     * <p>Profile CDS_QA : This variable stores the Neo4J database's username at runtime</p>
     */
    public static Object G_UserId
     
    /**
     * <p>Profile CDS_QA : This variable stores the Neo4J database's password at runtime</p>
     */
    public static Object G_Password
     
    /**
     * <p>Profile CDS_QA : This variable stores the path of the output file onto which the data is written from Ne04j</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This variable stores at runtime, the Cypher Query from Input Excel, used to fetch data from Neo4J for a specific criteria</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This variable holds the value of the filename of the input file attached to each test case</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This contains the name of the element as stored in Katalon's obj rep</p>
     */
    public static Object G_ObjectType
     
    /**
     * <p>Profile CDS_QA : This is for Katalon </p>
     */
    public static Object G_dbexcel
     
    /**
     * <p>Profile CDS_QA : This is the value for Bento</p>
     */
    public static Object G_rowcount_Katalon
     
    /**
     * <p>Profile CDS_QA : This variable holds the value of Cases count from Stat Bar in UI.</p>
     */
    public static Object G_StatBar_Cases
     
    /**
     * <p>Profile CDS_QA : This variable holds the value of Files count from Stat Bar in UI.</p>
     */
    public static Object G_StatBar_Files
     
    /**
     * <p>Profile CDS_QA : This variable holds the value of Samples count from Stat Bar in UI.</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This is the count from case details table</p>
     */
    public static Object G_rowcountFiles
     
    /**
     * <p>Profile CDS_QA : This variable contains the output tab name for stat bar counts from the case details page of a specific case ID</p>
     */
    public static Object G_CaseDetailStatTabname
     
    /**
     * <p>Profile CDS_QA : This variable contains the neo4j query to fetch case detail level stat data</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This holds the value of stat bar for assays</p>
     */
    public static Object G_StatBar_Assays
     
    /**
     * <p>Profile CDS_QA : This holds the value of stat bar for arms</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : contains the renamed manifest file's full path + name with csv extension</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This is the value of browser chosen at runtime to execute the test script</p>
     */
    public static Object execBrowser
     
    /**
     * <p>Profile CDS_QA : This is the value of the sheet name in the downloaded and renamed Manifest file converted to xls format</p>
     */
    public static Object G_ManifestTabName
     
    /**
     * <p>Profile CDS_QA : This is the variable holding the filename and full path of the converted .xls file</p>
     */
    ...
    /**
     * <p>Profile CDS_QA : This is the variable holding the filename and full path of the converted .xlsx file</p>
     */
    public static Object G_xlsxFilename
     
    /**
     * <p>Profile CDS_QA : This variable contains the current test case name</p>
     */
