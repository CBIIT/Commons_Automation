...
Profile CCDI_QA - Jenkins : This variable holds the location of the input excel file which has the locators to be read from
...
Profile CCDI_QA - Jenkins : This is the path where the browserdriver is stored - for Chromedriver, Geckodrive, IEdriver etc
...
Profile CCDI_QA - Jenkins : This can be modified to any environment - qa&#47;dev&#47;staging
...
Profile CCDI_QA - Jenkins : This variable stores the Neo4J database's server url at runtime
...
Profile CCDI_QA - Jenkins : This variable stores the Neo4J database's username at runtime
...
Profile CCDI_QA - Jenkins : This variable stores the Neo4J database's password at runtime
...
Profile CCDI_QA - Jenkins : This variable stores the path of the output file onto which the data is written from Ne04j
...
Profile CCDI_QA - Jenkins : This variable stores at runtime, the Cypher Query from Input Excel, used to fetch data from Neo4J for a specific criteria
...
Profile CCDI_QA - Jenkins : This variable holds the value of the filename of the input file attached to each test case
...
Profile CCDI_QA - Jenkins : This contains the name of the element as stored in Katalon's obj rep
...
Profile CCDI_QA - Jenkins : This is for Katalon 
...
Profile CCDI_QA - Jenkins : This is for the Cases tab and Samples tab which have 12 cols.  There is a separate variable for Files tab which has 10 cols
...
Profile CCDI_QA - Jenkins : This variable holds the value of Programs count from Stat Bar in UI
...
Profile CCDI_QA - Jenkins : This variable holds the value of Studies count from Stat Bar in UI
...
Profile CCDI_QA - Jenkins : This variable holds the value of Cases count from Stat Bar in UI.
...
Profile CCDI_QA - Jenkins : This variable holds the value of Samples count from Stat Bar in UI.
...
Profile CCDI_QA - Jenkins : This variable holds the value of Files count from Stat Bar in UI.
...
Profile CCDI_QA - Jenkins : This global variable holds the value of study files
...
Profile CCDI_QA - Jenkins : This variable contains the output tab name for stat bar counts from the case details page of a specific case ID
...
Profile CCDI_QA - Jenkins : Name of the current test script
...
Profile CCDI_QA - Jenkins : This flag specifies whether the script needs manifest file rename or not.
...
Profile CCDI_QA - Jenkins : This is the value of browser chosen at runtime to execute the test script
...
Profile CCDI_QA - Jenkins : Path where manifest is saved
...
Profile CCDI_QA - Jenkins : This contains the name of the recent manifest with timestamp which is to be renamed
...
Profile CCDI_QA - Jenkins : This variable holds the xpath of table which is to be read only for specific columns
...
Profile CCDI_QA - Jenkins : This variable contains the xpath of table body to be read by chosen column headers
...
Profile CCDI_QA - Jenkins : this holds the file name after csv to xls conversion of the downloaded manifest
...
Profile CCDI_QA - Jenkins : This variable holds the full path and filename of a manifest convereted from xls to xlsx
...
Profile CCDI_QA - Jenkins : dummy variable added due toINS profile
...
Profile CTDC_QA - Jenkins : This variable holds the value of Files count from Stat Bar in UI.</p>
     ...
     * <p></p>
     */
    public static Object G_CypherTabnameGrants
     
    /**
     * <p></p>
     */
    public static Object G_QueryGrantsTab
    ...
    static {
        try {
            ...
            G_CypherTabnameGrants = selectedVariables['G_CypherTabnameGrants']
            G_QueryGrantsTab = selectedVariables['G_QueryGrantsTab']
