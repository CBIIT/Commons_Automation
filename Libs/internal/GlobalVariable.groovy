...
public class GlobalVariable {
    ...
    /**
     * <p>Profile C3DC_QA : This variable holds the location of the input excel file which has the locators to be read from
Profile CCDC_QA : This variable holds the location of the input excel file which has the locators to be read from</p>
    ...
    /**
     * <p>Profile C3DC_QA : This is the path where the browserdriver is stored - for Chromedriver, Geckodrive, IEdriver etc
