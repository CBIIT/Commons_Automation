...
index_columns = {
    ...
    'specimen': 'specimen_record_id',
    'exposure': 'exposure_record_id',
    'targeted_therapy': 'targeted_therapy_record_id',
    'non_targeted_therapy': 'non_targeted_therapy_record_id',
    'participant_status': 'participant_status_record_id',
    'file': 'data_file_uuid'
}
...
df_biospecimen = dataframes['specimen']
df_exposure = dataframes['exposure']
df_targeted_therapy = dataframes['targeted_therapy']
df_non_targeted_therapy = dataframes['non_targeted_therapy']
df_participant_status = dataframes['participant_status']
...
print("\nDataFrame: df_biospecimen")
print(df_biospecimen)

print("\nDataFrame: df_exposure")
print(df_exposure)

print("\nDataFrame: df_targeted_therapy")
print(df_targeted_therapy)

print("\nDataFrame: df_non_targeted_therapy")
print(df_non_targeted_therapy)

print("\nDataFrame: df_participant_status")
print(df_participant_status)
