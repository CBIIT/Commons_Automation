...
public class DataValidation {
	...
	public static FindingBrokenURLs () {
		...
		List<WebElement> AdditionalDataLinks=driver.findElements(By.xpath("//*[@class='additionalDataLinks']"))
		List<WebElement> dataElementContentPublished=driver.findElements(By.xpath("//*[@class='dataElementContentPublished']/div/a"))
		List<WebElement> ResourceLinks=driver.findElements(By.xpath("//*[@class='prDetailExternalLink']"))
		List<WebElement> ResourceHeaderLinks= driver.findElements(By.xpath("//*[@class='prDetailHeaderLink']"))
		List<WebElement> AddDataLabeLinks=driver.findElements(By.xpath("//div[@class='prDataAccessContainer'][.//div[@class='prAdditionalDataLabel' and normalize-space()='Data Access']]//a"))
