...
public class PythonReader {
	 ...
	 */
	@Keyword
	public static void compareLists(String pythonFileName, List<List<XSSFCell>> l1, List<List<XSSFCell>> l2) {
		...
		try {
			// Create a process builder
			ProcessBuilder processBuilder = new ProcessBuilder(binPath, pyPath, pyPath, l1, l2);
			processBuilder.redirectErrorStream(true);
			KeywordUtil.logInfo("Executing Python file: " + pythonFileName);
