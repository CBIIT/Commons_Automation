...
<WebServiceRequestEntity>
   <description>GET single property — /model/.../node/.../property/{propHandle}</description>
   <name>GetNodeProperty</name>
   <tag></tag>
   <elementGuidId>7e6d5c4b-3a2f-1e0d-9c8b-7a654321fedc</elementGuidId>
   ...
   <restUrl>${GlobalVariable.baseUrl}/model/${modelHandle}/version/${versionString}/node/${nodeHandle}/property/${propHandle}</restUrl>
