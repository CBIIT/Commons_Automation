...
<WebServiceRequestEntity>
   ...
   <name>GetNodePropertyTerms</name>
   <tag></tag>
   <elementGuidId>4ab1fbf8-73b9-4507-ba7d-e48d1fc28856</elementGuidId>
   ...
   <restUrl>${GlobalVariable.baseUrl}/model/${modelHandle}/version/${versionString}/node/${nodeHandle}/property/${propHandle}/terms</restUrl>
