...
<WebServiceRequestEntity>
   <description>GET single node — /model/{modelHandle}/version/{versionString}/node/{nodeHandle}</description>
   <name>GetModelNode</name>
   <tag></tag>
   <elementGuidId>8f3a2b1c-9d8e-7f6a-5b4c-3d2e1f0a9b8c</elementGuidId>
   ...
   <restUrl>${GlobalVariable.baseUrl}/model/${modelHandle}/version/${versionString}/node/${nodeHandle}</restUrl>
