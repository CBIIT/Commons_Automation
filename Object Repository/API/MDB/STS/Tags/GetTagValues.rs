...
<WebServiceRequestEntity>
   <description>GET /tag/{tagKey}/values — full list for parity (no skip/limit in test)</description>
   <name>GetTagValues</name>
   <tag></tag>
   <elementGuidId>121b790b-03a9-48aa-8292-7bb3e2aabf5d</elementGuidId>
   ...
   <restUrl>${GlobalVariable.baseUrl}/tag/${tagKey}/values</restUrl>
