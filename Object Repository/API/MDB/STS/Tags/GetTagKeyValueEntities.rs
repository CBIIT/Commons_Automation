...
<WebServiceRequestEntity>
   <description>GET /tag/{tagKey}/{tagValue}/entities — parity (no skip/limit in test)</description>
   <name>GetTagKeyValueEntities</name>
   <tag></tag>
   <elementGuidId>221b790b-03a9-48aa-8292-7bb3e2aabf5d</elementGuidId>
   ...
   <restUrl>${GlobalVariable.baseUrl}/tag/${tagKey}/${tagValue}/entities</restUrl>
