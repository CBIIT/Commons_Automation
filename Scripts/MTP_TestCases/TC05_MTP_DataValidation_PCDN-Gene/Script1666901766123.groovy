...
//click enter
//then click Search
System.out.println('This is the value of Target Name from input test data to be entered in the input field : ' + ipTargName)
WebUI.verifyElementPresent(findTestObject('Object Repository/MTP/PCDNPage/GeneSymb_Input'), 5, FailureHandling.OPTIONAL)
WebUI.setText(findTestObject('Object Repository/MTP/PCDNPage/GeneSymb_Input'), ipTargName)  

Thread.sleep(2000)
WebUI.sendKeys(findTestObject('Object Repository/MTP/PCDNPage/GeneSymb_Input'), Keys.chord(Keys.ENTER))
System.out.println('Target Name entered')
...
System.out.println("This is the total count of diseases from UI : "+webResultsCnt)
System.out.println('This is the value of Disease count from input test data :' + ipResultsCnt)
