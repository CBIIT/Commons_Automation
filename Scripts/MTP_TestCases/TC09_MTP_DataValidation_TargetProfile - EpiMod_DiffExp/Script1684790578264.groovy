...
webDiffExpWdgt = WebUI.verifyElementPresent(findTestObject('Object Repository/MTP/TargetProfilePage/diffExp_Wdgt'), 30)
Thread.sleep(3000)
...
webEpiModWdgt = WebUI.verifyElementPresent(findTestObject('Object Repository/MTP/TargetProfilePage/epiModif_Wdgt'), 10)
...
//	System.out.println('****Scrolled to Epigenetic Modification - Meth by Isoform  tab****** ')
	boolean webmethByIsoTab = WebUI.verifyElementNotHasAttribute(findTestObject('Object Repository/MTP/TargetProfilePage/methByIso_Tab'),'disabled', 20, FailureHandling.OPTIONAL) 
