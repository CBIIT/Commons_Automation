...
webTargID = WebUI.getText(findTestObject('Object Repository/MTP/EvidencePage/TargetID'))
...
//Step 12--------------------Verifying GeneExp widget ****************************************************************
  ...
  while (webGeneExpWdgtTxt=="Loading...") {
	  WebUI.waitForPageLoad(10, FailureHandling.OPTIONAL)
	  webGeneExpWdgtTxt = WebUI.getText(findTestObject('Object Repository/MTP/EvidencePage/GeneExp_Wdgt'))
	  System.out.println('This is the text of Differential Expression widget obtained from UI :' + webGeneExpWdgtTxt)
  }
