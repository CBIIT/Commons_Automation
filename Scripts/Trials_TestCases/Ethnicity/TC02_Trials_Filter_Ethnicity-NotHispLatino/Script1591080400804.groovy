...
/*This test script:
  ...
  - Clicks on the Filter 'Ethnicity' from left pane
  - Selects the specific check box from 'Ethnicity' filter.
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_Trials_Filter_Ethnicity-NotHispLatino.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Trials/Filter/Ethnicity/NotHispLatino_Chkbx')
