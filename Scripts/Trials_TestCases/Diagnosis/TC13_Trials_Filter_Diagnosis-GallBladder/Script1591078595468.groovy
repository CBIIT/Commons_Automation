...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC13_Trials_Filter_Diagnosis-GallBladder.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/GallBladder_Chkbx'))
