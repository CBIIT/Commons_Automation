...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC15_Trials_Filter_Diagnosis-InvasiveBrst.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/InvasiveBrCarcinoma_Chkbx'))
