...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC08_Trials_Filter_Diagnosis-CarcinoUterus.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/CarcinoUterus_Chkbx'))
