...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC20_Trials_Filter_Diagnosis-Parathyroid.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/Parathyroid_Chkbx'))
