...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC04_Trials_Filter_Diagnosis-AdenoRectum.xlsx')
...
WebUI.click(findTestObject('Object Repository/Trials/Filter/Diagnosis/AdenoRectum_Chkbx') )
