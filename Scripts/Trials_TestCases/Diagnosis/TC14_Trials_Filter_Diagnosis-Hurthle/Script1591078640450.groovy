...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC14_Trials_Filter_Diagnosis-Hurthle.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/HurthleCell_Chkbx'))
