...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC07_Trials_Filter_Diagnosis-BoneCancer.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/BoneCancer_Chkbx'))
