...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC12_Trials_Filter_Diagnosis-FemaleReprod.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/FemaleReprod_Chkbx'))
