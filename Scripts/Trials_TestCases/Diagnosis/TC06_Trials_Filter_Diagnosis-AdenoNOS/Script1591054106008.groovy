...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC06_Trials_Filter_Diagnosis-AdenoNOS.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/AdenoCarcinomaNOS_Chkbx'))
