...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC05_Trials_Filter_Diagnosis-AdenoIntestine.xlsx')
...
WebUI.click( findTestObject('Object Repository/Trials/Filter/Diagnosis/AdenoIntestine_Chkbx'))
