...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC26_Trials_Filter_Diagnosis-UterineCancer.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/UterineCancer_Chkbx'))
