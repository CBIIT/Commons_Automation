...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC10_Trials_Filter_Diagnosis-Colorectal.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/Colorectal_Chkbx'))
