...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC21_Trials_Filter_Diagnosis-Prostate.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/Prostate_Chkbx'))
