...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC09_Trials_Filter_Diagnosis-Cholangio.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/Cholangio_Chkbx'))
