...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC19_Trials_Filter_Diagnosis-Ovarian.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/OvarianEpith_Chkbx'))
