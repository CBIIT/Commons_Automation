...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC18_Trials_Filter_Diagnosis-LungCancer.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/LungCancer_Chkbx'))
