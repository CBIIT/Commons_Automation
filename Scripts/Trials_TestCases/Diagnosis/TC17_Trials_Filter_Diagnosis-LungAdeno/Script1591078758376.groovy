...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC17_Trials_Filter_Diagnosis-LungAdeno.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/LungAdeno_Chkbx'))
