...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC11_Trials_Filter_Diagnosis-Endometrioid.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/Diagnosis/Endometrioid_Chkbx'))
