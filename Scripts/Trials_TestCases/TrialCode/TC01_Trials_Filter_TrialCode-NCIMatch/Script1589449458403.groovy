...
/*This test script:
  ...
  - Clicks on the Filter 'Trial Code' from left pane
  - Selects the specific check box from 'Trial Code' filter.
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_Trials_Filter_TrialCode-NCIMatch.xlsx')
