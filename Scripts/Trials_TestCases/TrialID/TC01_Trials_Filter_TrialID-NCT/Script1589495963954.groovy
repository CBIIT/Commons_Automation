...
/*This test script:
  ...
  - Clicks on the Filter 'Trial ID' from left pane
  - Selects the specific check box from 'Trial ID' filter.
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_Trials_Filter_TrialID-NCT.xlsx')
