...
/*This test script:
  ...
  - Clicks on the Filter 'Associated File Format' from left pane
  - Selects the specific check box from 'Associated File Format' filter.
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_Trials_Filter_AssocFileFormat-Bam.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Trials/Filter/AssocFileFormat/ASSOCFILEFORMAT_Ddn'), 5)

WebUI.click(findTestObject('Trials/Filter/AssocFileFormat/ASSOCFILEFORMAT_Ddn'))

WebUI.click(findTestObject('Trials/Filter/AssocFileFormat/Bam_Chkbx'))
