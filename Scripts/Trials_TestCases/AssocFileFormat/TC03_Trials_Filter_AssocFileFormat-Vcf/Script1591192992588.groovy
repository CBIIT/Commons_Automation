...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC03_Trials_Filter_AssocFileFormat-Vcf.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/AssocFileFormat/Vcf_Chkbx'))
