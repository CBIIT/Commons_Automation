...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_Trials_Filter_AssocFileType-AlignedDNA.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/AssocFileType/ASSOCFILETYPE_Ddn'))

WebUI.click(findTestObject('Trials/Filter/AssocFileType/AlignedDNA_Chkbx'))
