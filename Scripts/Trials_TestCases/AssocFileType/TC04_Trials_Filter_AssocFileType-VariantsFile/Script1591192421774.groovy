...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC04_Trials_Filter_AssocFileType-VariantsFile.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/AssocFileType/Variants_Chkbx'))
