...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_Trials_Filter_AssocFileType-AlignedRNA.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/AssocFileType/AlignedRNA_Chkbx'))
