...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC03_Trials_Filter_AssocFileType-IndexFile.xlsx')
...
WebUI.click(findTestObject('Trials/Filter/AssocFileType/Index_Chkbx'))
