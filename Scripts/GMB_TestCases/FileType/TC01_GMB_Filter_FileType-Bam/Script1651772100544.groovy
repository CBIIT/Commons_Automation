...
WebUI.waitForElementPresent(findTestObject('GMB/Filter/FileType/Bam_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/FileType/Bam_Chkbx')
