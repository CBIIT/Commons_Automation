...
//Clicking Index checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/FileType/Index_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/FileType/Index_Chkbx')
