...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_GMB_Filter_SourceOfLabData-Cincinchil.xlsx')
...
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/SourceOfLabData_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/SourceOfLabData_Ddn')

//Clicking (Cincinchil) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Cincinchil_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Cincinchil_Chkbx')
