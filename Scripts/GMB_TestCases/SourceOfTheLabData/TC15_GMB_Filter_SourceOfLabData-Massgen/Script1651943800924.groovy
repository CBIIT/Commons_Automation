...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_GMB_Filter_SourceOfLabData-Massgen.xlsx')
...
//Clicking (Massgen) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Massgen_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Massgen_Chkbx')
