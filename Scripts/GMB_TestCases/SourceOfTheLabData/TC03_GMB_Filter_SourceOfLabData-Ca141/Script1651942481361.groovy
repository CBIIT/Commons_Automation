...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_GMB_Filter_SourceOfLabData-Ca141.xlsx')
...
//Clicking (Ca141) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Ca141_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Ca141_Chkbx')
