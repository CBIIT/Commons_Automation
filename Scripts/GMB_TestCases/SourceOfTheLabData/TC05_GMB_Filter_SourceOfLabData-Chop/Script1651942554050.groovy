...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_GMB_Filter_SourceOfLabData-Chop.xlsx')
...
//Clicking (Chop) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Chop_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Chop_Chkbx')
