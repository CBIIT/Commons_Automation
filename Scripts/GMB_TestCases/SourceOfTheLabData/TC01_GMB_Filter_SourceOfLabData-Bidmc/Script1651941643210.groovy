...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_GMB_Filter_SourceOfLabData-Bidmc.xlsx')
...
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Bidmc_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Bidmc_Chkbx')
