...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_GMB_Filter_SourceOfLabData-Cozad.xlsx')
...
//Clicking (Cozad) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Cozad_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Cozad_Chkbx')
