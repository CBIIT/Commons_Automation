...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_GMB_Filter_SourceOfLabData-Croatia.xlsx')
...
//Clicking (Croatia) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Croatia_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Croatia_Chkbx')
