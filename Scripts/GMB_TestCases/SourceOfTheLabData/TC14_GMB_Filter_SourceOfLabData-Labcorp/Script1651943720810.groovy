...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC14_GMB_Filter_SourceOfLabData-Labcorp.xlsx')
...
//Clicking (Labcorp) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Labcorp_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Labcorp_Chkbx')
