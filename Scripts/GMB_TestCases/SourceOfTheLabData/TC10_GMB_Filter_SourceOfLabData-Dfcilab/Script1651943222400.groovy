...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_GMB_Filter_SourceOfLabData-Dfcilab.xlsx')
...
//Clicking (Dfcilab) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Dfcilab_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Dfcilab_Chkbx')
