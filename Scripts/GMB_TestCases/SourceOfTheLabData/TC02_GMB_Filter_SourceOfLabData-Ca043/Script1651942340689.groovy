...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_GMB_Filter_SourceOfLabData-Ca043.xlsx')
...
//Clicking (Ca043) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Ca043_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Ca043_Chkbx')
