...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_GMB_Filter_SourceOfLabData-Cinj.xlsx')
...
//Clicking (Cinj) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Cinj_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Cinj_Chkbx')
