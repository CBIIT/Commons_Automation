...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_GMB_Filter_SourceOfLabData-Dlm.xlsx')
...
//Clicking (Dlm) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SourceOfLabData/Dlm_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SourceOfLabData/Dlm_Chkbx')
