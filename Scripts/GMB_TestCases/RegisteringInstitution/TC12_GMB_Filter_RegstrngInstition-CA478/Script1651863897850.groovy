...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_GMB_Filter_RegstrngInstition-CA478.xlsx')
...
//Clicking (CA478 : University of California San Francisco) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/CA478_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/CA478_Chkbx')
