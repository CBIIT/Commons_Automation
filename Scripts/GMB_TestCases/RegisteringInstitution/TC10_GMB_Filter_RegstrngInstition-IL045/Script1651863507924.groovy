...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_GMB_Filter_RegstrngInstition-IL045.xlsx')
...
//Clicking (IL045 : Lurie Cancer Center at Northwestern University) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/IL045_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/IL045_Chkbx')
