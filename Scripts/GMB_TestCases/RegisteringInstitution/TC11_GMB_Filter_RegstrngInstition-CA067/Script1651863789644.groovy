...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_GMB_Filter_RegstrngInstition-CA067.xlsx')
...
//Clicking (CA067 : University of California San Diego) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/CA067_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/CA067_Chkbx')
