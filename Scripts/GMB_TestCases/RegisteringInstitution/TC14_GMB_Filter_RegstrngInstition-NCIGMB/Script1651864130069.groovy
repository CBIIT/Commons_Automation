...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC14_GMB_Filter_RegstrngInstition-NCIGMB.xlsx')
...
//Clicking (NCIGMB : National Cancer Institute Genitourinary Malignancy Branch) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/NCIGMB_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/NCIGMB_Chkbx')
