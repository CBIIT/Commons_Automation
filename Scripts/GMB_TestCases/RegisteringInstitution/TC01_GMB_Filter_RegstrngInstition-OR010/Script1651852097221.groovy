...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_GMB_Filter_RegstrngInstition-OR010.xlsx')
...
//Clicking (OR010 : Oregon Health Sciences University) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/OR010_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/OR010_Chkbx')
