...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_GMB_Filter_RegstrngInstition-NY016.xlsx')
...
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/NY016_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/NY016_Chkbx')
