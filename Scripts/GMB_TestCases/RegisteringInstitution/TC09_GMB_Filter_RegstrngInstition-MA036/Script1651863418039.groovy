...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_GMB_Filter_RegstrngInstition-MA036.xlsx')
...
//Clicking (MA036 : Dana Farber Cancer Institute, Boston, MA) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/MA036_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/MA036_Chkbx')
