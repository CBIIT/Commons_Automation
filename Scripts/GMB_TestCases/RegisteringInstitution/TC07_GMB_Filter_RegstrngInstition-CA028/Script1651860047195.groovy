...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_GMB_Filter_RegstrngInstition-CA028.xlsx')
...
//Clicking (NY021 : Mount Sinai Hospital) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/CA028_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/CA028_Chkbx')
