...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_GMB_Filter_RegstrngInstition-WA020.xlsx')
...
//Clicking (WA020 : University of Washington) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/WA020_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/WA020_Chkbx')
