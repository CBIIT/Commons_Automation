...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_GMB_Filter_RegstrngInstition-MA034.xlsx')
...
//Clicking (MA034 : Massachusetts General Hospital, Cancer Center) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/RegstrngInstition/MA034_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/RegstrngInstition/MA034_Chkbx')
