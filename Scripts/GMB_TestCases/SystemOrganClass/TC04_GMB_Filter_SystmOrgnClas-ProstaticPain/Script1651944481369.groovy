...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_GMB_Filter_SystmOrgnClas-ProstaticPain.xlsx')
...
//Clicking (ProstaticPain) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SystmOrgnClas/ProstaticPain_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SystmOrgnClas/ProstaticPain_Chkbx')
