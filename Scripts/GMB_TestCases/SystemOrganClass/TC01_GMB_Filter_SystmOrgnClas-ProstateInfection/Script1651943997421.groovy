...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_GMB_Filter_SystmOrgnClas-ProstateInfection.xlsx')
...
//Clicking (Bidmc) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SystmOrgnClas/ProstateInfection_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SystmOrgnClas/ProstateInfection_Chkbx')
