...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_GMB_Filter_SystmOrgnClas-ProstaticHemorrhage.xlsx')
...
//Clicking (ProstaticHemorrhage) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SystmOrgnClas/ProstaticHemorrhage_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SystmOrgnClas/ProstaticHemorrhage_Chkbx')
