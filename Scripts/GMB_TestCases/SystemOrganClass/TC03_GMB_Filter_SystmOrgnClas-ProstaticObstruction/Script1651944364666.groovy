...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_GMB_Filter_SystmOrgnClas-ProstaticObstruction.xlsx')
...
//Clicking SystemOrganClass drop-down
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SystmOrgnClas/SystmOrgnClas_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SystmOrgnClas/SystmOrgnClas_Ddn')

//Clicking (ProstaticObstruction) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SystmOrgnClas/ProstaticObstruction_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SystmOrgnClas/ProstaticObstruction_Chkbx')
