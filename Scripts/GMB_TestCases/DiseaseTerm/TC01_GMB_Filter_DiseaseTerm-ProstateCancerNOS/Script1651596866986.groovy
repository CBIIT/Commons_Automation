...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_GMB_Filter_DiseaseTerm-ProstateCancerNOS.xlsx')
...
//Clicking ProstateCancerNOS checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseTerm/ProstateCancerNOS_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/DiseaseTerm/ProstateCancerNOS_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/DiseaseTerm/DiseaseTerm_Ddn')
