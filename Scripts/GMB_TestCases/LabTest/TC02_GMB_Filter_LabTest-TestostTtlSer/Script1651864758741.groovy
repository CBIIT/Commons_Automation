...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_GMB_Filter_LabTest-TestostTtlSer.xlsx')
...
//Clicking LabTest drop-down
WebUI.waitForElementPresent(findTestObject('GMB/Filter/LabTest/LabTest_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/LabTest/LabTest_Ddn')

//Clicking (TestostTtlSer) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/LabTest/TestostTtlSer_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/LabTest/TestostTtlSer_Chkbx')
