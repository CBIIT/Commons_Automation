...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_GMB_Filter_LabTest-PsaSer.xlsx')
...
//Clicking (PsaSer) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/LabTest/PsaSer_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/LabTest/PsaSer_Chkbx')
