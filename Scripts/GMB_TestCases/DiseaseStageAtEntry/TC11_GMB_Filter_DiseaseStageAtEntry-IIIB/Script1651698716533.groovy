...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_GMB_Filter_DiseaseStageAtEntry-IIIB.xlsx')
...
//Clicking IIIB checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IIIB_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IIIB_Chkbx')
