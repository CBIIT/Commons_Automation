...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_GMB_Filter_DiseaseStageAtEntry-IIA.xlsx')
...
//Clicking IIA checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IIA_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IIA_Chkbx')
