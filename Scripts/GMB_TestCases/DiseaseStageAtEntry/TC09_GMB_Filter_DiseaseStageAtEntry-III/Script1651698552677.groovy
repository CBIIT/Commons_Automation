...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_GMB_Filter_DiseaseStageAtEntry-III.xlsx')
...
//Clicking III checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/III_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/III_Chkbx')
