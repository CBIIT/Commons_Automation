...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_GMB_Filter_DiseaseStageAtEntry-IA.xlsx')
...
//Clicking IA checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IA_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IA_Chkbx')
