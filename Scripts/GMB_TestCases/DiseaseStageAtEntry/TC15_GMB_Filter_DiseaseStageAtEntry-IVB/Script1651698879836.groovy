...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_GMB_Filter_DiseaseStageAtEntry-IVB.xlsx')
...
//Clicking IVB checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IVB_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IVB_Chkbx')
