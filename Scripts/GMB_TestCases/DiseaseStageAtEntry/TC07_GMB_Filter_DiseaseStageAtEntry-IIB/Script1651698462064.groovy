...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_GMB_Filter_DiseaseStageAtEntry-IIB.xlsx')
...
//Clicking IIB checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IIB_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IIB_Chkbx')
