...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_GMB_Filter_DiseaseStageAtEntry-IB.xlsx')
...
//Clicking IB checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IB_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IB_Chkbx')
