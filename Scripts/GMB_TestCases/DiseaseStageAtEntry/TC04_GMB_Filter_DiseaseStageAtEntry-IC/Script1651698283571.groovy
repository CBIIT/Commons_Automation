...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_GMB_Filter_DiseaseStageAtEntry-IC.xlsx')
...
//Clicking IC checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IC_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IC_Chkbx')
