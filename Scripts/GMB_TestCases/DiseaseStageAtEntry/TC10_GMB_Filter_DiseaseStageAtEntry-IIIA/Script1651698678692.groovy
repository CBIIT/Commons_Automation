...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_GMB_Filter_DiseaseStageAtEntry-IIIA.xlsx')
...
//Clicking IIIA checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IIIA_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IIIA_Chkbx')
