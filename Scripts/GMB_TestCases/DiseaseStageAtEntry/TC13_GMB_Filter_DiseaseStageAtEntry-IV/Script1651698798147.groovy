...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC13_GMB_Filter_DiseaseStageAtEntry-IV.xlsx')
...
//Clicking IV checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IV_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IV_Chkbx')
