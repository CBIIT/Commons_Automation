...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_GMB_Filter_DiseaseStageAtEntry-IIC.xlsx')
...
//Clicking IIC checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/DiseaseStageAtEntry/IIC_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/DiseaseStageAtEntry/IIC_Chkbx')
