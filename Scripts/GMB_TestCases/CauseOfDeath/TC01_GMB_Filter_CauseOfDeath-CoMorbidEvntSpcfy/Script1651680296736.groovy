...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_GMB_Filter_CauseOfDeath-CoMorbidEvntSpcfy.xlsx')
...
//Clicking "CoMorbid Event, Specify" checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/CauseOfDeath/CoMorbidEvntSpcfy_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/CauseOfDeath/CoMorbidEvntSpcfy_Chkbx')
