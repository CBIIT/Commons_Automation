...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_GMB_Filter_CauseOfDeath-Infection.xlsx')
...
//Clicking "Infection" checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/CauseOfDeath/Infection_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('Object Repository/GMB/Filter/CauseOfDeath/Infection_Chkbx')
