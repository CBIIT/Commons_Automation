...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_GMB_Filter_CauseOfDeath-ToxctyFrmPrtcolTrtmnt.xlsx')
...
//Clicking CauseOfDeath drop-down
WebUI.waitForElementPresent(findTestObject('GMB/Filter/CauseOfDeath/CauseOfDeath_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/CauseOfDeath/CauseOfDeath_Ddn')

//Clicking ToxctyFrmPrtcolTrtmnt checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/CauseOfDeath/ToxctyFrmPrtcolTrtmnt_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/CauseOfDeath/ToxctyFrmPrtcolTrtmnt_Chkbx')
