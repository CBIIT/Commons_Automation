...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_GMB_Filter_GermlinePathgncty-Pathogenic.xlsx')
...
//Clicking Pathogenic checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SomtcPathgncty/Pathogenic_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SomtcPathgncty/Pathogenic_Chkbx')
