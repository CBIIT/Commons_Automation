...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_GMB_Filter_GermlinePathgncty-VarintUnknwnSignficnceVUS.xlsx')
...
//Clicking GermlinePathgncty drop-down
WebUI.waitForElementPresent(findTestObject('GMB/Filter/GermlinePathgncty/GermlinePathgncty_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/GermlinePathgncty/GermlinePathgncty_Ddn')

//Clicking VarintUnknwnSignficnceVUS checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SomtcPathgncty/VarintUnknwnSignficnceVUS_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SomtcPathgncty/VarintUnknwnSignficnceVUS_Chkbx')
