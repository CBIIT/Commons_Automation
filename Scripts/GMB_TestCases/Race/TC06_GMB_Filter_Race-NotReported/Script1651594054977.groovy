...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_GMB_Filter_Race-NotReported.xlsx')
...
//Clicking not-reported checkbox
WebUI.waitForElementClickable(findTestObject('GMB/Filter/Race/NotReported_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/NotReported_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/Race_Ddn')
