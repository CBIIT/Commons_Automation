...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_GMB_Filter_Race-White.xlsx')
...
//Clicking white checkbox
WebUI.waitForElementClickable(findTestObject('GMB/Filter/Race/White_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/White_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/Race_Ddn')
