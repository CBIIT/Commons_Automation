...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_GMB_Filter_Race-Asian.xlsx')
...
//Clicking asian checkbox
WebUI.waitForElementClickable(findTestObject('GMB/Filter/Race/Asian_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/Asian_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/Race_Ddn')
