...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_GMB_Filter_Race-NativeHwianOthrPcfcIslandr.xlsx')
...
//Clicking native hwian othe pacific islander checkbox
WebUI.waitForElementClickable(findTestObject('GMB/Filter/Race/NativeHwianOthrPcfcIslandr_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/NativeHwianOthrPcfcIslandr_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/Race_Ddn')
