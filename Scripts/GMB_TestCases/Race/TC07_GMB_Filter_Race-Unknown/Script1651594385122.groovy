...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_GMB_Filter_Race-Unknown.xlsx')
...
WebUI.waitForElementClickable(findTestObject('GMB/Filter/Race/Unknown_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/Unknown_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('GMB/Filter/Race/Race_Ddn')
