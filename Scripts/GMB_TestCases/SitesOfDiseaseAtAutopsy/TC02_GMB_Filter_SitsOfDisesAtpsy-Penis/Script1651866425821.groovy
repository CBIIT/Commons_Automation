...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_GMB_Filter_SitsOfDisesAtpsy-Penis.xlsx')
...
//Clicking (Penis) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SitsOfDisesAtpsy/Penis_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SitsOfDisesAtpsy/Penis_Chkbx')
