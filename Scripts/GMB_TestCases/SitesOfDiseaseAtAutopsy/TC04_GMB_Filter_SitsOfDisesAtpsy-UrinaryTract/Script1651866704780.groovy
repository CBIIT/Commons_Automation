...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_GMB_Filter_SitsOfDisesAtpsy-UrinaryTract.xlsx')
...
//Clicking SitsOfDisesAtpsy drop-down
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SitsOfDisesAtpsy/SitsOfDisesAtpsy_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SitsOfDisesAtpsy/SitsOfDisesAtpsy_Ddn')

//Clicking (UrinaryTract) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SitsOfDisesAtpsy/UrinaryTract_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SitsOfDisesAtpsy/UrinaryTract_Chkbx')
