...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_GMB_Filter_SitsOfDisesAtpsy-Pelvis.xlsx')
...
//Clicking (Pelvis) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SitsOfDisesAtpsy/Pelvis_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SitsOfDisesAtpsy/Pelvis_Chkbx')
