...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_GMB_Filter_SitsOfDisesAtpsy-Prostate.xlsx')
...
//Clicking (Prostate) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/SitsOfDisesAtpsy/Prostate_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/SitsOfDisesAtpsy/Prostate_Chkbx')
