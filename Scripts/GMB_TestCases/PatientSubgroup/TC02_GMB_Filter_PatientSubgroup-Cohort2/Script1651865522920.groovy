...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_GMB_Filter_PatientSubgroup-Cohort2.xlsx')
...
//Clicking PatientSubgroup drop-down
WebUI.waitForElementPresent(findTestObject('GMB/Filter/PatientSubgroup/PatientSubgroup_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/PatientSubgroup/PatientSubgroup_Ddn')

//Clicking (Cohort2) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/PatientSubgroup/Cohort2_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/PatientSubgroup/Cohort2_Chkbx')
