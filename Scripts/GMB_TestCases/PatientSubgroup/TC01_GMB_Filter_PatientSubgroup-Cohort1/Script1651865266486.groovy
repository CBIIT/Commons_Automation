...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_GMB_Filter_PatientSubgroup-Cohort1.xlsx')
...
//Clicking (Cohort1) checkbox
WebUI.waitForElementPresent(findTestObject('GMB/Filter/PatientSubgroup/Cohort1_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabGMBStat'('GMB/Filter/PatientSubgroup/Cohort1_Chkbx')
