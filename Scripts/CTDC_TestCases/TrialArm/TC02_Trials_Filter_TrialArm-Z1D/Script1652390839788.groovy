...
/*This test script:
  ...
  - Clicks on the Filter 'Trial Arm' from left pane
  - Selects the specific check box from 'Trial Arm' filter.
...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Trials_Filter_TrialArm-Z1D.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Object Repository/CTDC/Filters//TrialArm/TRIALARM_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Trials/Filter/TrialArm/TRIALARM_Ddn')
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Trials/Filter/TrialArm/Z1D_Chkbx')
