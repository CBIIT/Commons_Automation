...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_CTDC_Race-NotReported.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Race/NotReported_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Race/NotReported_Chkbx')
