...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_CTDC_Race-NatHawaiPacifIsld.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Race/RACE_Ddn')
 
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Race/NatHawaiPacifIsld_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Race/NatHawaiPacifIsld_Chkbx')
