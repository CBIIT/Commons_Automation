...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CTDC_Race-Asian.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Race/Asian_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Race/Asian_Chkbx')
