...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CTDC_TissueCategory-Metastatic.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/TissueCategory/Metastatic_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/TissueCategory/Metastatic_Chkbx')
