...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_CTDC_TissueCategory-Primary.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/TissueCategory/Primary_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/TissueCategory/Primary_Chkbx')
