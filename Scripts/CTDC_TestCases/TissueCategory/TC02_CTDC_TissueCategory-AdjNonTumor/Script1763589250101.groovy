...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CTDC_TissueCategory-AdjNonTumor.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/TissueCategory/TISSUECATEGORY_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/TissueCategory/TISSUECATEGORY_Ddn')
 
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/TissueCategory/AdjacentNonTumor_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/TissueCategory/AdjacentNonTumor_Chkbx')
