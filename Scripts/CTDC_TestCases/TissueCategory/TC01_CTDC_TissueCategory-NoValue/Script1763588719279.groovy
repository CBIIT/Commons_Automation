...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CTDC_TissueCategory-NoValue.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/TissueCategory/NoValue_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/TissueCategory/NoValue_Chkbx')
