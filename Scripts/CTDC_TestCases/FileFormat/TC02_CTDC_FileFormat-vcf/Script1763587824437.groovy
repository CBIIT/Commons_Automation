...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CTDC_FileFormat-vcf.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/FileFormat/FILEFORMAT_Ddn')
 
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/FileFormat/vcf_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/FileFormat/vcf_Chkbx')
