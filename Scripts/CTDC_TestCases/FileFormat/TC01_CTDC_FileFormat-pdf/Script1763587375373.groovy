...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CTDC_FileFormat-pdf.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/FileFormat/pdf_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/FileFormat/pdf_Chkbx')
