...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC18_Trials_Filter_Diagnosis-LungCancer.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/Diagnosis/LungCancer_Chkbx')
