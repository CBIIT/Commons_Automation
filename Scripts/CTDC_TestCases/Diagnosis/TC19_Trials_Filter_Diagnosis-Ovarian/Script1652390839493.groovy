...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC19_Trials_Filter_Diagnosis-Ovarian.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/Diagnosis/OvarianEpith_Chkbx')
Thread.sleep(2000)
