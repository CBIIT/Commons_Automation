...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CTDC_Diagnosis-PlasmaCellMyeloma.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Diagnosis/DIAGNOSIS_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Diagnosis/DIAGNOSIS_Ddn')
 
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Diagnosis/PlasmaCellMyeloma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Diagnosis/PlasmaCellMyeloma_Chkbx')
