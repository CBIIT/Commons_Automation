...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CTDC_Diagnosis-ColorctlCarcin.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Diagnosis/ColorectalCarcin_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Diagnosis/ColorectalCarcin_Chkbx')
