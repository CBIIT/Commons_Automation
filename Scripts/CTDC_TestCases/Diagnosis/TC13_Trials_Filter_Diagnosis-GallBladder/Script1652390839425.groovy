...
/*This test script:
  ...
  */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC13_Trials_Filter_Diagnosis-GallBladder.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/Diagnosis/GallBladder_Chkbx')
