...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CTDC_Diagnosis-SmallCellLungCarcinoma.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Diagnosis/SmallCellLung_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Diagnosis/SmallCellLung_Chkbx')
