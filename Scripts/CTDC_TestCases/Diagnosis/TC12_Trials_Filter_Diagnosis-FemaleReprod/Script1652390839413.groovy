...
/*This test script:
  ...
  */
WebUI.closeBrowser() 
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_Trials_Filter_Diagnosis-FemaleReprod.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/Diagnosis/FemaleReprod_Chkbx')
