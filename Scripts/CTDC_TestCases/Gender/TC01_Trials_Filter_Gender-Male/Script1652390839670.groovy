...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Trials_Filter_Gender-Male.xlsx')
...
//CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Trials/Cases_page/Trials_FilterByCases_Facet')
 
WebUI.waitForElementClickable(findTestObject('Trials/Filter/Gender/GENDER_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/Gender/GENDER_Ddn')
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/Gender/Male_Chkbx')
