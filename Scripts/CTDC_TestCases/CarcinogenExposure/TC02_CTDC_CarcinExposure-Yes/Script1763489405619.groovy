...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CTDC_CarcinExposure-Yes.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/CarcinExposure/Yes_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/CarcinExposure/Yes_Chkbx')
