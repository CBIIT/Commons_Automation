...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CTDC_CarcinExposure-Unknown.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/CarcinExposure/Unknown_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/CarcinExposure/Unknown_Chkbx')
