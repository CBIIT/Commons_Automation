...
/*This test script:
  ...
  */
WebUI.closeBrowser() 
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Trials_Filter_AssocFileFormat-Bai.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/AssocFileFormat/Bai_Chkbx'))
