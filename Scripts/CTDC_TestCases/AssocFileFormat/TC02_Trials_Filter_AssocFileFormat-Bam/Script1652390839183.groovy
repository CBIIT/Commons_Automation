...
/*This test script:
  ...
  */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Trials_Filter_AssocFileFormat-Bam.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Trials/Filter/AssocFileFormat/ASSOCFILEFORMAT_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/AssocFileFormat/ASSOCFILEFORMAT_Ddn'))
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/AssocFileFormat/Bam_Chkbx'))
