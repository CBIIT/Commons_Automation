...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CTDC_FileType-VariantReport.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/FileType/VariantReport_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/FileType/VariantReport_Chkbx')
