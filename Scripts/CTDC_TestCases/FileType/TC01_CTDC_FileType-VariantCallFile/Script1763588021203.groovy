...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CTDC_FileType-VariantCallFile.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/FileType/FILETYPE_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/FileType/FILETYPE_Ddn')
 
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/FileType/VariantCallFile_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/FileType/VariantCallFile_Chkbx')
