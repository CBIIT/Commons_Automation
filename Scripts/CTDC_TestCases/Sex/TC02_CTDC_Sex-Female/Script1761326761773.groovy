...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CTDC_Sex-Female.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Sex/Sex_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Sex/Sex_Ddn')
 
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Sex/Female_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Sex/Female_Chkbx')
