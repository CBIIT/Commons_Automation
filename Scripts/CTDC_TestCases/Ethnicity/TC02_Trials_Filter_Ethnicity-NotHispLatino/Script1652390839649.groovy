...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Trials_Filter_Ethnicity-NotHispLatino.xlsx')
...
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Ethnicity/ETHNICITY_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/Ethnicity/ETHNICITY_Ddn')
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/Ethnicity/NotHispLatino_Chkbx')
