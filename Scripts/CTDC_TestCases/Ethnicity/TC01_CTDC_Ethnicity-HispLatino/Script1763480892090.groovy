...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CTDC_Ethnicity-HispLatino.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Ethnicity/ETHNICITY_Ddn')
 
WebUI.waitForElementClickable(findTestObject('CTDC/Filters/Ethnicity/HispLanitno_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CTDC/Filters/Ethnicity/HispLanitno_Chkbx')
