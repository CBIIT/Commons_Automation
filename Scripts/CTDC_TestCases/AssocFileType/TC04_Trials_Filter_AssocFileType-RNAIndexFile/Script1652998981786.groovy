...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Trials_Filter_AssocFileType-RNAIndexFile.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/AssocFileType/RNAIndex_Chkbx')
