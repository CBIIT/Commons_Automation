...
/*This test script:
  ...
  */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Trials_Filter_AssocFileType-AlignedDNA.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Trials/Filter/AssocFileType/AlignedDNA_Chkbx')
