...
//C3DC Study_Accession - phs002790 ; SexAtBirth - Male ; Race - Native Hawaiian or other Pacific Islander
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_C3DC_Study_Accession_phs002790_SexAtBirth_Race.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Study/Study_Accession/phs002790-Chkbx'), 5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('C3DC/Filters/Study/Study_Accession/phs002790-Chkbx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Demographics/Race/NativeHawaiianPacific_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('C3DC/Filters/Demographics/Race/NativeHawaiianPacific_Chkbx')
