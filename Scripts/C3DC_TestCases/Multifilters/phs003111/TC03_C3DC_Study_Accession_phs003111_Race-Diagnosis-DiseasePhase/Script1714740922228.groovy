...
//C3DC: Study_Accession - phs003111 ; Race - Black or African American ; Ethnicity - Not Hispanic or Latino ; AnatomicSite - C48.8 : Overlapping lesion of retroperitoneum and peritoneum
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC03_C3DC_Study_Accession_phs003111_Race-Diagnosis-DiseasePhase.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Demographics/Ethnicity/Ethnicity-Ddn'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('C3DC/Filters/Demographics/Ethnicity/Ethnicity-Ddn')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Demographics/Ethnicity/NotHispanicOrLatino-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('C3DC/Filters/Demographics/Ethnicity/NotHispanicOrLatino-Chkbx')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/AnatomicSite/AnatomicSite-Ddn'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('C3DC/Filters/Diagnosis/AnatomicSite/AnatomicSite-Ddn')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/AnatomicSite/C48.8.OverlaplesionOfRtrPeritPerit-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('C3DC/Filters/Diagnosis/AnatomicSite/C48.8.OverlaplesionOfRtrPeritPerit-Chkbx')
