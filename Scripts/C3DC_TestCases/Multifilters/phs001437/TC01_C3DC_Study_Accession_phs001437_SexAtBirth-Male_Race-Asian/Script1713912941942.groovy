...
//Study- in [phs001437], SextAtBirth in [Male] and Race in [Asian]

WebUI.closeBrowser()

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_C3DC_Study_Accession_phs001437_SexAtBirth-Male_Race-Asian.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Study/Study_Accession/phs001437-Chkbx'), 5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('C3DC/Filters/Study/Study_Accession/phs001437-Chkbx')
...
//This scenario does not have data for Survival tab
