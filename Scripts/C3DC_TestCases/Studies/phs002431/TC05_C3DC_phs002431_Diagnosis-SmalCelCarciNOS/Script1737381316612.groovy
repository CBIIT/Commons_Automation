...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_C3DC_phs002431_Diagnosis-SmalCelCarciNOS.xlsx')
...
CustomKeywords.'utilities.TestRunner.scrollFacetDownUntilVisible'('C3DC/Filters/Diagnosis/Diagnosis/Diagnosis-Ddn',
	'C3DC/Filters/Diagnosis/Diagnosis/SmalCelCarciNOS-Chkbx', 5)
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/Diagnosis/SmalCelCarciNOS-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/Diagnosis/SmalCelCarciNOS-Chkbx')
