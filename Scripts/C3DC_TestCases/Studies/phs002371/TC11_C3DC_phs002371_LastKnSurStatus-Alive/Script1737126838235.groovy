...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_C3DC_phs002371_LastKnSurStatus-Alive.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Survival/LastKnownSurStatus/Alive-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Survival/LastKnownSurStatus/Alive-Chkbx')
...
////clicking the Treatment tab - The filter does not have treatment data
