...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_C3DC_phs002371_TrtmntAgent-NotReported.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Treatment/TreatmentAgent/NotReported-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Treatment/TreatmentAgent/NotReported-Chkbx')
