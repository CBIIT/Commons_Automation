...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_C3DC_phs003164_DiseasePhase-RelapProgrsion.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/DiseasePhase/RelapProgrsion-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/DiseasePhase/RelapProgrsion-Chkbx')
