...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/Diagnosis/RhabdoidTumNOS-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/Diagnosis/RhabdoidTumNOS-Chkbx')
...
////clicking the Survival tab - not survival data for this filter
