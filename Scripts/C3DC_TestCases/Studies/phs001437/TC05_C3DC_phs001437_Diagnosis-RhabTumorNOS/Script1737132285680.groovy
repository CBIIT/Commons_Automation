...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_C3DC_phs001437_Diagnosis-RhabTumorNOS.xlsx')
...
CustomKeywords.'utilities.TestRunner.scrollFacetDownUntilVisible'('C3DC/Filters/Diagnosis/Diagnosis/Diagnosis-Ddn',
	'C3DC/Filters/Diagnosis/Diagnosis/RhabdoidTumorNOS-Chkbx', 10)
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/Diagnosis/RhabdoidTumorNOS-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/Diagnosis/RhabdoidTumorNOS-Chkbx')
