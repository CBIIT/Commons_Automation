...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_C3DC_phs001437_TrtmntAgent-Carboplatin.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Study/dbGaP_Accession/phs001437-Chkbx'), 10)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Study/dbGaP_Accession/phs001437-Chkbx')
...
WebUI.delay(2)
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Treatment/TreatmentAgent/TreatmentAgent-Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Treatment/TreatmentAgent/TreatmentAgent-Ddn')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Treatment/TreatmentAgent/Carboplatin-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Treatment/TreatmentAgent/Carboplatin-Chkbx')
...
////clicking the Treatment tab - sorting issue there
