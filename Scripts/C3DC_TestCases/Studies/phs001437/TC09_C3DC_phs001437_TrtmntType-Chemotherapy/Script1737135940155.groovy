...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_C3DC_phs001437_TrtmntType-Chemotherapy.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Treatment/TreatmentType/Chemotherapy-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Treatment/TreatmentType/Chemotherapy-Chkbx')
...
////clicking the Diagnosis tab - sorting issue there with 1 id
...
////clicking the Treatment tab - sorting issue there with 1 id
