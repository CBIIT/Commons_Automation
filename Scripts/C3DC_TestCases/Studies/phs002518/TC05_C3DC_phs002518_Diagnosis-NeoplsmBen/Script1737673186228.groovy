...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_C3DC_phs002518_Diagnosis-NeoplsmBen.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Study/dbGaP_Accession/phs002518-Chkbx'), 5)
...
CustomKeywords.'utilities.TestRunner.scrollFacetDownUntilVisible'('C3DC/Filters/Diagnosis/Diagnosis/Diagnosis-Ddn',
	'C3DC/Filters/Diagnosis/Diagnosis/NeoplsmBen-Chkbx', 10)
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/Diagnosis/NeoplsmBen-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/Diagnosis/NeoplsmBen-Chkbx')
