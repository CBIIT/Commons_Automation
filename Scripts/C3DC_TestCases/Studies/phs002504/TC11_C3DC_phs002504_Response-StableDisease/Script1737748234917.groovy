...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_C3DC_phs002504_Response-StableDisease.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/Response/StableDisease-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/Response/StableDisease-Chkbx')
