...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_C3DC_phs002504_SexAtBirth-Male.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Demographics/SexAtBirth/Male_Chkbx')
...
//For treatment added [] brackets and replaced semicolon with comma and space
