...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_C3DC_phs002504_TrtmntAgent-Other.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Treatment/TreatmentAgent/Other-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Treatment/TreatmentAgent/Other-Chkbx')
