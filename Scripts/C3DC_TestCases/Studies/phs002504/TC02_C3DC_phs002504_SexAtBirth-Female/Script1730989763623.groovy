...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_C3DC_phs002504_SexAtBirth-Female.xlsx')
...
////The Query collects only first and last colmn data. Need to fix the query
