...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_C3DC_phs002504_RespCategory-Unknown.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/RespCategory/Unknown-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/RespCategory/Unknown-Chkbx')
...
////clicking the Treatment tab - Sorting issue to be fixed (Tried other columns)
