...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC13_C3DC_phs002790_RespSystm-NotReported.xlsx')
...
WebUI.delay(2)
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/RespSystem/RespSystem-Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/RespSystem/RespSystem-Ddn')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/RespSystem/NotReported-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/RespSystem/NotReported-Chkbx')
