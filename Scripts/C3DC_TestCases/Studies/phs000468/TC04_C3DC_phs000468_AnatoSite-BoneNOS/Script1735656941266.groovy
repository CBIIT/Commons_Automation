...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_C3DC_phs000468_AnatoSite-BoneNOS.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/AnatomicSite/BoneNOS-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/AnatomicSite/BoneNOS-Chkbx')
