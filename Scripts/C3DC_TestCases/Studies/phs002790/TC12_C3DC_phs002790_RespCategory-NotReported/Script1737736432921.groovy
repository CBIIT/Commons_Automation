...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_C3DC_phs002790_RespCategory-NotReported.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Study/dbGaP_Accession/phs002790-Chkbx'), 10)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Study/dbGaP_Accession/phs002790-Chkbx')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/TreatReponse-Facet'), 10)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/TreatReponse-Facet')

WebUI.delay(2)
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/RespCategory/RespCategory-Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/RespCategory/RespCategory-Ddn')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/RespCategory/NotReported-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/RespCategory/NotReported-Chkbx')
...
////clicking the Treatment tab - failing due to sorting issue
