...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_C3DC_phs002790_TrtmntType-Brachthrpy.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Treatment/TreatmentType/Brachthrpy-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Treatment/TreatmentType/Brachthrpy-Chkbx')
