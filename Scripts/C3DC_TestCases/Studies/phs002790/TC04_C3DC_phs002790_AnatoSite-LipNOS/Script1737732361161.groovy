...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_C3DC_phs002790_AnatoSite-LipNOS.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/AnatomicSite/LipNOS-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/AnatomicSite/LipNOS-Chkbx')
