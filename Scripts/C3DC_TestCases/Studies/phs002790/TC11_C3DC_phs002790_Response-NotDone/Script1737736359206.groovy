...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_C3DC_phs002790_Response-NotDone.xlsx')
...
WebUI.delay(2)
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/Response/Response-Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/Response/Response-Ddn')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/TreatmentResp/Response/NotDone-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/TreatmentResp/Response/NotDone-Chkbx')
