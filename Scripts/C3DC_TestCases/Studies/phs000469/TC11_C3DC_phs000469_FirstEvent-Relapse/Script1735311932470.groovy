...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_C3DC_phs000469_FirstEvent-Relapse.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Survival/FirstEvent/Relapse-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Survival/FirstEvent/Relapse-Chkbx')
