...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_C3DC_phs000469_LastKnownSurStatus-Dead.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Study/dbGaP_Accession/phs000469-Chkbx'), 10)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Study/dbGaP_Accession/phs000469-Chkbx')
