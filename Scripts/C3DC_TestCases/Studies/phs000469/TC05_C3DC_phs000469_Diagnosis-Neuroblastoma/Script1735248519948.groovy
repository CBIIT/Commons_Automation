...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_C3DC_phs000469_Diagnosis-Neuroblastoma.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/Diagnosis/Neuroblastoma-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/Diagnosis/Neuroblastoma-Chkbx')
