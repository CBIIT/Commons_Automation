...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_C3DC_phs002517_DiagnClasfSystem-WHO.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/DiagsClasifctnSystem/WHO-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/DiagsClasifctnSystem/WHO-Chkbx')
