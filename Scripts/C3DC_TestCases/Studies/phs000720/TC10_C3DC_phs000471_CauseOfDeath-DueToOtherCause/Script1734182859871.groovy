...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_C3DC_phs000471_CauseOfDeath-DueToOtherCause.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Survival/CauseOfDeath/DueToOtherCause-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Survival/CauseOfDeath/DueToOtherCause-Chkbx')
