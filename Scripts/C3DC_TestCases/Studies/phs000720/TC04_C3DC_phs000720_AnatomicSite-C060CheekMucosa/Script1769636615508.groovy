...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_C3DC_phs000720_AnatomicSite-C060CheekMucosa.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/AnatomicSite/C060CheekMucosa-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/AnatomicSite/C060CheekMucosa-Chkbx')
