...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_C3DC_phs000720_DiseasePhase-Relapse.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/DiseasePhase/Relapse-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/DiseasePhase/Relapse-Chkbx')
