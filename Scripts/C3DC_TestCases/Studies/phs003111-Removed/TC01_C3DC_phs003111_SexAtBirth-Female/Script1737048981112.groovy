...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_C3DC_phs003111_SexAtBirth-Female.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Demographics/SexAtBirth/Female-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Demographics/SexAtBirth/Female-Chkbx')
