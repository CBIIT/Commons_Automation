...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_C3DC_phs002430_Race-AmerIndAlaskaNative.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Demographics/Race/AmerIndAlaskan_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Demographics/Race/AmerIndAlaskan_Chkbx')
...
//This filter doesn't have treatment data
