...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_C3DC_phs002430_Diagnosis-SarcomaNOS.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/Diagnosis-Facet'), 5)
...
CustomKeywords.'utilities.TestRunner.scrollFacetDownUntilVisible'('C3DC/Filters/Diagnosis/Diagnosis/Diagnosis-Ddn',
	'C3DC/Filters/Diagnosis/Diagnosis/SarcomaNOS-Chkbx', 10)
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/Diagnosis/SarcomaNOS-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/Diagnosis/SarcomaNOS-Chkbx')
