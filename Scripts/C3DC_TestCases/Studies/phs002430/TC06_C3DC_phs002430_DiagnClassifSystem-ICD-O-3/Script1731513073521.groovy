...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_C3DC_phs002430_DiagnClassifSystem-ICD-O-3.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Study/dbGaP_Accession/phs002430-Chkbx'), 10)
...
////Participants tab (Fails for sorting issue)
...
////clicking the Survival tab  (Fails for sorting issue)
