...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_C3DC_phs003519_DiagnClasfSystem-IndForStudy.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Study/dbGaP_Accession/phs003519-Chkbx'), 10)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Study/dbGaP_Accession/phs003519-Chkbx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/DiagsClasifctnSystem/DiagsClasifctnSystem-Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/DiagsClasifctnSystem/DiagsClasifctnSystem-Ddn')

WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/DiagsClasifctnSystem/IndForStudy-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/DiagsClasifctnSystem/IndForStudy-Chkbx')
...
////clicking the Survival tab - This study does not have survival data
