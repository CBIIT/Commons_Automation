...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_C3DC_phs003519_Race-NotReported.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Demographics/Race/NotReported_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Demographics/Race/NotReported_Chkbx')
