...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_C3DC_phs003111_AnatomicSite-NotReported.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/AnatomicSite/NotReported-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/AnatomicSite/NotReported-Chkbx')
