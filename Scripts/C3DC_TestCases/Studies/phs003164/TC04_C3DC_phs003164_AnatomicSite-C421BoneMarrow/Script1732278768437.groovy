...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_C3DC_phs003164_AnatomicSite-C421BoneMarrow.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/AnatomicSite/C421BoneMarrow-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/AnatomicSite/C421BoneMarrow-Chkbx')
