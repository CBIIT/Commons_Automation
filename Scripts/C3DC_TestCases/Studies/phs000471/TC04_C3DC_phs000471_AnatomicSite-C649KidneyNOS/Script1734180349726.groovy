...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_C3DC_phs000471_AnatomicSite-C649KidneyNOS.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/AnatomicSite/C649KidneyNOS-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/AnatomicSite/C649KidneyNOS-Chkbx')
...
////clicking the Diagnosis tab - Failing due to missmatch of sorting order
...
WebUI.waitForElementPresent(findTestObject('C3DC/ResultTabs/SortBySurvivalID-Colm'), 5)
