...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_C3DC_phs000470_CauseOfDeath-DueToThisDisease.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Survival/CauseOfDeath/DueToThisDisease-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Survival/CauseOfDeath/DueToThisDisease-Chkbx')
