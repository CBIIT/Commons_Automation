...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_C3DC_phs000471_DiseasePhase-InitialDiag.xlsx')
...
WebUI.waitForElementPresent(findTestObject('C3DC/Filters/Diagnosis/DiseasePhase/InitialDiag-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('C3DC/Filters/Diagnosis/DiseasePhase/InitialDiag-Chkbx')
