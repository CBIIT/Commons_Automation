...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Bento_MultiFilter_Diagnosis-TumorSize-PRStatus-EndocrineTher-TissueComp.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Bento/Cases_page/Filter/EndocrineTherapy/None_Chkbx')
WebUI.waitForElementClickable(findTestObject('Object Repository/Bento/Cases_page/Filter/EndocrineTherapy/ENDOCRINETHERAPY_Ddn'), 10)
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Bento/Cases_page/Filter/FilterBySamples_Facet')
Thread.sleep(2000) //only if a wait is added, this step passes in headless browsers
 
WebUI.waitForElementClickable(findTestObject('Object Repository/Bento/Cases_page/Filter/TissueComposition/TISSUECOMP_Ddn'), 10)
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Bento/Cases_page/Filter/TissueComposition/TISSUECOMP_Ddn')
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Bento/Cases_page/Filter/TissueComposition/SolidTissue_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Bento/Cases_page/Filter/TissueComposition/TISSUECOMP_Ddn')
