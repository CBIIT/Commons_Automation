...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Bento_Filter_RecurrScore-26-30.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Recurrence Score/21_to_25_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Recurrence Score/26_to_30_Chkbx')
