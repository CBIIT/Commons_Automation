...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_Bento_Filter_RecurrScore-41-50.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Recurrence Score/41_to_50_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Recurrence Score/41_to_50_Chkbx')
