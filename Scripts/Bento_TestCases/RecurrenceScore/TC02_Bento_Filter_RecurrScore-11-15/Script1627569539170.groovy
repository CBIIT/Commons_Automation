...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_Bento_Filter_RecurrScore-11-15.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Recurrence Score/RecurrScore_Ddn'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Bento/Cases_page/Filter/Recurrence Score/RecurrScore_Ddn')
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Recurrence Score/11_to_15_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Bento/Cases_page/Filter/Recurrence Score/11_to_15_Chkbx')
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Bento/Cases_page/Filter/Recurrence Score/RecurrScore_Ddn')
...
//Commented below tabs due to time increase as the data is huge
