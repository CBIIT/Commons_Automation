...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_Bento_Filter_RecurrScore-6-10.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Recurrence Score/06_to_10_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Recurrence Score/06_to_10_Chkbx')
