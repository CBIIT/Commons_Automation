...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_Bento_Filter_RecurrScore-51-100.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Recurrence Score/RecurrScore_Ddn')
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Recurrence Score/51_to_100_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Recurrence Score/51_to_100_Chkbx')
