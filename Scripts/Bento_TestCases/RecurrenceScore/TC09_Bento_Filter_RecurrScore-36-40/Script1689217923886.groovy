...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Bento_Filter_RecurrScore-36-40.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Recurrence Score/36_to_40_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Recurrence Score/36_to_40_Chkbx')
