...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_Bento_Filter_RecurrScore-31-35.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Recurrence Score/31_to_35_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Recurrence Score/31_to_35_Chkbx')
