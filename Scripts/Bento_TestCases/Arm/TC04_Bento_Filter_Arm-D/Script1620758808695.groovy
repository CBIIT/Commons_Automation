...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_Bento_Filter_Arm-D.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Arm/ARM_Ddn')

WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Arm/D_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Arm/D_Chkbx')
