...
//Filter
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Age/Age_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Age/Age_Ddn')

WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/Age/MinAge_Input'), 5)
WebUI.click(findTestObject('Bento/Cases_page/Filter/Age/MinAge_Input'))
CustomKeywords.'utilities.TestRunner.clearTextfieldByOs'('Bento/Cases_page/Filter/Age/MinAge_Input')
...
WebUI.click(findTestObject('Bento/Cases_page/Filter/Age/MaxAge_Input'))
CustomKeywords.'utilities.TestRunner.clearTextfieldByOs'('Bento/Cases_page/Filter/Age/MaxAge_Input')
