...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_Bento_Filter_TumorGrade-IntermediateGrade.xlsx')
...
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/TumorGrade/TumorGrade_Ddn'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Bento/Cases_page/Filter/TumorGrade/TumorGrade_Ddn')
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Object Repository/Bento/Cases_page/Filter/TumorGrade/Intermediate_Chkbx')
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Object Repository/Bento/Cases_page/Filter/TumorGrade/TumorGrade_Ddn')
...
//Commented below tabs due to time increase as the data is 528 for each tab in QA
...
//CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.multiFunction'('Bento',GlobalVariable.G_StatBar_Cases, 'Object Repository/Bento/Cases_page/Bento_SamplesTable',
