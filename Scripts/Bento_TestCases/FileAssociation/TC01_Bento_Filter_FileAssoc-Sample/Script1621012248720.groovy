...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Bento_Filter_FileAssoc-Sample.xlsx')
...
//CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/FilterByFiles_Facet')
 
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/FileAssociation/FILEASSOC_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/FileAssociation/FILEASSOC_Ddn')
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/FileAssociation/Sample_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/FileAssociation/Sample_Chkbx')
