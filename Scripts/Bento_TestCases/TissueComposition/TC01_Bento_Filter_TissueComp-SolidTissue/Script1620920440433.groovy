...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Bento_Filter_TissueComp-SolidTissue.xlsx')
...
//CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/FilterBySamples_Facet')
 
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/TissueComposition/TISSUECOMP_Ddn'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/TissueComposition/TISSUECOMP_Ddn')
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/TissueComposition/SolidTissue_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/TissueComposition/SolidTissue_Chkbx')
