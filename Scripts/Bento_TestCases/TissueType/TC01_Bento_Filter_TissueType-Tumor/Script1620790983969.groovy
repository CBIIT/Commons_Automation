...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_Bento_Filter_TissueType-Tumor.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Bento/Cases_page/Filter/TissueType/TISSUETYPE_Ddn')
 
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/TissueType/Tumor_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Bento/Cases_page/Filter/TissueType/Tumor_Chkbx')
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Bento/Cases_page/Filter/TissueType/TISSUETYPE_Ddn')
