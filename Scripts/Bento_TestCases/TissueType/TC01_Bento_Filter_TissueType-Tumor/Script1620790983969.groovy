...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Bento_Filter_TissueType-Tumor.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/TissueType/TISSUETYPE_Ddn')
 
WebUI.waitForElementClickable(findTestObject('Bento/Cases_page/Filter/TissueType/Tumor_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/TissueType/Tumor_Chkbx')
