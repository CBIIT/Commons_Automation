...
//Initiate
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_Bento_Filter_Diagnosis-TubularCarcinoma.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Diagnosis/TubularCarcinoma_Chkbx')
