...
//Initiate
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Bento_Filter_Diagnosis-Adenocarcinoma.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Diagnosis/Adenocarcinoma_Chkbx')
