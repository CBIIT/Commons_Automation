...
//Initiate
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_Bento_Filter_Diagnosis-InfilLobularCarcinoma.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Diagnosis/InfiltrLobuCarcinoma_Chkbx')
