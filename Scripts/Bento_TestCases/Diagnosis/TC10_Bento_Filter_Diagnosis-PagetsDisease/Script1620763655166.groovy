...
//Initiate
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_Bento_Filter_Diagnosis-PagetsDisease.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Bento/Cases_page/Filter/Diagnosis/PagetsDisease_Chkbx')
