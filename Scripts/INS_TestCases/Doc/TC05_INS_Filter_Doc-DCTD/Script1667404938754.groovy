...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_INS_Filter_Doc-DCTD.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('Object Repository/INS/ProjectsPage/Filter/DOC/DCTD_Chkbx')
