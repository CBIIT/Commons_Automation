...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_INS_SpecialTopic-SPORE.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/SpecialTopic/SPORE-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/SpecialTopic/SPORE-Chkbx')
...
/*
//Clicking Programs tab - has mismatch due to extra space
