...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_INS_SpecialTopic-HealthDisparities.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/INS/Filters/SpecialTopic/HealthDisparities-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('Object Repository/INS/Filters/SpecialTopic/HealthDisparities-Chkbx')
...
//Clicking Grants tab //has extra space issue in data
