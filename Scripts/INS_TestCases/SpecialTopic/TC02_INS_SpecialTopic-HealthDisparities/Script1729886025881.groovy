...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_INS_FocusArea-HealthDisparities.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/SpecialTopic/HealthDisparities-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/SpecialTopic/HealthDisparities-Chkbx')
