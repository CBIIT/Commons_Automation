...
WebUI.waitForElementPresent(findTestObject('INS/Filters/FocusArea/HealthDisparities-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/FocusArea/HealthDisparities-Chkbx')
