...
WebUI.waitForElementPresent(findTestObject('INS/Filters/FocusArea/Moonshot-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/FocusArea/Moonshot-Chkbx')
