...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC18_INS_CancerType-HeadandNeckCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/CancerType/HeadandNeckCancer-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/CancerType/HeadandNeckCancer-Chkbx')
