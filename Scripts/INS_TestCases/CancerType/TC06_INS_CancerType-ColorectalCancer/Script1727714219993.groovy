...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_INS_CancerType-ColorectalCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/CancerType/ColorectalCancer-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/CancerType/ColorectalCancer-Chkbx')
...
/*
//Clicking Programs tab  - has extra space issue
