...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_INS_CancerType-EsophagealCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/CancerType/EsophagealCancer-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/CancerType/EsophagealCancer-Chkbx')
