...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_INS_CancerType-OvarianCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/CancerType/OvarianCancer-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/CancerType/OvarianCancer-Chkbx')
...
CustomKeywords.'utilities.TestRunner.multiFunction'('INS', GlobalVariable.G_StatBar_Grants, 'INS/ResultTabs/Grants-Tbl',
	...
	GlobalVariable.G_QueryProjectsTab)
/*
//Clicking Publication tab  //lot of extra spaces in data
