...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_INS_CancerType-CervicalCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/CancerType/CervicalCancer-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/CancerType/CervicalCancer-Chkbx')
