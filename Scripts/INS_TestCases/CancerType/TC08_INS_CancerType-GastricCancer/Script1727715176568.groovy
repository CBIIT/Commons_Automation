...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_INS_CancerType-GastricCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/CancerType/GastricCancer-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/CancerType/GastricCancer-Chkbx')
