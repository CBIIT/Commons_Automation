...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC21_INS_CancerType-ProstateCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/CancerType/ProstateCancer-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/CancerType/ProstateCancer-Chkbx')
