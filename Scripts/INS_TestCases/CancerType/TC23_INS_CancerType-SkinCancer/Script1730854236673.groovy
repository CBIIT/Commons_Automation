...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC23_INS_CancerType-SkinCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('INS/Filters/CancerType/SkinCancer-Chkbx'), 15)
CustomKeywords.'utilities.TestRunner.clickTabINSStat'('INS/Filters/CancerType/SkinCancer-Chkbx')
