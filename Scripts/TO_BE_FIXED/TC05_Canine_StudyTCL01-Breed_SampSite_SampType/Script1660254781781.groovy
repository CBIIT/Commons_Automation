...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Canine_StudyTCL01-Breed_SampSite_SampType.xlsx')
...
//breed, samp site, samp type - boxer, labrador | blood, spleen | whole blood, tumor cell line
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/Boxer_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/LabradorRetriever_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/LabradorRetriever_Chkbx'), 5)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleSite/Spleen_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleSite/Spleen_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SampleSite/Spleen_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/TumorCellLine_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/TumorCellLine_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SampleType/TumorCellLine_Chkbx')
