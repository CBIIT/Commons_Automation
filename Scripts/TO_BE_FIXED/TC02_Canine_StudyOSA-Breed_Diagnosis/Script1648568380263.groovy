...
//Study OSA01, Breed in (Great Dane ,Mixed Breed and Golden Retriever) and Dignosis in (OsteoSarcoma)
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Canine_StudyOSA-Breed_Diagnosis.xlsx')   //changed for OSA
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/GreatDane_Chkbx')
