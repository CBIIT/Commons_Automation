...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_Canine_StudyTCL01-Breed_Sex_NeutStatus.xlsx')
...
//breed, sex, neut  - boxer, labrador | male, female | yes
...
findTestObject('Object Repository/Canine/Filter/NeuteredStatus/Yes_Chkbx')
