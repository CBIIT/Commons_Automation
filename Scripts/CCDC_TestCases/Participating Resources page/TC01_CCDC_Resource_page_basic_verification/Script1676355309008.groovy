...
//Step 6--------------------Verifying Filter Type ****************************************************************
  System.out.println ("This is the value of Filter Type obtained from input test data :" + ipResourceType)
 GlobalVariable.G_FilterType=ipResourceType.toString()
  elementlabel= "Filter Type"
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv,'Object Repository/CCDC/Resource_page/FilterType', ipResourceType, GlobalVariable.G_FilterType, elementlabel)
...
// CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv,'Object Repository/CCDC/Resource_page/ResourceType', ipResourceType, GlobalVariable.G_ResrceType, elementlabel)
// 
...
/*
 ...
 GlobalVariable.G_DtstName=ipDtstName.toString()
  elementlabel= "Dataset Name"
 CustomKeywords.'ctdutilities.DataValidation.CCDCreadInfo'(drv,'Object Repository/CCDC/Dataset_page/DatasetName', ipDtstName, GlobalVariable.G_DtstName, elementlabel)
