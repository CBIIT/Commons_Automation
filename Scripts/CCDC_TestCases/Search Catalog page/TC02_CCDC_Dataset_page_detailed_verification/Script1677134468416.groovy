...
//WebDriver drv = CustomKeywords.'utilities.CustomBrowserDriver.createWebDriver'();
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/ResrcCode', ipResCode, GlobalVariable.G_resCode, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/POC', ipPOC, GlobalVariable.G_POC, elementlabel)
...
GlobalVariable.G_POCemail=ipPOCemail.toString()
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/POCemail', ipPOCemail, GlobalVariable.G_POCemail, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/DatasetDesc', ipDtstDesc, GlobalVariable.G_DtstDesc, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/DtstScope', ipDtstScope, GlobalVariable.G_DtstScope, elementlabel)
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/PublishedIn', ipPubIn, GlobalVariable.G_PubIn, elementlabel)
...
//Step 9--------------------Verifying Num of Cases ****************************************************************
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/CasesCnt', ipCasesCnt, GlobalVariable.G_casesCnt, elementlabel)
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/SamplesCnt', ipSamplesCnt, GlobalVariable.G_samplesCnt, elementlabel)
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/caseDisDiag', ipCaseDisDiag, GlobalVariable.G_caseDisDiag, elementlabel)
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/CaseAge', ipCaseAge, GlobalVariable.G_caseAge, elementlabel)
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/CaseEthn', ipCaseEthn, GlobalVariable.G_caseEthn, elementlabel)
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/CaseRace', ipCaseRace, GlobalVariable.G_caseRace, elementlabel)
 ...
 CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/CaseSex', ipCaseSex, GlobalVariable.G_caseSex, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/caseGender', ipCaseGender, GlobalVariable.G_caseGender, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/caseTumorSite', ipCTumorSite, GlobalVariable.G_cTumorSite, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/caseTrtmtAdmn', ipCTrtmtAdmn, GlobalVariable.G_caseTrtmtAdmn, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/caseTrtmtOutcm', ipCTrtmtOutcm, GlobalVariable.G_caseTrtmtOutcm, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/sampleAssMethod', ipSampAssMeth, GlobalVariable.G_sampleAssMeth, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/sampleAnalType', ipSampAnalType, GlobalVariable.G_sampleAnalType, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/sampleAnatSite', ipSampAnatSite, GlobalVariable.G_sampleAnatSite, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/sampleCompType', ipSampCompType, GlobalVariable.G_sampleCompType, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/sampleIsNormal', ipSampIsNml, GlobalVariable.G_sampleIsNml, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/sampleIsXeno', ipSampIsXeno, GlobalVariable.G_sampleIsXeno, elementlabel)
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/dbgapID', ipdbgapID, GlobalVariable.G_dbgapID, elementlabel)
...
elementlabel = "Grant"
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/Grant', ipGrant, GlobalVariable.G_Grant, elementlabel)
/*
...
CustomKeywords.'utilities.DataValidation.CCDCreadInfo'(drv, 'Object Repository/CCDC/Dataset_page/GrantInfo', ipGrantInfo, GlobalVariable.G_GrantInfo, elementlabel)
 */
