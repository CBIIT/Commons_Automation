...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CCDI_phs001714_Sex-Female_Sampletumorclassif-Primary_FileType-maf.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/maf_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/maf_Chkbx')
