...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CCDI_phs001714_Diaganatomicsite-C76.2AbdomenNOS_LibStratgy-WGS.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Diagnosis-Facet/Diagnosis_Anatomic_Site/C76.2AbdomenNOS_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Diagnosis-Facet/Diagnosis_Anatomic_Site/C76.2AbdomenNOS_Chkbx')
