...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_CCDI_phs002677_Sex-Male_TumClas-Recurrent_StudyName.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Study_Facet/StudyName/IntegLngtdClncScdmgrphGenmInNCCR_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Study_Facet/StudyName/IntegLngtdClncScdmgrphGenmInNCCR_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Samples_Facet/SampleTumorClassification/Recurrent_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Samples_Facet/SampleTumorClassification/Recurrent_Chkbx')
