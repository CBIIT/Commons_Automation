...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CCDI_phs001228_Sex-Male_Diaganatomicsite-C41.2vertebralcolmn.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Diagnosis-Facet/Diagnosis_Anatomic_Site/C41.2.VertebralColmn-Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Diagnosis-Facet/Diagnosis_Anatomic_Site/C41.2.VertebralColmn-Chkbx')
