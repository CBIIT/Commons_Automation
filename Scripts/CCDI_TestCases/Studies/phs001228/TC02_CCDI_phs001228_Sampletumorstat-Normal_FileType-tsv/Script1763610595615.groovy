...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CCDI_phs001228_Sampletumorstat-Normal_FileType-tsv.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/tsv_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/tsv_Chkbx')
