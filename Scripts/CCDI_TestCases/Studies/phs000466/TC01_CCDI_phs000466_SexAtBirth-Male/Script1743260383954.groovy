...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CCDI_phs000466_SexAtBirth-Male.xlsx')
...
//clicking the Studies tab - This tab shows some missmatch due to space issue (UI = xlsx (3) DB= xlsx(3). The query needs to be updated. Run this tab to see what other space issue is there
