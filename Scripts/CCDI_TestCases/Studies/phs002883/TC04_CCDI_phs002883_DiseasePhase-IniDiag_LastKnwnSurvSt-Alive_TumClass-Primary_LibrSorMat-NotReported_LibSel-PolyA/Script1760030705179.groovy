...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_CCDI_phs002883_DiseasePhase-IniDiag_LastKnwnSurvSt-Alive_TumClass-Primary_LibrSorMat-NotReported_LibSel-PolyA.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Study_Facet/PHS_Accession/phs002883_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Study_Facet/PHS_Accession/phs002883_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Filters/SequencingLibrary_Facet/LibrarySelection/LibSelection_Ddn')

WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySelection/PolyA_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySelection/PolyA_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Filters/SequencingLibrary_Facet/LibrarySourceMaterial/LibrarySourceMaterial_Ddn')
