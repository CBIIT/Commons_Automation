...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CCDI_phs002883_DiagClasSyst-ICD03.2_DiagBasis-NotReported_SamTumSt-Normal_Sex-Female_Race-Unknwn.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Demographics-Facet/Race/Unknown_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Demographics-Facet/Race/Unknown_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Diagnosis-Facet/Diagnosis_Basis/Diagnosis_Basis_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Diagnosis-Facet/Diagnosis_Basis/Diagnosis_Basis_Ddn')
