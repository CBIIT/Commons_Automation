...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CCDI_phs000471_FirstEvent-Progression_Sampleanatomic-NtReported_FileType-pdf.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Samples_Facet/AnatomicSite/NotReported_Chkbx'), 5)
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/pdf_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/pdf_Chkbx')
