...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CCDI_phs003519_Diagnosis-9540.1NeurofibromNOS_Sex-Male_TumClassif-Metast_StudyName.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Study_Facet/StudyName/SingleCellAtlasOfNF1NervSheathTum_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Study_Facet/StudyName/SingleCellAtlasOfNF1NervSheathTum_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Diagnosis-Facet/Diagnosis/9540.1Neurofibromatosis, NOS_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Diagnosis-Facet/Diagnosis/9540.1Neurofibromatosis, NOS_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Samples_Facet/SampleTumorClassification/SampleTumorClassif_Ddn'), 10)
