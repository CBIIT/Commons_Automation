...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_CCDI_phs002529_Sex-Female_StudyName_FileMap-Sample_LibrSelec-Random_LibrSourMol-Transcriptmic.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Study_Facet/StudyName/ComGenmcSeqOfPedCancrCMRI.KUCC_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Study_Facet/StudyName/ComGenmcSeqOfPedCancrCMRI.KUCC_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySelection/Random_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySelection/Random_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySourceMolecule/Transcriptomic_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySourceMolecule/Transcriptomic_Chkbx')
