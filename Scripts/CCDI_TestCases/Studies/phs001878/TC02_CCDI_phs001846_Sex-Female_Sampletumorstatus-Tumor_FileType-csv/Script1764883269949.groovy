...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CCDI_phs001738_Sex-Female_Sampletumorstatus-Tumor_FileType-csv.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/csv_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/csv_Chkbx')
