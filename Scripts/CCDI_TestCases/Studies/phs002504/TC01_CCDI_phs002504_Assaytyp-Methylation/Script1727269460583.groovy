...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CCDI_phs002504_Assaytyp-Methylation.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/DataCategory_Facet/AssayType/AssayType_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/DataCategory_Facet/AssayType/AssayType_Ddn')

WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/DataCategory_Facet/AssayType/MethylationArray_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/DataCategory_Facet/AssayType/MethylationArray_Chkbx')
