...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_CCDI_phs002599_FileMap-Sample_LibrSelect-HybridSelect_LibrSourMat-NotReportd_LibrSourMol-Genomic.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySelection/HybridSel_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySelection/HybridSel_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySourceMaterial/NotReported_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/SequencingLibrary_Facet/LibrarySourceMaterial/NotReported_Chkbx')
