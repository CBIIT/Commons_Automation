...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CCDI_phs002517_Sex-Male_Race-Asian_FileType-nifti_DataCat-RadioImaging.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/nifti_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/DataCategory_Facet/FileType/nifti_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/DataCategory_Facet/DataCategory/RadiologyImaging_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/DataCategory_Facet/DataCategory/RadiologyImaging_Chkbx')
