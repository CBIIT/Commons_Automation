...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CCDI_phs002517_Sampltumorstat-NotReported_Datacat-Radiologyimaging.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Samples_Facet/SampleTumorStatus/Notreported_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Samples_Facet/SampleTumorStatus/Notreported_Chkbx')
