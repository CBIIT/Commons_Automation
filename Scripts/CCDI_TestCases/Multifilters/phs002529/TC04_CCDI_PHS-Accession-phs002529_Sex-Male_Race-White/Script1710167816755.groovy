...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_CCDI_PHS-Accession-phs002529_Sex-Male_Race-White.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Demographics-Facet/Race/White_Chbx'), 5)

CustomKeywords.'utilities.TestRunner.clickTab'('CCDI/ExplorePage/Filters/Demographics-Facet/Race/White_Chbx')
