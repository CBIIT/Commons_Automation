...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_CCDI_PHS-Accession-phs002529_Sex-Female_Race-NativeHawaiianPacific.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('CCDI/ExplorePage/Filters/Study_Facet/PHS_Accession/PHS_Accession_Ddn')

WebUI.waitForElementPresent(findTestObject('CCDI/ExplorePage/Filters/Study_Facet/PHS_Accession/phs002529_Chkbx'),5)

CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('CCDI/ExplorePage/Filters/Study_Facet/PHS_Accession/phs002529_Chkbx')
