...
WebUI.waitForElementPresent(findTestObject('Object Repository/CCDI/Filters/Study_Facet/Study_Facet'), 10)
...
//query to be corrected in the excel or the code to be modified for -999 to not reported ?
