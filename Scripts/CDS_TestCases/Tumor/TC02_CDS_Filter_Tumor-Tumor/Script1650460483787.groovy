...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_CDS_Filter_Tumor-Tumor.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Z-ObsoleteObjects/Tumor/Tumor-Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/Tumor/Tumor-Chkbx')
