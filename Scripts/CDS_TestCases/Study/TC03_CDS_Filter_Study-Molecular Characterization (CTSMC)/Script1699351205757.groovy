...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CDS_Filter_Study-Molecular Characterization (CTSMC).xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/StudyFacet/StudyName/CDS-Study-Molecular Characterization (CTSMC)-Chkbx')
