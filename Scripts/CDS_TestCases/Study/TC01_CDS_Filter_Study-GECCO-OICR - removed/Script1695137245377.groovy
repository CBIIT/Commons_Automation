...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CDS_Filter_Study-GECCO-OICR.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/StudyFacet/StudyName/CDS-Study-NCI-CCSG_CCDI-Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/Study/CDS-Study-GECCO-OICR-Chkbx')
