...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_CDS_phs001524_LibrarySelection_HybridSelection.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/StudyFacet/PHS_Accession/phs001524_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/StudyFacet/PHS_Accession/phs001524_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibrarySelection/HybridSelection_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibrarySelection/HybridSelection_Chkbx')
