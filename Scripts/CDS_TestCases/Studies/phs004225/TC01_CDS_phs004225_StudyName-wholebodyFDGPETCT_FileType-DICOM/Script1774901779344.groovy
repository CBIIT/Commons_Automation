...
//Clicking checkbox 
//WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/StudyFacet/PHS_Accession/phs004225_Chkbx'),5)
...
WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/StudyFacet/StudyName/CDS-Study-A whole-body FDG-PETCT dataset with manually annotated tumor lesions-Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/StudyFacet/StudyName/CDS-Study-A whole-body FDG-PETCT dataset with manually annotated tumor lesions-Chkbx')
...
//Clicking Image Modality dropdown
//WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/ImagingFacet/ImageModality/ImageModality_Ddn'),5)
//CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/ImagingFacet/ImageModality/ImageModality_Ddn')

//Clicking Image Modality checkbox
//WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/ImagingFacet/ImageModality/CT_Chkbx'),5)
//CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/ImagingFacet/ImageModality/CT_Chkbx')
