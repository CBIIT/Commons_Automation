...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CDS_phs00422511_StudyName-CTRTSTRUCTRTDOSERTPLAN_StudyDataTypes-Imaging.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/StudyFacet/StudyName/CDS-Study-CT-RTSTRUCT-RTDOSE-RTPLAN Sets of Head and Neck Cancers Treated with Identical Prescriptions using IMRT-Chkbx')
...
//Clicking Imaging checkbox
WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/StudyFacet/StudyDataTypes/Imaging-Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/StudyFacet/StudyDataTypes/Imaging-Chkbx')
