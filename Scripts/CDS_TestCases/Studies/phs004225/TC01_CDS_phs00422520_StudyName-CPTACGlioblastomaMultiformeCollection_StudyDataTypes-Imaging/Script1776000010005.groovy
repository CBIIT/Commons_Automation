...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_CDS_phs00422520_StudyName-CPTACGlioblastomaMultiformeCollection_StudyDataTypes-Imaging.xlsx')
...
// Scroll down inside the Study Name facet list (virtualized rows) so the CPTAC GBM checkbox can mount in the DOM
...
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/StudyFacet/StudyName/CDS-Study-The Clinical Proteomic Tumor Analysis Consortium Glioblastoma Multiforme Collection-Chkbx')
