...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_CDS_phs002517_LibrarySource_Genomic.xlsx')
...
WebUI.waitForElementPresent(findTestObject('CDS/Data_page/Filter/StudyFacet/PHS_Accession/phs002517_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Data_page/Filter/StudyFacet/PHS_Accession/phs002517_Chkbx')
