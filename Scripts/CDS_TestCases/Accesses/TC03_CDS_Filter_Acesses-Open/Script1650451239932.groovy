...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_CDS_Filter_Acesses-Open.xlsx')
...
//Clicking open checkbox
WebUI.waitForElementPresent(findTestObject('CDS/Z-ObsoleteObjects/Accesses/Open-Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('CDS/Filter/Accesses/Open-Chkbx')
