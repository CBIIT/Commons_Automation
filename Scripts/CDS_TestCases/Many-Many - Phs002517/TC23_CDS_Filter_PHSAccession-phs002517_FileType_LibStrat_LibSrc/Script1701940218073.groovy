...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC23_CDS_Filter_PHSAccession-phs002517_FileType_LibStrat_LibSrc.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/PHS_Accession/phs002517_Chkbx'),10)
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/FileType/FileType_Ddn')

//Clicking the desired File Type checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/FileType/CSV-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/FileType/CSV-Chkbx')

//Clicking the Library Strategy dropdown
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/LibraryStrategy/Library_Strategy_Ddn'),5)
...
//Clicking the desired Library Strategy checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/LibraryStrategy/WXS_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/LibraryStrategy/WXS_Chkbx')

//Clicking the LibrarySource dropdown
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/LibrarySource/LibrarySource_Ddn'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/LibrarySource/LibrarySource_Ddn')

//Clicking the desired LibrarySource checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/LibrarySource/Genomic_Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/LibrarySource/Genomic_Chkbx')
