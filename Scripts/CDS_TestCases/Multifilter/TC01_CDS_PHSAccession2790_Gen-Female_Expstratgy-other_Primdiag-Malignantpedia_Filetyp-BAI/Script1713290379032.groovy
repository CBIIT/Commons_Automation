...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC13_CDS_PHSAccession2479_Gen-Female_Libstrategy-RNA-seq_Liblayout-Singleend_Libselc-PolyA_Primdiag-IMC.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/StudyFacet/PHS_Accession/phs002479_Chkbx')
...
//Clicking Female checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/DemographicsFacet/Gender/Female-Chkbx'),5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/DemographicsFacet/Gender/Female-Chkbx')


//Clicking Library Strategies dropdown
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibraryStrategy/Library_Strategy_Ddn'),15)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibraryStrategy/Library_Strategy_Ddn'')

//Clicking RNA Seq checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibraryStrategy/RNASeq_Chkbx''),15)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibraryStrategy/RNASeq_Chkbx'')

//Clicking Library Layout Status
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibraryLayout/LibraryLayout_Ddn'),15)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibraryLayout/LibraryLayout_Ddn')
	
	 	
//Clicking Single end  Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibraryLayout/Singleend_Chkbx'),15)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibraryLayout/Singleend_Chkbx')
	
//Clicking Library Selection Status
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibrarySelection/LibrarySelection_Ddn'),15)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibrarySelection/LibrarySelection_Ddn')
	
		
//Clicking PolyA  Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibrarySelection/PolyA_Chkbx'),15)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/SequencingFacet/LibrarySelection/PolyA_Chkbx')
	

//Clicking Primary Diagnosis Status
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/DiagnosisFacet/PrimaryDiagnosis/PrimaryDiagnosis-Ddn'),15)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/DiagnosisFacet/PrimaryDiagnosis/PrimaryDiagnosis-Ddn')

 

//Clicking Invasive Mammary Carcinoma Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/DiagnosisFacet/PrimaryDiagnosis/InvasiveMammaryCarcinoma_Chkbx'),15)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/DiagnosisFacet/PrimaryDiagnosis/InvasiveMammaryCarcinoma_Chkbx')
