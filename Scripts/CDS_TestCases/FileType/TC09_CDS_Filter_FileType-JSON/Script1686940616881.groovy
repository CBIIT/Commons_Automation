...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_CDS_Filter_FileType-JSON.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/CDS/Data_page/Filter/FilesFacet/FileType/json-Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCDSStat'('Object Repository/CDS/Data_page/Filter/FileType/json-Chkbx')
