...
// Send API request
String API_Object_Path ='Object Repository/API/Federation/AggregationLayer/AL_SubjectCountsByEthnicity'
...
def allowedValuesData = TestDataFactory.findTestData('Data Files/API/Enum-Subject_Ethnicity')
