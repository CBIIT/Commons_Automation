...
// Send API request
String API_Object_Path ='Object Repository/API/Federation/AggregationLayer/AL_SubjectCountsByVitalStatus'
...
def allowedValuesData = TestDataFactory.findTestData('Data Files/API/Enum-Subject_VitalStatus')
