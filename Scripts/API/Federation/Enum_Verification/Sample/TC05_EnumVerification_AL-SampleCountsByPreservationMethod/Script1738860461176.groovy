...
// Send API request
String API_Object_Path ='Object Repository/API/Federation/AggregationLayer/AL_SampleCounts_by_PreservationMethod'
...
def allowedValuesData = TestDataFactory.findTestData('Data Files/API/Enum-Sample_PreservationMethod')
