...
// Send API request
String API_Object_Path ='Object Repository/API/Federation/AggregationLayer/AL_SampleCounts_by_SpecimenMolecularAnalyteType'
...
def allowedValuesData = TestDataFactory.findTestData('Data Files/API/Enum-Sample_SpecimenMolecularAnalyteType')
