...
// Send API request
String API_Object_Path ='Object Repository/API/Federation/AggregationLayer/AL_SampleCounts_by_DiagnosisCategory'
...
def allowedValuesData = TestDataFactory.findTestData('Data Files/API/Enum-Sample_DiagnosisCategory')
