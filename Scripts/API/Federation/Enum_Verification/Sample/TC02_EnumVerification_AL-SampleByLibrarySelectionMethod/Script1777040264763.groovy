...
// Send API request
String API_Object_Path ='Object Repository/API/Federation/AggregationLayer/AL_SampleCounts_by_LibrarySelectionMethod'
...
def allowedValuesData = TestDataFactory.findTestData('Data Files/API/Enum-Sample_LibrarySelectionMethod')
