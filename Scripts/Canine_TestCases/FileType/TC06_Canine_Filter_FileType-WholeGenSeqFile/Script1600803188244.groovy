...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_Canine_Filter_FileType-WholeGenSeqFile.xlsx')
...
//Clicking on the FileType filter and WholeGenome SeqFile option


CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/WholeGenSeqFile_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
