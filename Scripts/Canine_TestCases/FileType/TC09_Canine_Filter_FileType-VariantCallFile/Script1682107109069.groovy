...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Canine_Filter_FileType-VariantCallFile.xlsx')
...
//Clicking on the FileType filter and VariantCallFile option


CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/VariantCallFile_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
