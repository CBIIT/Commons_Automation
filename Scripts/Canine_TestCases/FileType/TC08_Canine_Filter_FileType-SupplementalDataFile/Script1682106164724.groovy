...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_Canine_Filter_FileType-SupplementalDataFile.xlsx')
...
//Clicking on the FileType filter and SupplementalDataFile option


CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/SupplementalDataFile_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
