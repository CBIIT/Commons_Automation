...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Canine_Filter_FileType-WholeExoSeqFile.xlsx')
...
//Clicking on the FileType filter and WholeExome SeqFile option
