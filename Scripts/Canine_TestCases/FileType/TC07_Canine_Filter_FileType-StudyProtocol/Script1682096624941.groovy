...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_Canine_Filter_FileType-StudyProtocol.xlsx')
...
//Clicking on the FileType filter and StudyProtocol option


CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/StudyProtocol_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
