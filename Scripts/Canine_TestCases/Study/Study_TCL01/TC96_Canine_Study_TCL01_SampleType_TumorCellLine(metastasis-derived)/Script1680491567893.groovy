...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC96_Canine_Study_TCL01_SampleType_TumorCellLine(metastasis-derived).xlsx')   //changed for MGT
...
'Selects the specific check box Filter \'Sample Site\' from left pane'
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SampleType/TumorCellLine(metastasis-derived)_Chbx')
