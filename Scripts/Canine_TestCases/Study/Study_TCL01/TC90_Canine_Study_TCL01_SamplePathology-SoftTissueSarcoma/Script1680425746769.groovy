...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC90_Canine_Study_TCL01_SamplePathology-SoftTissueSarcoma.xlsx')   //changed for MGT
...
'Selects the specific check box Filter \'Sample Pathology\' from left pane'
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SamplePathology/SoftTissueSarcoma_Chkbx')
