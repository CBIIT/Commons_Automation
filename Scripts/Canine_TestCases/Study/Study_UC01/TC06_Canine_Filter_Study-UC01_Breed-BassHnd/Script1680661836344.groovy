...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_Canine_Filter_Study-UC01_Breed-BassHnd.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/BassHnd_Chkbx'), 5)
