...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC015_Canine_Study_MGT01_FileType_WholeExomeSeqFile.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/FileType/WholeExoSeqFile_Chkbx'), 5)
