...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC43_Canine_Study_MGT01_PrimaryDiseaseSite_NotApplicable.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/NotApplicable_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/NotApplicable_Chkbx')
