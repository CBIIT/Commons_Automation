...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC38_Canine_Study_MGT01_Breed_ShihTzu.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/ShihTzu_Chkbx'), 5)
