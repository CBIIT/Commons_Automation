...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Canine_Study_MGT01_Biobank_CSU_UCD.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Biobank/CSU-ACTR_Chkbx')
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Biobank/UCD-SVM_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Biobank/UCD-SVM_Chkbx')
