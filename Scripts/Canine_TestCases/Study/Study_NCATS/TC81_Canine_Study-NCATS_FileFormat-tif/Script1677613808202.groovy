...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC81_Canine_Study-NCATS_FileFormat-tif.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/CanineResults_StudyFiles_Tab'), 10)
