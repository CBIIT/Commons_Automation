...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Canine_Study-UBC02_Breed-Boxer.xlsx')
...
//Breed Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Boxer_Chkbx'),5)
