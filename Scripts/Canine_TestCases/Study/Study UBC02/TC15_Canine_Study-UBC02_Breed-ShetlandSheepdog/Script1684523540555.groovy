...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_Canine_Study-UBC02_Breed-ShetlandSheepdog.xlsx')
...
//Breed Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/ShetlandShpdog_Chkbx'),5)
