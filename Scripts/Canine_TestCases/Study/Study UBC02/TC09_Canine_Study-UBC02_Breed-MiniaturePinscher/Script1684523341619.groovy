...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Canine_Study-UBC02_Breed-MiniaturePinscher.xlsx')
...
//Breed Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/MiniaturePinscher_Chkbx'),5)
