...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC57_Canine_Study_OSA01_SampleSite_SubcutaneousTissue.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Subcutaneous_Tissue_Chkbx'), 5)
