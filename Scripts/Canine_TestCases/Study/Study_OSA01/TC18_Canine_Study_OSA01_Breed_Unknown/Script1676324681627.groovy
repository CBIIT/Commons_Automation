...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC18_Canine_Study_OSA01_Breed_Unknown.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Unknown_Chkbx'), 5)
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/Unknown_Chkbx')
