...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC20_Canine_Study_OSA01_Diagnosis_Unknown.xlsx')
...
'Selects the specific check box from \'Diagnosis\' filter.'
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Diagnosis/Unknown_Chkbx')
