...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC50_Canine_Study_OSA01_FileType_WholeGenomeSeqFile.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/FileType/WholeGenSeqFile_Chkbx'), 5)
