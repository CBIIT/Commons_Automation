...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC26_Canine_Study_OSA01_ResponsetoTreatment_NotDeter.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Study/Canine_Filter_Study-OSA01_Chkbx'), 5)
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/ResponseToTreatment/NotDetermined_Chkbx'), 5)
