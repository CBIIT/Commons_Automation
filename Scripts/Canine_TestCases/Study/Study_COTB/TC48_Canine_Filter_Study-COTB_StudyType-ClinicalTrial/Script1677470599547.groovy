...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC48_Canine_Filter_Study-COTB_StudyType-ClinicalTrial.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Study/Canine_Filter_Study-COTB_Chkbx')

//Click Study Type//
WebUI.waitForElementPresent(findTestObject('Canine/Filter/StudyType/StudyType_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/StudyType/StudyType_Ddn')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/StudyType/Canine_Filter_StudyType-ClinTrials_Chkbx')*/
