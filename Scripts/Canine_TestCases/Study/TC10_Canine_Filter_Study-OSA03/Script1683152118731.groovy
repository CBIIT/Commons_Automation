...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_Canine_Filter_Study-OSA03.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Study/Canine_Filter_Study-OSA03_Chkbx'), 5)
...
//this is temporarily added to check dog icon remove breed and stage of disease later
/*
//breed
