...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_Filter_Study-COTB.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Study/Canine_Filter_Study-COTB_Chkbx'), 5)
