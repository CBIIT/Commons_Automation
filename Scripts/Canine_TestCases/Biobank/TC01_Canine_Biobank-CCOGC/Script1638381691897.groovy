...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_Biobank-CCOGC.xlsx') 
...
//WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Biobank/CCOGC_Chkbx'), 30)  //changed for MGT
 
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Biobank/CCOGC_Chkbx'), 5)
