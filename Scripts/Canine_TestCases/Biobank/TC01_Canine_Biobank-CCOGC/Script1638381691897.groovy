...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_Canine_Biobank-CCOGC.xlsx')   //changed for MGT
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Biobank/CCOGC_Chkbx'), 5)  //changed for MGT

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Object Repository/Canine/Filter/Biobank/CCOGC_Chkbx') //changed for MGT
