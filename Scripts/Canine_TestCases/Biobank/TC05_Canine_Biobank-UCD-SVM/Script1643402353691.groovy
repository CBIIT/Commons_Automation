...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Canine_Biobank-UCD-SVM.xlsx')   //changed for MGT
...
//WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Biobank/UCD-SVM_Chkbx'), 30)

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Biobank/UCD-SVM_Chkbx'), 5) 
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Biobank/UCD-SVM_Chkbx') 
