...
//Sample Site - Bladder Trigone
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_Canine_SampleSite-BladderTrigone.xlsx')   //changed for MGT
...
//WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/FilterBySamples_Facet'), 20)
//WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/FilterBySamples_Facet'), 5)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleSite/BladderTrigone_Chkbx'), 30)  //changed for MGT

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleSite/BladderTrigone_Chkbx'), 5)  //changed for MGT

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Object Repository/Canine/Filter/SampleSite/BladderTrigone_Chkbx') //changed for MGT
