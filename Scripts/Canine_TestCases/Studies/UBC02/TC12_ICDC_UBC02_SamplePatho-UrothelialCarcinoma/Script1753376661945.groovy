...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_ICDC_UBC02_SamplePatho-UrothelialCarcinoma.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SamplePathology/UroCarcinoma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SamplePathology/UroCarcinoma_Chkbx')
