...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_ICDC_UBC02_FileFormat-docx.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/FileFormat/docx_Chkbx'), 5)
