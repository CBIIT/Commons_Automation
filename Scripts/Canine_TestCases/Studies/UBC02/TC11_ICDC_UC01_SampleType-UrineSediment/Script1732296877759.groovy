...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_ICDC_UC01_SampleType-UrineSediment.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleType/UrineSediment_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SampleType/UrineSediment_Chkbx')
