...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC30_ICDC_OSA04_FileFormat-h5.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileFormat/h5_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/h5_Chkbx')
