 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_ICDC_OSA04_Breed-DobermanPinscher.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/DobrmnPinsh_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/DobrmnPinsh_Chkbx')
