...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC26_ICDC_OSA04_FileType-scATACSequenceFile.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileType/scATACSeqFile_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileType/scATACSeqFile_Chkbx')
