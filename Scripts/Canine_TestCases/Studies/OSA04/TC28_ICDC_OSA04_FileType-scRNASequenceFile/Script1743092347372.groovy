...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC28_ICDC_OSA04_FileType-scRNASequenceFile.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileType/scRNASeqFile_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileType/scRNASeqFile_Chkbx')
