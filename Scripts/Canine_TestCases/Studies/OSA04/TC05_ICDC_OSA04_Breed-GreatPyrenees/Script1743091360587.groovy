 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_ICDC_OSA04_Breed-GreatPyrenees.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/GreatPyrenees_Chkbx'), 5)
