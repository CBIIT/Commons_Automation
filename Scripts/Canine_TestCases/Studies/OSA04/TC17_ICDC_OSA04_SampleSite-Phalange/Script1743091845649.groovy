...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC17_ICDC_OSA04_SampleSite-Phalange.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Phalange_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Phalange_Chkbx')
