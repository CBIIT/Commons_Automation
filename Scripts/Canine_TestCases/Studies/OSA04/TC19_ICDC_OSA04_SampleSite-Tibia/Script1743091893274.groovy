...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC19_ICDC_OSA04_SampleSite-Tibia.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Tibia_Chkbx'), 5)
