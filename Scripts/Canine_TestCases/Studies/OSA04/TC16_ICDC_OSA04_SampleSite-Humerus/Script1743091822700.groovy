...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC16_ICDC_OSA04_SampleSite-Humerus.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Humerus_Chkbx'), 5)
