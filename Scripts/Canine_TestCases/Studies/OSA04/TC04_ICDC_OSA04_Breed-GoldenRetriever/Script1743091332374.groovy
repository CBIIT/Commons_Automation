 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_ICDC_OSA04_Breed-GoldenRetriever.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/GoldenRetr_Chkbx'), 5)
