...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC22_ICDC_OSA04_SamplePatho-NotApplicable.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Study/Canine_Filter_Study-OSA04_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Study/Canine_Filter_Study-OSA04_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SamplePathology/NotApplicable_Chkbx'), 5)
