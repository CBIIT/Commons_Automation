...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC23_ICDC_OSA04_SamplePatho-Osteosarcoma.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SamplePathology/Osteosarcoma_Chkbx'), 5)
