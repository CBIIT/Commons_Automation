...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC27_ICDC_OSA04_FileType-scH5MatrixFile.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileType/scH5MatrixFile_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileType/scH5MatrixFile_Chkbx')
