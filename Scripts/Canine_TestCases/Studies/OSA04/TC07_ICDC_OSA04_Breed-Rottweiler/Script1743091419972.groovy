 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_ICDC_OSA04_Breed-Rottweiler.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Rottweiler_Chkbx'), 5)
