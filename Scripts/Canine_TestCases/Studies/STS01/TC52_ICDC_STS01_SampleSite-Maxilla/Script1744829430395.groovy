...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC52_ICDC_STS01_SampleSite-Maxilla.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Maxilla_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Maxilla_Chkbx')
