...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC20_ICDC_STS01_PrimDisSite-Hip.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Hip_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Hip_Chkbx')
