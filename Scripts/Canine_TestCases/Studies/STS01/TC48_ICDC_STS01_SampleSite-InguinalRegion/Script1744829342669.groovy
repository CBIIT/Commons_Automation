...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC48_ICDC_STS01_SampleSite-InguinalRegion.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/InguinalRegion_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/InguinalRegion_Chkbx')
