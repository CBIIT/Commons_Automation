...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC39_ICDC_STS01_SampleSite-Abdomen.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Abdomen_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Abdomen_Chkbx')
