...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC54_ICDC_STS01_SampleSite-RibRegion.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/RibRegion_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/RibRegion_Chkbx')
