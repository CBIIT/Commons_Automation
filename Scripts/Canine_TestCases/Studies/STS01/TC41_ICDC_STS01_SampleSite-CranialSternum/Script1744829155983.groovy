...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC41_ICDC_STS01_SampleSite-CranialSternum.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/CranialSternum_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/CranialSternum_Chkbx')
