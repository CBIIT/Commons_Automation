...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC16_ICDC_STS01_PrimDisSite-CranialSternum.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/CranialSternum_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/CranialSternum_Chkbx')
