...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC59_ICDC_STS01_SampleSite-Thigh.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Thigh_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Thigh_Chkbx')
