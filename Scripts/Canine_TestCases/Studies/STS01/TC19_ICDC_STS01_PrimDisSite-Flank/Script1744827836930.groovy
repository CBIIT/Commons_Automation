...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC19_ICDC_STS01_PrimDisSite-Flank.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Flank_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Flank_Chkbx')
