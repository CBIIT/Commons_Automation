...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC21_ICDC_STS01_PrimDisSite-Hock.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Hock_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Hock_Chkbx')
