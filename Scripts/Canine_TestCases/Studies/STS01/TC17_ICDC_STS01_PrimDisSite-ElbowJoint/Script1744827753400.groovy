...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC17_ICDC_STS01_PrimDisSite-ElbowJoint.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/ElbowJoint_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/ElbowJoint_Chkbx')
