...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC23_ICDC_STS01_PrimDisSite-InguinalRegion.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/InguinalRegion_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/InguinalRegion_Chkbx')
