...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC61_ICDC_STS01_SampleSite-Unknown.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Unknown_Chkbx'), 5)
