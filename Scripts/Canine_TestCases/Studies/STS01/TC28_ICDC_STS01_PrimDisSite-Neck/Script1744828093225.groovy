...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC28_ICDC_STS01_PrimDisSite-Neck.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Neck_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Neck_Chkbx')
