...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC46_ICDC_STS01_SampleSite-Hock.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Hock_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Hock_Chkbx')
