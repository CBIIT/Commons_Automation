...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC60_ICDC_STS01_SampleSite-Thorax.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Thorax_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Thorax_Chkbx')
