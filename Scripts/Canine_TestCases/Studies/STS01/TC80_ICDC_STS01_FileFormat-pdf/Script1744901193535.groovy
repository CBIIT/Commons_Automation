...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC80_ICDC_STS01_FileFormat-pdf.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileFormat/pdf_Chkbx'), 5)
