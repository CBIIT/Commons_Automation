...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC32_ICDC_STS01_PrimDisSite-Thorax.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Thorax_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Thorax_Chkbx')
