...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC51_ICDC_STS01_SampleSite-Mandible.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Mandible_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Mandible_Chkbx')
