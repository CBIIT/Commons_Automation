...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC25_ICDC_STS01_PrimDisSite-Lip.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Lip_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Lip_Chkbx')
