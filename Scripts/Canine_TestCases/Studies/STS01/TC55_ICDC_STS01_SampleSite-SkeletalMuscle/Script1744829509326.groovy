...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC55_ICDC_STS01_SampleSite-SkeletalMuscle.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/SkeletalMuscle_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/SkeletalMuscle_Chkbx')
