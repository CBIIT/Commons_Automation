...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC42_ICDC_STS01_SampleSite-ElbowJoint.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/ElbowJoint_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/ElbowJoint_Chkbx')
