...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC45_ICDC_STS01_SampleSite-Hip.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Hip_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Hip_Chkbx')
