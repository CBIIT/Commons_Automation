...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC22_ICDC_STS01_PrimDisSite-Humerus.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Humerus_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Humerus_Chkbx')
