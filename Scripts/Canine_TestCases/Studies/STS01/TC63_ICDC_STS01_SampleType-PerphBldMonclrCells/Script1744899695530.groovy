...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC63_ICDC_STS01_SampleType-PerphBldMonclrCells.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/SampleType/PeriphBloodMonCells_Chbx'), 5) 
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SampleType/PeriphBloodMonCells_Chbx')
