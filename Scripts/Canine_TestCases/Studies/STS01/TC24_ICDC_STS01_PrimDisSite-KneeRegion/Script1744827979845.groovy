...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC24_ICDC_STS01_PrimDisSite-KneeRegion.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/KneeRegion_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/KneeRegion_Chkbx')
