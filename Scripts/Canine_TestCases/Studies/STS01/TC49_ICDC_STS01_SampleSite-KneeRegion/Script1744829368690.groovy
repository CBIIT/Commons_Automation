...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC49_ICDC_STS01_SampleSite-KneeRegion.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/KneeRegion_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/KneeRegion_Chkbx')
