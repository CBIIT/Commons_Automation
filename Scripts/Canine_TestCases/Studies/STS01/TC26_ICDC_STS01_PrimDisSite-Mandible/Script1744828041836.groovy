...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC26_ICDC_STS01_PrimDisSite-Mandible.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Mandible_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Mandible_Chkbx')
