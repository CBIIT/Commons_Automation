...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_ICDC_STS01_PrimDisSite-Abdomen.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Abdomen_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Abdomen_Chkbx')
