...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC53_ICDC_STS01_SampleSite-Neck.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Neck_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Neck_Chkbx')
