...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC29_ICDC_STS01_PrimDisSite-RibRegion.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/RibRegion_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/RibRegion_Chkbx')
