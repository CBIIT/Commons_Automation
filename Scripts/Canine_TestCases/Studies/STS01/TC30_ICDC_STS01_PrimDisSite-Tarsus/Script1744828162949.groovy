...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC30_ICDC_STS01_PrimDisSite-Tarsus.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Tarsus_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Tarsus_Chkbx')
