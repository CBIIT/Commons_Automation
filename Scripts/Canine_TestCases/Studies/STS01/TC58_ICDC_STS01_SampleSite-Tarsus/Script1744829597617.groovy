...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC58_ICDC_STS01_SampleSite-Tarsus.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Tarsus_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Tarsus_Chkbx')
