...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC66_ICDC_STS01_SamplePatho-Fibrosarcoma.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/SamplePathology/Fibrosarcoma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SamplePathology/Fibrosarcoma_Chkbx')
