...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Diagnosis/SoftTissueSarcoma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Diagnosis/SoftTissueSarcoma_Chkbx')
