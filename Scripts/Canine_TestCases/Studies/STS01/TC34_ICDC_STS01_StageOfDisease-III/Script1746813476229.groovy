...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC34_ICDC_STS01_StageOfDisease-III.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/StageOfDisease/3_Chkbx'), 5)
