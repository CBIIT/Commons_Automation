...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC67_ICDC_STS01_SamplePatho-PerphNervSheathTum.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/SamplePathology/PeriphNerveSheathTum_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SamplePathology/PeriphNerveSheathTum_Chkbx')
