...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC32_ICDC_UBC03_FileAssociation-Study.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileAssociation/study_Chkbx'), 5)
