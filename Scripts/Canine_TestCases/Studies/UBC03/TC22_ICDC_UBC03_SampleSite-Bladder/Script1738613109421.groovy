...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC22_ICDC_UBC03_SampleSite-Bladder.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Bladder_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Bladder_Chkbx')
