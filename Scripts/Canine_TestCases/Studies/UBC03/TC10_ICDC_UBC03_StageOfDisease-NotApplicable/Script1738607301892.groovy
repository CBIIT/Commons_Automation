...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_ICDC_UBC03_StageOfDisease-NotApplicable.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/StageOfDisease/NotApplicable_Chkbx'), 5)
