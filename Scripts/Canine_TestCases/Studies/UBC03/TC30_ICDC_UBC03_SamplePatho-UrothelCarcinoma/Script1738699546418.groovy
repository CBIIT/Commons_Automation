...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC30_ICDC_UBC03_SamplePatho-UrothelCarcinoma.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/SamplePathology/UroCarcinoma_Chkbx'), 5)
