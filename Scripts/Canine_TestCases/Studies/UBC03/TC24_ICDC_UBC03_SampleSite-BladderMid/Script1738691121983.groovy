...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC24_ICDC_UBC03_SampleSite-BladderMid.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/BladderMid_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/BladderMid_Chkbx')
