...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC38_ICDC_UBC03_FileFormat-csv.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileFormat/csv_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/csv_Chkbx')
