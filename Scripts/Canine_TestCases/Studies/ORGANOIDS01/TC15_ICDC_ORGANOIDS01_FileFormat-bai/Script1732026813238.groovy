...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_ICDC_ORGANOIDS01_FileFormat-bai.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/FILEFORMAT_Ddn')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/FileFormat/bai_Chkbx'), 5)
