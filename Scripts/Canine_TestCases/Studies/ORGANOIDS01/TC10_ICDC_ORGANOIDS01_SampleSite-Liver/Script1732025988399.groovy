...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_ICDC_ORGANOIDS01_SampleSite-Liver.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Liver_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SampleSite/Liver_Chkbx')
