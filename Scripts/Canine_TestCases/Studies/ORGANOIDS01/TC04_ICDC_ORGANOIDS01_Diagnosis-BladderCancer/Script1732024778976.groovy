...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_ICDC_ORGANOIDS01_Diagnosis-BladderCancer.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Diagnosis/DIAGNOSIS_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Diagnosis/DIAGNOSIS_Ddn')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/Diagnosis/BladderCancer_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Diagnosis/BladderCancer_Chkbx')
