...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_ICDC_ORGANOIDS01_PrimDisSite-Bladder.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/Bladder_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Bladder_Chkbx')
