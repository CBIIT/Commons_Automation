...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC14_ICDC_ORGANOIDS01_FileType-IndexFile.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/FileType/IndexFile_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileType/IndexFile_Chkbx')
