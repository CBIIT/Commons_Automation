...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_ICDC_ORGANOIDS01_NeuteredStatus-No.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/NeuteredStatus/NEUTEREDSTATUS_Ddn')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/NeuteredStatus/No_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/NeuteredStatus/No_Chkbx')
