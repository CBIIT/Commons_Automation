...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_ICDC_ORGANOIDS01_SamplePatho-EndometOrgand.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Study/Canine_Filter_Study-ORGANOIDS01_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Study/Canine_Filter_Study-ORGANOIDS01_Chkbx')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/SamplePathology/SAMPLEPATHOLOGY_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SamplePathology/SAMPLEPATHOLOGY_Ddn')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/SamplePathology/EndometOrgand_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SamplePathology/EndometOrgand_Chkbx')
