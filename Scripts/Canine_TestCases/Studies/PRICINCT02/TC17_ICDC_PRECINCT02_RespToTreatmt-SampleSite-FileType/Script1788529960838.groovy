...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC18_ICDC_PRECINCT01_RespToTreatmt-PartialResponse.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/ResponseToTreatment/RESPONSETOTREATMENT_Ddn')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/ResponseToTreatment/PartialResponse_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/ResponseToTreatment/PartialResponse_Chkbx')
