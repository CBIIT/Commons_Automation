...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileFormat/rtf_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/rtf_Chkbx')
