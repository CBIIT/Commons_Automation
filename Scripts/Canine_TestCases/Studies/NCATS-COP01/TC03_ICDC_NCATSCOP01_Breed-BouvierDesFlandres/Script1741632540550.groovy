 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_ICDC_NCATSCOP01_Breed-BouvierDesFlandres.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Bouvier_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Bouvier_Chkbx')
