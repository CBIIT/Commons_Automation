...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_ICDC_GLIOMA01_Diagnosis-Glioma.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Diagnosis/Glioma_Chkbx'), 5)
