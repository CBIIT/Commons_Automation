...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC29_ICDC_PRECINCT01_FileType-SupplementalDataFile.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileType/FILETYPE_Ddn')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/FileType/SupplementalDataFile_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileType/SupplementalDataFile_Chkbx')
