...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC31_ICDC_PRECINCT01_FileFormat-xlsx.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/FileFormat/xlsx_Chkbx'), 5)
