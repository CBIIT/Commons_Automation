...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC30_ICDC_PRECINCT01_FileFormat-pdf.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/FileFormat/pdf_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/pdf_Chkbx')
