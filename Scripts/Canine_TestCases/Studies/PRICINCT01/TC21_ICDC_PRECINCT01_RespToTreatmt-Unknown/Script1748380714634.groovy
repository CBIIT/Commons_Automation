...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC21_ICDC_PRECINCT01_RespToTreatmt-Unknown.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/ResponseToTreatment/Unknown_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/ResponseToTreatment/Unknown_Chkbx')
