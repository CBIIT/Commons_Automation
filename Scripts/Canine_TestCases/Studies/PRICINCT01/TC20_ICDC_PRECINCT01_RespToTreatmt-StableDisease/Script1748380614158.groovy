...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC20_ICDC_PRECINCT01_RespToTreatmt-StableDisease.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/ResponseToTreatment/StableDisease_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/ResponseToTreatment/StableDisease_Chkbx')
