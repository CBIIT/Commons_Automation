...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC19_ICDC_PRECINCT01_RespToTreatmt-ProgressiveDisease.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx')
