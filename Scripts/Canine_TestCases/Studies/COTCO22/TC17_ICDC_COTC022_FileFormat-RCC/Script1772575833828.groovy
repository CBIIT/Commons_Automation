...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC17_ICDC_COTC022_FileFormat-RCC.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileFormat/RCC_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/RCC_Chkbx')
