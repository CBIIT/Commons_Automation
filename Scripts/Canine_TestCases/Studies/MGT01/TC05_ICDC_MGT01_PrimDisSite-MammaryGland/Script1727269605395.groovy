...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_ICDC_MGT01_PrimDisSite-MammaryGland.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/MammaryGland_Chkbx'), 5)
