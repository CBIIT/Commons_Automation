...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_ICDC_MGT01_SamplePatho-SimpleCarcinoma.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/SamplePathology/SimpleCarcinoma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SamplePathology/SimpleCarcinoma_Chkbx')
