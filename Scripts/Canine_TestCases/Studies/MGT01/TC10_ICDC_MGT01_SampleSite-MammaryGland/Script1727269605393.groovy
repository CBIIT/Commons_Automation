...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_ICDC_MGT01_SampleSite-MammaryGland.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/MammaryGland_Chkbx'), 5)
