...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC54_ICDC_COTC021_FileType-NanoStrIOAnalysFile.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileType/NanoStrIOAnalysFile_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileType/NanoStrIOAnalysFile_Chkbx')
