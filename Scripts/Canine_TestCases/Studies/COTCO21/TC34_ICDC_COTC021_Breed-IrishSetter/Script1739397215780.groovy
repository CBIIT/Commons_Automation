...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC34_ICDC_COTC021_Breed-IrishSetter.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/IrishSetter_Chkbx'), 5)
