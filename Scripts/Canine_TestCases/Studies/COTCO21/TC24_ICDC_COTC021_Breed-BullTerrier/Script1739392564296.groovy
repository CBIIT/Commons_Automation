...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC24_ICDC_COTC021_Breed-BullTerrier.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/BullTerrier_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/BullTerrier_Chkbx')
