...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_ICDC_COTC026_SampleType-PrimMaligTumTissue.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/SampleType/SAMPLETYPE_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SampleType/SAMPLETYPE_Ddn')

WebUI.verifyElementPresent(findTestObject('Canine/Filter/SampleType/PrimMaligTumTissue_Chkbx'), 5) 
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SampleType/PrimMaligTumTissue_Chkbx')
