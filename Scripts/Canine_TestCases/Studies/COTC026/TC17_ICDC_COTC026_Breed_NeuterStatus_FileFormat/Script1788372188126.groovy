...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC17_ICDC_COTC026_Breed_NeuterStatus_FileFormat.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Greyhnd_Chkbx'), 5)
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileFormat/bai_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/bai_Chkbx')
