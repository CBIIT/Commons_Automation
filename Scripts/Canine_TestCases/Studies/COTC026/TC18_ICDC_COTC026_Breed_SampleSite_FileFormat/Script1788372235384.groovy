...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC18_ICDC_COTC026_Breed_SampleSite_FileFormat.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Study/Canine_Filter_Study-COTC026_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Study/Canine_Filter_Study-COTC026_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Mastiff_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Mastiff_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Bone_Chkbx'), 5)
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileFormat/bam_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/bam_Chkbx')
