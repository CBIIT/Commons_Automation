 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC46_ICDC_OSA02_Breed-SiberianHusky.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/SiberianHusky_Chkbx'), 5)
