...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC57_ICDC_OSA02_SampleSite-Scapula.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Scapula_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Scapula_Chkbx')
