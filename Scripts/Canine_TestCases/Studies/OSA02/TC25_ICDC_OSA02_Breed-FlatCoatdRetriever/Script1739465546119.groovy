 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC25_ICDC_OSA02_Breed-FlatCoatdRetriever.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Flat_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Flat_Chkbx')
