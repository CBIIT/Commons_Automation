...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC75_ICDC_OSA02_FileType-StudyProtocol.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileType/StudyProtocol_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileType/StudyProtocol_Chkbx')
