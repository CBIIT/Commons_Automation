 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC27_ICDC_OSA02_Breed-GermnShrthairdPntr.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/GermanShthrPntr_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/GermanShthrPntr_Chkbx')
