 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_ICDC_OSA02_Breed-Akita.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Akita_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Akita_Chkbx')
