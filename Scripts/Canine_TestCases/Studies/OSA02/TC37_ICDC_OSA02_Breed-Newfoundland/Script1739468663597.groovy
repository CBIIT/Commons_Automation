 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC37_ICDC_OSA02_Breed-Newfoundland.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Newfoundland_Chkbx'), 5)
