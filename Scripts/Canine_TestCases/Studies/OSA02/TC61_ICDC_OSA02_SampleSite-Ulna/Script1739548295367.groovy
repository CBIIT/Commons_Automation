...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC61_ICDC_OSA02_SampleSite-Ulna.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Ulna_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Ulna_Chkbx')
