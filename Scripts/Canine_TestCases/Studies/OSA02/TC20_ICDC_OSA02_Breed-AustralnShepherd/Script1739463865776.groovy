 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC20_ICDC_OSA02_Breed-AustralnShepherd.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/AusShephd_Chkbx'), 5)
