...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_ICDC_OSA02_FileFormat-tsv.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileFormat/tsv_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/FileFormat/tsv_Chkbx')
