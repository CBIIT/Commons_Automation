 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC29_ICDC_OSA02_Breed-GreatDane.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/GreatDane_Chkbx'), 5)
