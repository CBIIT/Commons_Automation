 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC18_ICDC_OSA02_Breed-AnatolnShphrdDog.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Anatolin_Shphrd_Dog_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Anatolin_Shphrd_Dog_Chkbx')
...
CustomKeywords.'utilities.TestRunner.multiFunction'('ICDC', GlobalVariable.G_StatBar_Cases, 'Canine/Canine_CasesTable',
	'Canine/Canine_TableHeader', 'Canine/Canine_CasesTabNextBtn', GlobalVariable.G_WebTabnameCases,
