...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC69_ICDC_OSA02_SamplePatho-OsteoblasticOsteosarcoma.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SamplePathology/Osteoblastic_Osteosarcoma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Osteoblastic_Osteosarcoma_Chkbx')
