 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC22_ICDC_OSA02_Breed-BerneseMntnDog.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/BernMtnDog_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/BernMtnDog_Chkbx')
