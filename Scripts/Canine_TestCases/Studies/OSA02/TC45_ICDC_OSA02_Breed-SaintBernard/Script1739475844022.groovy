 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC45_ICDC_OSA02_Breed-SaintBernard.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/SaintBnd_Chkbx'), 5)
