...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC59_ICDC_OSA02_SampleSite-SkinAndMuscle.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/SAMPLE_SITE_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/SAMPLE_SITE_Ddn')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/SkinMuscle_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/SkinMuscle_Chkbx')
