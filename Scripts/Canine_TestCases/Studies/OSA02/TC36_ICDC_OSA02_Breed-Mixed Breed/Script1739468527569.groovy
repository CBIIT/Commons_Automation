 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC36_ICDC_OSA02_Breed-MixedBreed.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Mixed_Chkbx'), 5)
