...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC64_ICDC_OSA02_SampleType-PrimMalgntTumTissue.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleType/PrimMaligTumTissue_Chkbx'), 5)
