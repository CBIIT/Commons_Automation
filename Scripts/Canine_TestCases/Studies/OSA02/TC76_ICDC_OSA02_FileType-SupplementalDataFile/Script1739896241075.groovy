...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC76_ICDC_OSA02_FileType-SupplementalDataFile.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileType/SupplementalDataFile_Chkbx'), 5)
