...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC14_ICDC_OSA02_FileType-IndexFile.xlsx')
...
WebUI.verifyElementPresent(findTestObject('Canine/Filter/FileType/IndexFile_Chkbx'), 5)
