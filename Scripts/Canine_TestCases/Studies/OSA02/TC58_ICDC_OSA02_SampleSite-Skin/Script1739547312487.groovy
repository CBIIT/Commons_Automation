...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC58_ICDC_OSA02_SampleSite-Skin.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Skin_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Skin_Chkbx')
