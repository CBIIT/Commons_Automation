 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC16_ICDC_OSA02_Breed-AiredaleTerrier.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/AiredaleTerrier_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/AiredaleTerrier_Chkbx')
