 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC43_ICDC_OSA02_Breed-RhodsnRidgeback.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/RhodesianRdgbck_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/RhodesianRdgbck_Chkbx')
