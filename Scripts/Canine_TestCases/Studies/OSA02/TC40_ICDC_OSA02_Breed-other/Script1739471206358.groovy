 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC40_ICDC_OSA02_Breed-other.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Other_Chkbx'), 5)
