 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC26_ICDC_OSA02_Breed-GermanShphrdDog.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/GermanShphd_Chkbx'), 5)
