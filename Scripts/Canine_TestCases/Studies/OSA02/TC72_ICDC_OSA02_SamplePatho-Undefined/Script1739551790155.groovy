...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC72_ICDC_OSA02_SamplePatho-Undefined.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SamplePathology/Undefined_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Undefined_Chkbx')
