 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC23_ICDC_OSA02_Breed-BorderCollie.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/BorderCol_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/BorderCol_Chkbx')
