...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC55_ICDC_OSA02_SampleSite-Lung.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleSite/Lung_Chkbx'), 5)
