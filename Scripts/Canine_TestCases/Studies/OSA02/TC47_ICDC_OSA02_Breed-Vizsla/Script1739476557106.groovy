 ...
 */
WebUI.closeBrowser()
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC47_ICDC_OSA02_Breed-Vizsla.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/Breed/Vizsla_Chkbx'), 5)
