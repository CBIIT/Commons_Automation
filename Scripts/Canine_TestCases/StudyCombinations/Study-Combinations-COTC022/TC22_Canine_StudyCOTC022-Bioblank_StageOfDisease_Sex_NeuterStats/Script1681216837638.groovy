 ...
 */
WebUI.closeBrowser()
//Study COTC022, Bioblank in (Not Applicable) and Stage of Disease (Not Determined) and Sex in (Female) and Neuterred Status in (Yes)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC22_Canine_StudyCOTC022-Bioblank_StageOfDisease_Sex_NeuterStats.xlsx')
