 ...
 */
WebUI.closeBrowser()
//Study COTC022, Stage of Disease (Not Determined) and Response to Treatment in (Not Determined) and Neutered Status in (Yes)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC24_Canine_StudyCOTC022-StageOfDisease_RespnseToTreat_NeuterStats.xlsx')
