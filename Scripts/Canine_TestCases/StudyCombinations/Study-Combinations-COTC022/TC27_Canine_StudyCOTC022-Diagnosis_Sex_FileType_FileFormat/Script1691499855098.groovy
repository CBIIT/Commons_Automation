 ...
 */
WebUI.closeBrowser()
//Study COTC022, Diagnosis in (Osteosarcoma) and Sex in (Female) and File Type (Supplemental Data File) and file format (xlsx)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC27_Canine_StudyCOTC022-Diagnosis_Sex_FileType_FileFormat.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileType/SupplDataFile_Chkbx')
