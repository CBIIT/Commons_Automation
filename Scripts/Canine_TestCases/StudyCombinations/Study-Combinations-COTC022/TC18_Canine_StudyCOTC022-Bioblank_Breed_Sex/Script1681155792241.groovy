 ...
 */
WebUI.closeBrowser()
//Study COTC022, Bioblank in (Not Applicable) and Breed in (Siberian Husky, Vizsla ) and Sex in (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC18_Canine_StudyCOTC022-Bioblank_Breed_Sex.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/SiberianHusky_Chkbx')

CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Vizsla_Chkbx')
