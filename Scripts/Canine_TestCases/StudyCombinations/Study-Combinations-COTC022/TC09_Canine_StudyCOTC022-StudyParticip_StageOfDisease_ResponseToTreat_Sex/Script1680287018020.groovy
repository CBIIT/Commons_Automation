 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Participation in (Single Study) and StageOfDisease in (Not Determined) and Complete Response in (Complete Response) and Sex in (Female)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Canine_StudyCOTC022-StudyParticip_StageOfDisease_ResponseToTreat_Sex.xlsx')
