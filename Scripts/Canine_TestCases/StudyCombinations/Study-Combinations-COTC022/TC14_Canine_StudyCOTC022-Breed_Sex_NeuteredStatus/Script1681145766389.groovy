 ...
 */
WebUI.closeBrowser()
//Study COTC022, Breed in (Newfoundland, Saint Bernard) and Sex in (Male) and Neutered Status in (Yes)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC14_Canine_StudyCOTC022-Breed_Sex_NeuteredStatus.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Newfoundland_Chkbx')
