 ...
 */
WebUI.closeBrowser()
//Study COTC022, Breed in (Chow Chow, Rottweiler ) and Primary Disease Site in (Bone (Axial)) and Sex in (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_Canine_StudyCOTC022-Breed_PrimDiseaseSite_Sex.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/ChowChow_Chkbx')
