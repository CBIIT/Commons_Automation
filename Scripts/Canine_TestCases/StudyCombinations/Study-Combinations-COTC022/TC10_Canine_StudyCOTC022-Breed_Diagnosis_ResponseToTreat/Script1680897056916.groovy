 ...
 */
WebUI.closeBrowser()
//Study COTC022, Breed in (Greyhound) and Diagnosis in (Osteosarcoma) and Response to Treatment in (Progressive Disease)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_Canine_StudyCOTC022-Breed_Diagnosis_ResponseToTreat.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Greyhnd_Chkbx')
