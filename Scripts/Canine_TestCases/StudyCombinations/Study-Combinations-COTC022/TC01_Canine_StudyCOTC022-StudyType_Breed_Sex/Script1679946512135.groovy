 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Type in (Clinical Trial) and Breed in (Australian Shepherd, Doberman Pinscher) and Sex in (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_StudyCOTC022-StudyType_Breed_Sex.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/AusShephd_Chkbx')
