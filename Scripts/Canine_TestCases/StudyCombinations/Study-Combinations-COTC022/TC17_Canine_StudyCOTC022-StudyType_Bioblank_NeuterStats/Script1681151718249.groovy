 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Type in (Clinical Trial) and Bioblank in (Not Applicable) Neutered Status in (No)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC17_Canine_StudyCOTC022-StudyType_Bioblank_NeuterStats.xlsx')
