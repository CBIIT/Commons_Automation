 ...
 */
WebUI.closeBrowser()
//Study COTC022, Primary Disease Site in (Bone (Appendicular)) and Response to Treatment in (Progressive Disease) and Sex in (Male) and Neutered Status in (No)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC16_Canine_StudyCOTC022-PrimDiseaseSite_RespToTreatnt_Sex_NeutStats.xlsx')
