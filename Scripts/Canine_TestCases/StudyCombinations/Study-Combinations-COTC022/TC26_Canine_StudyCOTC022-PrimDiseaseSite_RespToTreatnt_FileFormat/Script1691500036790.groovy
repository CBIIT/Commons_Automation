 ...
 */
WebUI.closeBrowser()
//Study COTC022, Primary Disease Site in (Bone (Appendicular)) and Response to Treatment in (Progressive Disease) and File Format

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC26_Canine_StudyCOTC022-PrimDiseaseSite_RespToTreatnt_FileFormat.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileFormat/docx_Chkbx')
