 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Participation in (Single Study) and Neutered Status in (Yes) and File Type

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC25_Canine_StudyCOTC022-StudyParticip_NeuteredStatus_FileType.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileType/StudyProtocol_Chkbx')
