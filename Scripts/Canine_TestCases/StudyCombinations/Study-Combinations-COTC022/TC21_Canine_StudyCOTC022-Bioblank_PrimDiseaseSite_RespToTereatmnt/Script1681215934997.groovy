 ...
 */
WebUI.closeBrowser()
//Study COTC022, Bioblank in (Not Applicable) and Primary Disease Site in (Bone (Appendicular)) and Response to Treatment in (Complete Response)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC21_Canine_StudyCOTC022-Bioblank_PrimDiseaseSite_RespToTereatmnt.xlsx')
