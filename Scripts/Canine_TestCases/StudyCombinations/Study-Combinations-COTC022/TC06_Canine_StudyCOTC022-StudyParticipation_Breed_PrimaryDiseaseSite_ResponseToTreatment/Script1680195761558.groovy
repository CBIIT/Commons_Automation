 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Participation in (Single Study) and Breed in (Labrador Retriever) and Primary Disease Site in (Bone (Appendicular)) and Response to Treatment (Progressive Disease)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_Canine_StudyCOTC022-StudyParticipation_Breed_PrimaryDiseaseSite_ResponseToTreatment.xlsx')
