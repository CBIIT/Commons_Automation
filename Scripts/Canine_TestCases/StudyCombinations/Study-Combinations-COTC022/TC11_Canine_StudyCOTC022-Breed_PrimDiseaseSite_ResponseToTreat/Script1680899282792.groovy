 ...
 */
WebUI.closeBrowser()
//Study COTC022, Breed in (Mixed Breed) and Primary Disease Site in (Bone (Appendicular)) and Response to Treatment in (Complete Response)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_Canine_StudyCOTC022-Breed_PrimDiseaseSite_ResponseToTreat.xlsx')
