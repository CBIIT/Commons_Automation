 ...
 */
WebUI.closeBrowser()
//Study COTC022, Bioblank in (Not Applicable) and Breed in (Bulldog, German Shepherd Dog) and Response to Treatment in (Progressive Disease)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC19_Canine_StudyCOTC022-Bioblank_Breed_ResponsToTretmnt.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Biobank/NotApplicable_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/GermanShphd_Chkbx')
