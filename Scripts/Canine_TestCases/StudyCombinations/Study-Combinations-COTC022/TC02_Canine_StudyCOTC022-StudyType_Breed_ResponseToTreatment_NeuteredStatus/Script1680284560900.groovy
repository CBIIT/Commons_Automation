 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Type in (Clinical Trial) and Breed in (Great Pyrenees) and Response to Treatment in (Progressive Disease) and Neutered Status in (No)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Canine_StudyCOTC022-StudyType_Breed_ResponseToTreatment_NeuteredStatus.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/StudyType/Canine_Filter_StudyType-ClinTrials_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/GreatPyrenees_Chkbx')
