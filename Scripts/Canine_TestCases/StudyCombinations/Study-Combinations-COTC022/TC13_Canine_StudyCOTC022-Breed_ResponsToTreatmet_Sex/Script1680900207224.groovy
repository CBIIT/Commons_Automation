 ...
 */
WebUI.closeBrowser()
//Study COTC022, Breed in (Irish Setter, Labrador Retriever) and Response to Treatment in (Not Determined) and Sex in (Female)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC13_Canine_StudyCOTC022-Breed_RespToTreatmet_Sex.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/IrishSetter_Chkbx')
