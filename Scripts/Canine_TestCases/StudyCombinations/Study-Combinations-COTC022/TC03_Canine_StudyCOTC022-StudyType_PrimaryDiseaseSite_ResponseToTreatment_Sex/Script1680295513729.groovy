 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Type in (Clinical Trial) and PrimaryDiseaseSite in (Bone (Appendicular)) and Response to Treatment in (Not Determined) and Sex in (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Canine_StudyCOTC022-StudyType_PrimaryDiseaseSite_ResponseToTreatment_Sex.xlsx')
