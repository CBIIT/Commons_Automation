 ...
 */
WebUI.closeBrowser()
//Study COTC022, Diagnosis in (Osteosarcoma) and Stage of Disease in (Not Determined) and Sex in (Female) and Neutered Status in (No)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_Canine_StudyCOTC022-Diagnosis_StageOfDisease_Sex_NeuterStats.xlsx')
