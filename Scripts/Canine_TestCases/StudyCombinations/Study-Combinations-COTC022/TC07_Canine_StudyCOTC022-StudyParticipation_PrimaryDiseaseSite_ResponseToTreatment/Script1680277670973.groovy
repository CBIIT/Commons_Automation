 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Participation in (Single Study) and Primary Disease Site in (Bone (Appendicular)) and Response to Treatment (Complete Response)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_Canine_StudyCOTC022-StudyParticipation_PrimaryDiseaseSite_ResponseToTreatment.xlsx')
