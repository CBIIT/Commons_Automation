 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Participation in (Single Study) and Diagnosis in (Osteosarcoma) and Primary Disease Site in (Bone (Axial))

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_Canine_StudyCOTC022-StudyParticipation_Diagnosis_PrimaryDiseaseSite.xlsx')
