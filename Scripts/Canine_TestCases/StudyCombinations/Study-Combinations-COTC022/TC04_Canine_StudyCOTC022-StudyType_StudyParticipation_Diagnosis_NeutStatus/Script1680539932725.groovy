 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Type in (Clinical Trial) and Study Participation in (Single Study) and Diagnosis in (Osteosarcome) and Neutered Status in (No)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_Canine_StudyCOTC022-StudyType_StudyParticip_Diagnosis_NeutStatus.xlsx')
