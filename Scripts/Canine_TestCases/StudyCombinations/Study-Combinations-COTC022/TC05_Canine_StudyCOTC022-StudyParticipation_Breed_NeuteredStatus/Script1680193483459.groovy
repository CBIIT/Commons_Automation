 ...
 */
WebUI.closeBrowser()
//Study COTC022, Study Participation in (Single Study) and Breed in (Great Dane) and Neutered Status in (Yes)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Canine_StudyCOTC022-StudyParticipation_Breed_NeuteredStatus.xlsx')
