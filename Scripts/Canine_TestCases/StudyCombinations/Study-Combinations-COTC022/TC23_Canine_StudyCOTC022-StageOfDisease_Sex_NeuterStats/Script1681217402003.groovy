 ...
 */
WebUI.closeBrowser()
//Study COTC022, Stage of Disease (Not Determined) and Sex in (Male) and Neutered Status in (No)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC23_Canine_StudyCOTC022-StageOfDisease_Sex_NeuterStats.xlsx')
