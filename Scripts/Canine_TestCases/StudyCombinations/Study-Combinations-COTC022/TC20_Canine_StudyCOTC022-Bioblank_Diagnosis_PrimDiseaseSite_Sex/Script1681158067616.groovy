 ...
 */
WebUI.closeBrowser()
//Study COTC022, Bioblank in (Not Applicable) and Diagnosis in (Osteosacroma) and Primary Disease Site in (Bone (Axial)) and Sex in (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC20_Canine_StudyCOTC022-Bioblank_Diagnosis_PrimDiseaseSite_Sex.xlsx')
