...
// UBC02-BorderCollie, ScottishTerrier -BladderCancer- BladdrUreth, Bladder
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Canine_StudyUBC02-Breed_Diagnosis_PrimDiseaseSite.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/BorderCol_Chkbx'),10)
