...
//UBC --  Miniature pinscher, norfolk terrier -- bladdercancer	 -- bladderUrethra
...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Canine_StudyUBC02-Breed_Diagnosis_PrimDiseaseSite.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/MiniaturePinscher_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/NorfolkTerr_Chkbx'),10)
