...
//UBC02 - airedale, bluetick, norfolk, norwegian, scottish, welsh, wheaten----male, female---- neut yes, no
...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC16_Canine_StudyUBC02-Breed_Sex_NeuteredStatus.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/NavBar/Canine_Cases_Btn')

//WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/FilterByCases_Facet'),10)
//CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FilterByCases_Facet')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Study/Canine_Filter_Study-UBC02_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Study/Canine_Filter_Study-UBC02_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/AiredaleTerrier_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/AiredaleTerrier_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/BluetickHound_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/BluetickHound_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/NorfolkTerr_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/NorfolkTerr_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/NorwegElk_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/NorwegElk_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/ScottTerr_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/ScottTerr_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/WelshSprSpaniel_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/WelshSprSpaniel_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/WheatenTerr_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/WheatenTerr_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Sex/Male_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Sex/Female_Chkbx'),5)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/NeuteredStatus/No_Chkbx'),5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/NeuteredStatus/No_Chkbx')
