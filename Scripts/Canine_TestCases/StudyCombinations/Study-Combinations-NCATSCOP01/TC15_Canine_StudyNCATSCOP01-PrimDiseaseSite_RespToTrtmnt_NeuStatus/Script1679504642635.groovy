...
////StudyNCATSCOP01-PrimDiseaseSite_ResptoTrtmnt_NeuStatus
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_Canine_StudyNCATSCOP01-PrimDiseaseSite_RespToTrtmnt_NeuStatus.xlsx')   //changed for NCATS
...
'Clicks on the Filter \'Primary Disease Site\' from left pane'
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/LymphNode_Chkbx')
...
'Clicks on the Filter \'Neutered Status\' from left pane'
