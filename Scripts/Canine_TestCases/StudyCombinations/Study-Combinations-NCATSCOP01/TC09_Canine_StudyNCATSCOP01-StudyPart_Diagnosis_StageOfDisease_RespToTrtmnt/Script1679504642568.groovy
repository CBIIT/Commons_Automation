...
////Study NCATSCOP01 - StudyPart__Diagnosis_StageOfDisease_RespToTrtmnt
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Canine_StudyNCATSCOP01-StudyPart_Diagnosis_StageOfDisease_RespToTrtmnt.xlsx')   //changed for NCATS
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Study/Canine_Filter_Study-NCATS_Chkbx') //changed for NCATS

'Selects the specific check box from \'StudyParticipation\' filter.'
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/StudyParticipation/SingleStudy_Chkbx')
WebUI.delay(3)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Diagnosis/BCellLymphoma_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Diagnosis/BCellLymphoma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Diagnosis/BCellLymphoma_Chkbx')
...
'Selects the specific check box from \'StageofDisease\' filter.'
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/StageOfDisease/3_Chkbx')

'Clicks on the Filter \'Response to Treatment\' from left pane'
...
'Selects the specific check box from \'Response to Treatment\' filter.'
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/NotDetermined_Chkbx'), 30)
