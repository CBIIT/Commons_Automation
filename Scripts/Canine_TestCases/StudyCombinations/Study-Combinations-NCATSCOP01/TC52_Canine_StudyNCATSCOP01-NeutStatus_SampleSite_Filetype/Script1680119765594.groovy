...
////Study NCATSCOP01 -NeutStatus_SampleSite_Filetype
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC52_Canine_StudyNCATSCOP01-NeutStatus_SampleSite_Filetype.xlsx')   //changed for NCATS
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/LymphNode_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileType/SupplementalDataFile_Chkbx')

//CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileType/IndexFile_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
