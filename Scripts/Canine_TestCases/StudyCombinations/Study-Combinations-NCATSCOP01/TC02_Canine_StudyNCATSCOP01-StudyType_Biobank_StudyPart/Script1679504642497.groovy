...
////Study NCATSCOP01 - StudyType_Biobank_StudyParticipation
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Canine_StudyNCATSCOP01-StudyType_Biobank_StudyPart.xlsx')   //changed for NCATS
