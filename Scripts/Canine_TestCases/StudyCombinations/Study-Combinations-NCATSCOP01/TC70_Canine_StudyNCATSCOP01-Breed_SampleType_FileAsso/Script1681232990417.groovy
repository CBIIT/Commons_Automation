...
////StudyNCATSCOP01-Breed_SampleType_FileAsso
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC70_Canine_StudyNCATSCOP01-Breed_SampleType_FileAsso.xlsx')   //changed for NCATS
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Vizsla_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Vizsla_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/Vizsla_Chkbx')
