...
////Study NCATSCOP01 -Breed_StageOfDisease_SampleSite_FileType
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC64_Canine_StudyNCATSCOP01-Breed_StageOfDisease_SampleSite_FileType.xlsx')   //changed for NCATS
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/BlkTanCoon_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/BlkTanCoon_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/BlkTanCoon_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/StageOfDisease/4_Chkbx')
WebUI.delay(3)
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Blood_Chkbx')
