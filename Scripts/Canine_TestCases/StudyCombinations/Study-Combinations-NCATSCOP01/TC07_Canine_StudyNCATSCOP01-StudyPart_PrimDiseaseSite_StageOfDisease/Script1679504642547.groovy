...
////Study NCATSCOP01 - StudyPart_PrimDiseaseSite_StageOfDisease
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_Canine_StudyNCATSCOP01-StudyPart_PrimDiseaseSite_StageOfDisease.xlsx')   //changed for NCATS
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Bone_Chkbx')
