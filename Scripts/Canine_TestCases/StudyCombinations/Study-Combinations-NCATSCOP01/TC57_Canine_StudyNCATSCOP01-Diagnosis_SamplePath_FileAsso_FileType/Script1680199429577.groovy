...
////Study NCATSCOP01 -Diagnosis_SamplePath_FileAsso_FileType
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC57_Canine_StudyNCATSCOP01-Diagnosis_SamplePath_FileAsso_FileType.xlsx')   //changed for NCATS
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Diagnosis/Melanoma_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Melanoma_Chkbx')
WebUI.delay(3)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SamplePathology/SAMPLEPATHOLOGY_Ddn')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileAssociation/study_Chkbx')
//CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileAssociation/diagnosis_Chkbx')
