...
////Study NCATSCOP01 - StudyPart_SampleSite_FileFormat
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC34_Canine_StudyNCATSCOP01-StudyPart_SampleSite_FileFormat.xlsx')   //changed for NCATS
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/LungCaudalRghtLobe_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SampleSite/SAMPLE_SITE_Ddn')
WebUI.delay(3)
