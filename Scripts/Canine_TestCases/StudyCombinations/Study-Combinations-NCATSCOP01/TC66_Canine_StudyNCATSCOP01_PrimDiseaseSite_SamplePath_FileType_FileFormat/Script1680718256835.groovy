...
////Study NCATSCOP01 -PrimDiseaseSite_SamplePath_FileType_FileFormat
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC66_Canine_StudyNCATSCOP01_PrimDiseaseSite_SamplePath_FileType_FileFormat.xlsx')   //changed for NCATS
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileFormat/xlsx_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileFormat/FILEFORMAT_Ddn')
