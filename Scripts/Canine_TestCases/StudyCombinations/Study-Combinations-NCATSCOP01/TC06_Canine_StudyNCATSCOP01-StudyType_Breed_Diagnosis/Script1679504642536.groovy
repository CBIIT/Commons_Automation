...
////StudyNCATSCOP01-StudyType_Breed_Diagnosis
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_Canine_StudyNCATSCOP01-StudyType_Breed_Diagnosis.xlsx')   //changed for NCATS
...
WebUI.delay(3)
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/AmerStaffd_Chkbx'),30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/AmerStaffd_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/AmerStaffd_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Diagnosis/PulmonaryNeo_Chkbx')
