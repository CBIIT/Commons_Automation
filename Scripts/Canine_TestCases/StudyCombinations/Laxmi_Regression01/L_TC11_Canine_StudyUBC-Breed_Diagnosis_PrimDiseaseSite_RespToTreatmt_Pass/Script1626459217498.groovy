...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Breed/BelgMalin_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Labrador_Chkbx'), 10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Breed/Labrador_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/WestHland_Chkbx'), 10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Breed/WestHland_Chkbx')
...
WebUI.verifyElementVisibleInViewport(findTestObject('Object Repository/Canine/Filter/PrimDiseaseSite/PRIMARYDISEASESITE_Ddn'), 
    10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/PrimDiseaseSite/PRIMARYDISEASESITE_Ddn')

WebUI.verifyElementVisibleInViewport(findTestObject('Object Repository/Canine/Filter/PrimDiseaseSite/BladderProstate_Chkbx'), 
    10)
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/PrimDiseaseSite/BladderUrethraProstate_Chkbx'), 
    10)
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/PrimDiseaseSite/UrethraProstate_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/RESPONSETOTREATMENT_Ddn'), 
    10)
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/ResponseToTreatment/NotDetermined_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/PartialResponse_Chkbx'), 
    10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/ResponseToTreatment/PartialResponse_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx'), 10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/StableDisease_Chkbx'), 10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/ResponseToTreatment/StableDisease_Chkbx')
