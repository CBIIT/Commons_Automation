...
//UBC -- Irish terr,Miniature, Poodle -- bladdercancer	 -- bladderUrethra
...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Canine_StudyUBC-Breed_Diagnosis_PrimDiseaseSite.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/IrishTerr_Chkbx'), 10)

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/IrishTerr_Chkbx'), 10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Breed/IrishTerr_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/MiniaturePinscher_Chkbx'), 10)

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/MiniaturePinscher_Chkbx'), 10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Breed/MiniaturePinscher_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Poodle_Chkbx'), 10)

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Poodle_Chkbx'), 10)

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Breed/Poodle_Chkbx')
