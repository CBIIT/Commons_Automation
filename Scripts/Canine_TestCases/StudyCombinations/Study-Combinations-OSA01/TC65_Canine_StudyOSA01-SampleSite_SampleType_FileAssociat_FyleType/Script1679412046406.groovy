 ...
 */
WebUI.closeBrowser()
//Study OSA01,Sample Site in (Musclee) and Sample Type in (Normal Tissue) and File Association (sample) and File Typet in (Whole Genome Sequence File) 

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC65_Canine_StudyOSA01-SampleSite_SampleType_FileAssociat_FyleType.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Muscle_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileType/WholeGenSeqFile_Chkbx')
