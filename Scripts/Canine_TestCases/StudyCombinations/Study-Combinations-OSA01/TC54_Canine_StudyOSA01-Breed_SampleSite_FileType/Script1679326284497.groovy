 ...
 */
WebUI.closeBrowser()
//Study OSA01, Breed in (Old English Sheepdog) and Sample Site (Muscle) and File Type in (bai)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC54_Canine_StudyOSA01-Breed_SampleSite_FileType.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/OldEnglishSheepdog_Chkbx')
