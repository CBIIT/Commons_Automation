 ...
 */
WebUI.closeBrowser()
//Study OSA01, Breed in (Golden Retriever) and Sample Pathology (Osteosarcoma; Combined Type) and File Format in (bai)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC53_Canine_StudyOSA01-Breed_SamplePathology_FileFormat.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/OsteosarcomaCombinedType_Chkbx')
