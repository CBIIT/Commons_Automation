 ...
 */
WebUI.closeBrowser()
//Study OSA01, Diagnosis in (Osteosarcoma) AND Breed in (Greyhound, Saint Bernard) and Stage of Disease (Unknown)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC44_Canine_StudyOSA01-Diagnosis_Breed_StageOfDisease.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/SaintBnd_Chkbx')
