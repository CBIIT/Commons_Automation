 ...
 */
WebUI.closeBrowser()
//Study OSA01, Study Type in (Genomics) AND Breed in (Mixed Breed) and Diagnosis in (Osteosarcoma) and Sex in (Female)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC41_Canine_StudyOSA01-StudyType_Breed_Diagnosis_Sex.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Mixed_Chkbx')
