 ...
 */
WebUI.closeBrowser()
//Study OSA01, Sex in (Female) and Sample Type in (Normal Tissue) and File Type (Index File) and File Format in (bai) 

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC62_Canine_StudyOSA01-Sex_SampleType_FileType_FileFormat.xlsx')
