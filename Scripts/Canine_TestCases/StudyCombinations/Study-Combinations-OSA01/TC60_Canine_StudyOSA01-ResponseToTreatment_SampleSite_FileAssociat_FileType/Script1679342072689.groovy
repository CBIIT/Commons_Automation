 ...
 */
WebUI.closeBrowser()
//Study OSA01, Response to Treatment in (Not Determined) and Sample Site in (Lung) and File Association (sample) and File Type in (Index File) 

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC60_Canine_StudyOSA01-ResponseToTreatment_SampleSite_FileAssociat_FileType.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Study/Canine_Filter_Study-OSA01_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/ResponseToTreatment/NotDetermined_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Lung_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileAssociation/sample_Chkbx')
