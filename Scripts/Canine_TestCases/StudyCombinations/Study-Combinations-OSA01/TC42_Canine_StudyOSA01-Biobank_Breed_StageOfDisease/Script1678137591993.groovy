 ...
 */
WebUI.closeBrowser()
//Study OSA01, Biobank in (CCOGC) AND Breed in (Great Dane, Rottweiler ) and Stage of Disease (II)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC42_Canine_StudyOSA01-Biobank_Breed_StageOfDisease.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Biobank/CCOGC_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/GreatDane_Chkbx')
