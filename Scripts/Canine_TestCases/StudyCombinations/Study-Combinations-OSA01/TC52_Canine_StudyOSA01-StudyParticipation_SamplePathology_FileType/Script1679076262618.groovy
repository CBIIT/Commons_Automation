 ...
 */
WebUI.closeBrowser()
//Study OSA01, StudyParticipation in (Single Study) and Sample Pathology (Osteoblastic and Chrondroblastic Osteosarcoma) and File Type in (Index File)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC52_Canine_StudyOSA01-StudyParticipation_SamplePathology_FileType.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Osteoblasticandchrondroblastic_Osteosarcoma_Chkbx')
