...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC03_Canine_StudyOSA01-Breed_Sex_Male.xlsx')   //changed for OSA
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/Greyhnd_Chkbx')


//CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTab'('Canine/Filter/Breed/BREED_Ddn')
Thread.sleep(2000);
