...
//Study OSA01, Diagnosis in (Unknown ,Response to treatment in ('Not determined') File Type in (RNA Sequence File)
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC23_Canine_StudyOSA01-Diagnosis-Resptotreatment-FileType.xlsx')   //changed for OSA
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/FileType/RNASeqFile_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/FileType/RNASeqFile_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/FileType/RNASeqFile_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Diagnosis/Unknown_Chkbx')
