 ...
 */
WebUI.closeBrowser()
//Study OSA01, Diagnosis in (Osteosarcoma) and Sample Type (Metastatic Tumor Tissue) and File Type in (Whole Exome Sequence File)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC55_Canine_StudyOSA01-Diagnosis_SampleType_FileType.xlsx')
