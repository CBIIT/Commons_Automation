 ...
 */
WebUI.closeBrowser()
//Study OSA01, Biobank in (Not Applicable) AND Breed in (Bullmastiff, Golden Retriever) and Neutered Status (Yes)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC43_Canine_StudyOSA01-Biobank_Breed_NeuteredStatus.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Bullmastif_Chkbx')
