...
//Study OSA01, Brred in (Rottweiler) and Sample Pathology in (Chondroblastic osteosarcoma) and File Format in (bam)
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC22_Canine_StudyOSA01-Breed-SamPath-FileFormat.xlsx')   //changed for OSA
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Rottweiler_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Rottweiler_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/Rottweiler_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SamplePathology/Chondroblastic Osteosarcoma_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SamplePathology/Chondroblastic Osteosarcoma_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/SamplePathology/Chondroblastic Osteosarcoma_Chkbx'), 30)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SamplePathology/Chondroblastic Osteosarcoma_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileFormat/FILEFORMAT_Ddn')

'Selects the specific check box from \'File Format\' filter.'
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/FileFormat/bam_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/FileFormat/bam_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/FileFormat/bam_Chkbx'), 30)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileFormat/bam_Chkbx')

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/FileFormat/FILEFORMAT_Ddn')
