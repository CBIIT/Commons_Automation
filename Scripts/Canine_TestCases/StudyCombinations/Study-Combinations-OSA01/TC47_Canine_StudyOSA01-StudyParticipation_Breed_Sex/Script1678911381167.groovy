 ...
 */
WebUI.closeBrowser()
//Study OSA01, Study Participation in (Single Study) AND Breed in (German Shepherd Dog) and Sex (Female)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC47_Canine_StudyOSA01-StudyParticipation_Breed_Sex.xlsx')
