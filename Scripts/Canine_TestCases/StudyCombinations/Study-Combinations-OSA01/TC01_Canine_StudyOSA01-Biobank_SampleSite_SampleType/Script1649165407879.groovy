...
//Study OSA01, Biobank in (CCOGC),SampleSite in (Blood) and Sample Type in (Whole Blood)
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_StudyOSA01-Biobank_SampleSite_SampleType.xlsx')   //changed for OSA
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Biobank//CCOGC_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleSite/Blood_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleSite/Blood_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/SampleSite/Blood_Chkbx'), 30)

CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SampleSite/Blood_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/WholeBlood_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/WholeBlood_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/SampleType/WholeBlood_Chkbx'), 30)

CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SampleType/WholeBlood_Chkbx')
...
CustomKeywords.'utilities.TestRunner.multiFunction'('ICDC', GlobalVariable.G_StatBar_Projects, 'Object Repository/Canine/Canine_CasesTable',
