...
//Study - OSA01/ Breed - Golden Retriever, Labrador Retriever/ Sex - Male/ File Type - Index File, Whole Genome Sequence File
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC14_Canine_StudyOSA01-Breed-Sex-FileType.xlsx') //changed
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Study/Canine_Filter_Study-OSA01_Chkbx')//changed
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/GoldenRetr_Chkbx')
