 ...
 */
WebUI.closeBrowser()
//Study OSA01, Sex in (Male) and Sample Type in (Metastatic Tumor Tissue) and File Association (sample) and File Format in (bam) 

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC61_Canine_StudyOSA01-Sex_SampleType_FileAssociat_FileFormat.xlsx')
