...
//Study OSA01, Biobank in (CCOGC) AND Stage of Disease in (Unknown) and Sample Pathology in (Osteosarcoma)
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC25_Canine_StudyOSA01-Biobank-StageofDisease-SamplePathology.xlsx')   //changed for OSA
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Biobank/Biobank_Ddn')
...
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/StageOfDisease/Unknown_Chkbx'), 30)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/StageOfDisease/Unknown_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SamplePathology/Osteosarcoma_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SamplePathology/Osteosarcoma_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/SamplePathology/Osteosarcoma_Chkbx'), 30)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SamplePathology/Osteosarcoma_Chkbx')
