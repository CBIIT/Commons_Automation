...
//Study OSA01, Breed in (Old English Sheepdog) and Sample type in (Primary MALIGNANT Tumor Tissue)
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_Canine_StudyOSA01-Breed_SampType_PrimMaligTumor.xlsx')   //changed for OSA
