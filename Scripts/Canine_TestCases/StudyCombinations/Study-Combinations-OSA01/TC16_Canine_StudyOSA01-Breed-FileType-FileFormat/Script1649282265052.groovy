...
//Study - OSA01/ Biobank - CCOGC /Breed - GreatPyrenees/File Type - RNA Sequence File/ File format - bam
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC16_Canine_StudyOSA01-Breed-FileType-FileFormat.xlsx') //changed
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/RNASeqFile_Chkbx')
