 ...
 */
WebUI.closeBrowser()
//Study OSA01, Primary Disease Site in (Bone (Appendicular)) and Sample Type (Normal Tissue) and Sample Site in (Muscle) and File Type in (Whole Exome Sequence File)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC56_Canine_StudyOSA01-PrimaryDiseaseSite_SampleType_SampleSite_FileType.xlsx')
