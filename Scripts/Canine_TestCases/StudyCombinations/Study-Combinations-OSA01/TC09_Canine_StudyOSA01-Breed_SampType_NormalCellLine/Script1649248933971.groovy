...
//Study OSA01, Breed in (Unknown) and Sample type in (Normal Cell Line)
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Canine_StudyOSA01-Breed_SampType_NormalCellLine.xlsx')   //changed for OSA
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/NormalCellLine_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/NormalCellLine_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/SampleType/NormalCellLine_Chkbx'), 30)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SampleType/NormalCellLine_Chkbx')
