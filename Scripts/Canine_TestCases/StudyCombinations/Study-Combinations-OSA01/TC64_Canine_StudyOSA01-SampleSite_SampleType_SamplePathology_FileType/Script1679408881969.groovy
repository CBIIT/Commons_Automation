 ...
 */
WebUI.closeBrowser()
//Study OSA01, Sample Site in (Subcutaneous Tissue) Sample Type in (Metastatic Tumor Tissue) and Sample Pathology (Osteosarcoma) and File Type in (Whole Exome Sequence File)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC64_Canine_StudyOSA01-SampleSite_SampleType_SamplePathology_FileType.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleType/MetastaticTumorTissue_Chbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Subcutaneous_Tissue_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Osteosarcoma_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileType/WholeExoSeqFile_Chkbx')
