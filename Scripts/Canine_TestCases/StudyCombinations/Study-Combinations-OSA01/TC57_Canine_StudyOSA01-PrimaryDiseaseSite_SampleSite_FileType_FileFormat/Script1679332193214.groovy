 ...
 */
WebUI.closeBrowser()
//Study OSA01, Primary Disease Site in (Unknown) and Sample Type (Normal Cell Line) and File Type in (RNA Sequence File) and File Format in (bam)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC57_Canine_StudyOSA01-PrimaryDiseaseSite_SampleSite_FileType_FileFormat.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Unknown_Ckhbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleType/NormalCellLine_Chkbx')
