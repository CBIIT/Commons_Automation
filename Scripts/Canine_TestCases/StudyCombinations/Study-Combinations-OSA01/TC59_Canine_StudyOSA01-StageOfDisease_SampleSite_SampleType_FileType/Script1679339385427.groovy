 ...
 */
WebUI.closeBrowser()
//Study OSA01, Stage of Disease in (III) and Sample Site in (Blood) Sample Type (Whole Blood) and File Type in (Index File) 

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC59_Canine_StudyOSA01-StageOfDisease_SampleSite_SampleType_FileType.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleType/WholeBlood_Chkbx')
