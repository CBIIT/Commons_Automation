 ...
 */
WebUI.closeBrowser()
//Study OSA01, ResponseToTreatment in (Not Determined) and Sex (Male) and Neutered Status (Yes)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC46_Canine_StudyOSA01-ResponseToTreatment_Sex_NeuteredStatus.xlsx')
...
//CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Doberman_Chkbx')
