...
//Study - OSA01/ Response To Treatment - Not Determined/ Neutered Status - No
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC35_Canine_StudyOSA01-ResponseToTreatment-NeutStatus.xlsx') //changed
