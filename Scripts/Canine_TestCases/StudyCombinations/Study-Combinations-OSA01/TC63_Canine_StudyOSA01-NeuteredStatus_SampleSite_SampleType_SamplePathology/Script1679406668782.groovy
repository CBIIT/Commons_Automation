 ...
 */
WebUI.closeBrowser()
//Study OSA01, Neutered Status in (Yes) and Sample Type in (Primary Malignant Tumor Tissue) and Sample Site (Bone) and Sample Pathology in (Giant Cell Osteosarcoma) 

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC63_Canine_StudyOSA01-NeuteredStatus_SampleSite_SampleType_SamplePathology.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Bone_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/GiantCell_Osteosarcoma_Chkbx')
