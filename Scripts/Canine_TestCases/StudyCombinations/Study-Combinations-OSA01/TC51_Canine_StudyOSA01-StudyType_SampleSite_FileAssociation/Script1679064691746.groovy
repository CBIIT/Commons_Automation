 ...
 */
WebUI.closeBrowser()
//Study OSA01, Study Type in (Genomics) and Sample Site (Subcutaneous Tissue) and File Association in (sample)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC51_Canine_StudyOSA01-StudyType_SampleSite_FileAssociation.xlsx')
