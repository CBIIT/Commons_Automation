 ...
 */
WebUI.closeBrowser()
//Study OSA01, Primary Disease Site in (Bone (Appendicular)) AND Breed in (Rottweiler ) and Stage of Disease (III)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC45_Canine_StudyOSA01-PrimaryDiseaseSite_Breed_StageOfDisease.xlsx')
