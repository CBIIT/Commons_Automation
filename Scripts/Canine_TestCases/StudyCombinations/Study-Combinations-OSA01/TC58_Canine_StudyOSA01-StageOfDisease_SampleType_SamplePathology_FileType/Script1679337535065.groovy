 ...
 */
WebUI.closeBrowser()
//Study OSA01, Stage of Disease in (II) and Sample Type (Primary Malignant Tumor Tissue) and Sample Pathology in (Fibroblastic Osteosarcoma) and File Type in (RNA Sequence File) 

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC58_Canine_StudyOSA01-StageOfDisease_SampleType_SamplePathology_FileType.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Fibroblastic_Osteosarcoma_Chkbx')
