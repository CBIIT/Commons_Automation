 ...
 */
WebUI.closeBrowser()
//Study OSA01, Study Participation in (Multiple Study) AND ResponseToTreatment in (Not Determined) and Sex (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC48_Canine_StudyOSA01-StudyParticipation_ResponseToTreatment_Sex.xlsx')
