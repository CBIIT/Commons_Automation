 ...
 */
WebUI.closeBrowser()
//Study Glioma, File Association in (case) and File Type in (Variant Call File) and File Format in (gz)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC16_Canine_StudyGlioma-FileAssoc_FileType_FileFormat.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileAssociation/case_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileType/VariantCallFile_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileFormat/gz_Chkbx')
