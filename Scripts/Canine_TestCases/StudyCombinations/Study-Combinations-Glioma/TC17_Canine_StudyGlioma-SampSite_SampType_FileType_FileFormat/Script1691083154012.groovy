 ...
 */
WebUI.closeBrowser()
//Study Glioma, Sample Site in (Cerebellar) and Sample Type in (Primary Malignant Tumor Tissue) and File Type in (RNA Sequence File) and File Format in (bam)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC17_Canine_StudyGlioma-SampSite_SampType_FileType_FileFormat.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Cerebellar_Chkbx')
