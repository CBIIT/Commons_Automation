 ...
 */
WebUI.closeBrowser()
//Study Glioma, Responce To Treatment in (Not Determined) and Sample Site in (Kidney) and File Associetion in (sample)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC13_Canine_StudyGlioma-RespToTret_SamplSite_FileAssoc.xlsx')
