 ...
 */
WebUI.closeBrowser()
//Study COTC022, Breed in (Boxer) and Stage of Disease in (Unknown) and Sample Site in (Midline)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_Canine_StudyGlioma-Breed_StageOfDisease_SampleSite.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Midline_Chkbx')
