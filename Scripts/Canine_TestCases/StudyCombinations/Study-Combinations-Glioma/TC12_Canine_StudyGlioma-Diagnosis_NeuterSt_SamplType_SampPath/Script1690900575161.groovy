 ...
 */
WebUI.closeBrowser()
//Study Glioma, Diagnosis in (Glioma) and Neutered Status in (Yes) and Sample Type in (Primary Malignant Tumor Tissue) and Sample Pathology in (Astrocytoma)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC12_Canine_StudyGlioma-Diagnosis_NeuterSt_SamplType_SampPath.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Astrocytoma_Chkbx')
