 ...
 */
WebUI.closeBrowser()
//Study Glioma, Neutered Status in (No) and Sample Type in (Normal Tissue) and File Type in (Index File)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC14_Canine_StudyGlioma-NeuterStatus_SamplType_FileType.xlsx')
