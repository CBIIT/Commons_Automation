 ...
 */
WebUI.closeBrowser()
//Study Glioma, Bioblank in (Not Applicable) and Diagnosis in (Glioma) and Primary Disease Site in (Brain) and Sex in (Unknown)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Canine_StudyGlioma-Bioblank_Diagnosis_PrimDiseaseSite_Sex.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Diagnosis/Glioma_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Sex/Unknown_Chkbx')
