 ...
 */
WebUI.closeBrowser()
//Study Glioma, Study Type in (Genomics) and Breed in (Boston Terrier) and Sex in (Female)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_StudyGlioma-StudyType_Breed_Sex.xlsx')
