 ...
 */
WebUI.closeBrowser()
//Study Glioma, Study Participation in (Single Study) and Diagnosis in (Glioma) and Primary Disease Site in (Brain)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_Canine_StudyGlioma-StudyParticip_Diagnosis_PrimDiseaseSite.xlsx')
