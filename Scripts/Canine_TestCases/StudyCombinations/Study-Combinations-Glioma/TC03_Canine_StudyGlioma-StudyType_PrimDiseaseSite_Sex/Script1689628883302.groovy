 ...
 */
WebUI.closeBrowser()
//Study Glioma, Study Type in (Genomics) and PrimaryDiseaseSite in (Brain)  and Sex in (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Canine_StudyGlioma-StudyType_PrimDiseaseSite_Sex.xlsx')
