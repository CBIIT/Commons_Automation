 ...
 */
WebUI.closeBrowser()
//Study Glioma, Study Participation in (Single Study) and Breed in (Labrador Retriever)) and Response to Treatment (Not Determined)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_Canine_StudyGlioma-StudyParticipation_Breed_ResponToTreatm.xlsx')
