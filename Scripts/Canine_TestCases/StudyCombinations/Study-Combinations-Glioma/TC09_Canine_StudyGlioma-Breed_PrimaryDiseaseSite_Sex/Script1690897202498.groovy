 ...
 */
WebUI.closeBrowser()
//Study COTC022, Breed in (Mixed Breed,Cocker Spaniel ) and Primary Disease Site in (Brain) and Sex in (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Canine_Glioma-Breed_PrimaryDiseaseSite_Sex.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/CockerSpan_Chkbx')
