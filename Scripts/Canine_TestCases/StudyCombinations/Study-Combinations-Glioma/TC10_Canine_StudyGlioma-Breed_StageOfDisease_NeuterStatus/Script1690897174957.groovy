 ...
 */
WebUI.closeBrowser()
//Study COTC022, Breed in (Boston Terrier, French Bulldog) and Stage of Disease in (Unknown) and Neutered status in (Yes)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_Canine_StudyGlioma-Breed_StageOfDisease_NeuterStatus.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Boston_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/FrenchBulldog_Chkbx')
