 ...
 */
WebUI.closeBrowser()
//Study Glioma, Sample Site in (Hemispheric) Sample Type in (Primary Malignant Tumor Tissue) and Sample Pathology in (Oligodendroglioma)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC15_Canine_StudyGlioma-SampSite_SampType_SampPathology.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/Hemispheric_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Oligodendro_Chkbx')
