 ...
 */
WebUI.closeBrowser()
//Study Glioma, Biobank in (Not Applicable) and Breed in (French Bulldog) and Neutered Status in (Yes)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_Canine_StudyGlioma-Biobank_Breed_NeuteredStatus.xlsx')
