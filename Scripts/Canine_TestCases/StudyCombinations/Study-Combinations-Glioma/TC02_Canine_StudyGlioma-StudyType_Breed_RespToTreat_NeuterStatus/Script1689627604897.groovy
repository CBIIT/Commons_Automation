 ...
 */
WebUI.closeBrowser()
//Study Glioma, Study Type in (Genomics) and Breed in (Boxer) and Response to Treatment in (Not Determined) and Neutered Status in (No)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Canine_StudyGlioma-StudyType_Breed_RespToTreat_NeuterStatus.xlsx')
