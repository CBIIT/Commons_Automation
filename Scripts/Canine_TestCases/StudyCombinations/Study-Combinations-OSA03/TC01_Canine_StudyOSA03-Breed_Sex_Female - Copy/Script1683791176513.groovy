...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_StudyOSA03-Breed_Sex_Female.xlsx')   //changed for OSA
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Study/Canine_Filter_Study-OSA03_Chkbx'), 30)  //changed for OSA01
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Study/Canine_Filter_Study-OSA03_Chkbx'), 5)  //changed for OSA01
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Study/Canine_Filter_Study-OSA03_Chkbx') //changed for OSA
