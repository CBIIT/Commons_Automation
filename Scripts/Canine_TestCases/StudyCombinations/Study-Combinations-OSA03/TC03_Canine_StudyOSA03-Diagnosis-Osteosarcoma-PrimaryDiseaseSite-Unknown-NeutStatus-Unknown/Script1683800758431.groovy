...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Canine_StudyOSA03-Diagnosis-Osteosarcoma-PrimaryDiseaseSite-Unknown-NeutStatus-Unknown.xlsx')
...
//Diagnosis - Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Diagnosis/OsteoSarcoma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Diagnosis/OsteoSarcoma_Chkbx')

// Primary Disease Site- Dropdwn
...
// Primary Disease Site- Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/PrimDiseaseSite/Unknown_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/PrimDiseaseSite/Unknown_Chkbx')

//Neutered Status - Dropdwn
...
//Neutered Status - Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/NeuteredStatus/Unknown_Chkbx'), 5)
