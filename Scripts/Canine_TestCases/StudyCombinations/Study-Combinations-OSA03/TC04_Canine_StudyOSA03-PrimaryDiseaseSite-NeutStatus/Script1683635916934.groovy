...
//Study - OSA01/ Primary Disease Site - Bone (Appendicular)/ Neutered Status - No
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_Canine_StudyOSA03-PrimaryDiseaseSite-NeutStatus.xlsx') //changed
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Study/Canine_Filter_Study-OSA03_Chkbx'), 5)  //changed
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Study/Canine_Filter_Study-OSA03_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/PrimDiseaseSite/BoneApendicular_Chkbx'), 5)
