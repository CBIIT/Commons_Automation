...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC10_Canine_StudyOSA03-NeuterStatus-FileType-FileFormat.xlsx')
//Study OSA03, Neutered Status (Yes) and File Type in (Index File) and File Format in (bai)
