...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC07_Canine_StudyOSA03-StageOfDisease-SampleSite-FileFormat.xlsx')
//Study OSA03, Stage Of Disease in (IIb) and Sample Site in (Bone) and File Format in (bai)
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/StageOfDisease/2b_Chkbx')
