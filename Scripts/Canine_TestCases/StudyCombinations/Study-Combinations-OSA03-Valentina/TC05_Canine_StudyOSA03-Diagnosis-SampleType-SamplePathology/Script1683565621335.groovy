...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Canine_StudyOSA03-Diagnosis-SampleType-SamplePathology.xlsx')
//Study OSA03, Diagnosis in (Osteosarcoma) and Sample Type in (Primary Malignant Tumor Tissue) and Sample Pathology in (Chondroblastic Osteosarcoma)
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SamplePathology/ChondroblasticOsteosarcoma_Chkbx')
