...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_Canine_StudyOSA03-PrimDiseaseSite-SamplePathology-FileType.xlsx')
//Study OSA03, Primary Disease Site in (Bone (Appendicular) and Sample Pathology in (Fibroblastic Osteosarcoma) and File Type in (DNA Methylation Analysis File)
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/DNAMethylAnalFile_Chkbx')
