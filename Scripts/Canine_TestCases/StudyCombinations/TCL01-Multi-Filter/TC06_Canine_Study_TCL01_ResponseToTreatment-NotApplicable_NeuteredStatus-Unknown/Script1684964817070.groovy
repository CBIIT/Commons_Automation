...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC06_Canine_Study_TCL01_ResponseToTreatment-NotApplicable_NeuteredStatus-Unknown.xlsx')
...
'Selects the specific check box from \'NeuteredStatus\' filter.'
