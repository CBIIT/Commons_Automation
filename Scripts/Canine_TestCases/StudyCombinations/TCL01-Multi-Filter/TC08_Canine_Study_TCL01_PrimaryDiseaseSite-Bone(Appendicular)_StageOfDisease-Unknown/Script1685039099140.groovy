...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC08_Canine_Study_TCL01_PrimaryDiseaseSite-Bone(Appendicular)_StageOfDisease-Unknown.xlsx')
...
'Selects the specific check box from \'PrimaryDiseaseSite\' filter.'
