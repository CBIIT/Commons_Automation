...
//UBC-- bassethound, Belgian,Labrador,WestHIghland  -- bladderCanc--  bladderprostate/bladderUrethra/bladderUrethraProstate/urethraProstate--notdeter/partialResponse/progressiveDisease/stableDisease
...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC20_Canine_StudyUBC-Breed_Diagnosis_PrimDiseaseSite_RespToTreatmt.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/BassHnd_Chkbx'),10)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/BassHnd_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/BelgMalin_Chkbx'),10)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/BelgMalin_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Labrador_Chkbx'),10)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/Labrador_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/WestHland_Chkbx'),10)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/WestHland_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/PrimDiseaseSite/BladderProstate_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/PrimDiseaseSite/UrethraProstate_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/ResponseToTreatment/PartialResponse_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx'),10)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx')
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/StableDisease_Chkbx'),10)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/ResponseToTreatment/StableDisease_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/ResponseToTreatment/RESPONSETOTREATMENT_Ddn')
