...
//Study - UBC01/ Biobank-Not Appl / Sample type- primary malignant tumor tissue / File type - index file
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC36_Canine_StudyUBC-Biobank-SampleType_FileType.xlsx')   //changed for MGT
...
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Biobank/Purdue_Chkbx') //changed for MGT
