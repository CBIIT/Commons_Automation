 ...
 */
WebUI.closeBrowser()
//Study PRECINCT01, Study Type in (Clinical Trial) and Breed in (Golden Retriever, Doberman) and Sex in (Male)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_Study-PRECINCT01-StudyType_Breed_Sex.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/GoldenRetr_Chkbx')
