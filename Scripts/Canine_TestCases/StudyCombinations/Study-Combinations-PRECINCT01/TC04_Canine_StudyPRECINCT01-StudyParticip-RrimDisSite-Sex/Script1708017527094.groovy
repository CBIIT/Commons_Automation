 ...
 */
WebUI.closeBrowser()
//Study PRECINCT01, Study Type in (Clinical Trial) and 

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_Canine_StudyPRECINCT01-StudyParticip-RrimDisSite-Sex.xlsx')
