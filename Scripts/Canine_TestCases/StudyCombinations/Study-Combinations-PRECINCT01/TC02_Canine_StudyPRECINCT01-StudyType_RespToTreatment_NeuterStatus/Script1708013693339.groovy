 ...
 */
WebUI.closeBrowser()
//Study PRECINCT01, Study Type in (Clinical Trial) and Response to Treatment in (Progressive Disease) and Neutered Status in (No)

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Canine_StudyPRECINCT01-StudyType_RespToTreatment_NeuterStatus.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Study/Canine_Filter_Study-PRECINCT01_Chkbx')
