 ...
 */
WebUI.closeBrowser()
//Study GLIOMA01, Study Participation in (Single Study) and Diagnosis in (Glioma) and Sex in (Female)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC03_Canine_StudyGLIOMA01-StudyParticipat_Diagnosis_Sex.xlsx')
