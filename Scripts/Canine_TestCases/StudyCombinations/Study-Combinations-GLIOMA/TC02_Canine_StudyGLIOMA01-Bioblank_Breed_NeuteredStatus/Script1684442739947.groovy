 ...
 */
WebUI.closeBrowser()
//Study GLIOMA01, Bioblank in (Not Applicable) and Breed in (Boxer) and Neutered Status in (Yes)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC02_Canine_StudyGLIOMA01-Bioblank_Breed_NeuteredStatus.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/Boxer_Chkbx')
