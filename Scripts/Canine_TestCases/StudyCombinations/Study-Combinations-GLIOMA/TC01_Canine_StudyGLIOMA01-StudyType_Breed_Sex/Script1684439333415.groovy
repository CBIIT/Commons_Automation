 ...
 */
WebUI.closeBrowser()
//Study GLIOMA01, Study Type in (Genomics) and Breed in (Boston Terrier) and Sex in (Male)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC01_Canine_StudyGLIOMA01-StudyType_Breed_Sex.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/Boston_Chkbx')
