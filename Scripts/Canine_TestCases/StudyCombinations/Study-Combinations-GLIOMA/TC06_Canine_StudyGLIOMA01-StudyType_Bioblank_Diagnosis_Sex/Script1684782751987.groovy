 ...
 */
WebUI.closeBrowser()
//Study GLIOMA01,Study Type in (Genomics) and Bioblank in (Not Applicable) and Diagnosis in (Glioma) and Sex in (Unknown)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC06_Canine_StudyGLIOMA01-StudyType_Bioblank_Diagnosis_Sex.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/StudyType/Canine_Filter_StudyType-Genomics_Chkbx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Diagnosis/Glioma_Chkbx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Sex/Unknown_Chkbx')
