 ...
 */
WebUI.closeBrowser()
//Study GLIOMA01,Study Participation in (Single Study) and Primary Disease Site in (Brain) and Stage of Disease in (Unknown) and Response to Treatment in (Not Determined)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC07_Canine_StudyGLIOMA01-StudyPartic_PrDisSite_StageOfDis_RespToTreat.xlsx')
