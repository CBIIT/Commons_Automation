 ...
 */
WebUI.closeBrowser()
//Study GLIOMA01, Breed in (Mixed Breed, Shih Tzu) and Primary Disease Site in (Brain) and Neutered Status in (Unknown)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC04_Canine_StudyGLIOMA01-Breed_PrimDiseaseSite_NeutStatus.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/Mixed_Chkbx')

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/ShihTzu_Chkbx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/Brain_Chkbx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/NeuteredStatus/Unknown_Chkbx')
