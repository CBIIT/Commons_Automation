 ...
 */
WebUI.closeBrowser()
//Study GLIOMA01, Breed in (French Bulldog, Poodle) and Stage of Disease in (Unknown) and Response to Treatment in (Not Determined)

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.RunKatalon'('TC05_Canine_StudyGLIOMA01-Breed_StagOfDiseas_RespToTreatm.xlsx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Study/Canine_Filter_Study-GLIOMA_Chkbx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/FrenchBulldog_Chkbx')

CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/Breed/Poodle_Chkbx')
...
CustomKeywords.'ctdc.utilities.runtestcaseforKatalon.clickTabCanineStat'('Canine/Filter/StageOfDisease/Unknown_Chkbx')
