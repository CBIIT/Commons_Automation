...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC34_Canine_StudyMGT-SampleSite_SamplePath_Filetype.xlsx')   //changed for MGT
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/Carcinoma With Simple And Complex Components_Chkbx')
