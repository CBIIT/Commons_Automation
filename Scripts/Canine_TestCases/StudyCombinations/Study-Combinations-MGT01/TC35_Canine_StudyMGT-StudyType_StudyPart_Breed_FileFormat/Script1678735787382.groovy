...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC35_Canine_StudyMGT-StudyType_StudyPart_Breed_FileFormat.xlsx')   //changed for MGT
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/Other_Chkbx')
