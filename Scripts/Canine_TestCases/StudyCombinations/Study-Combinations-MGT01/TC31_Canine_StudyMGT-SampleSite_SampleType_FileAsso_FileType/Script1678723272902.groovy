...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC31_Canine_StudyMGT-SampleSite_SampleType_FileAsso_FileType.xlsx')   //changed for MGT
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleSite/MammaryGland_Chkbx')
WebUI.delay(3)
