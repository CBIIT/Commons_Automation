...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC18_Canine_StudyMGT-Diagnosis_SampType__FileAsso_FileType.xlsx')   //changed for MGT
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Diagnosis/MammaryCancer_Chkbx')
