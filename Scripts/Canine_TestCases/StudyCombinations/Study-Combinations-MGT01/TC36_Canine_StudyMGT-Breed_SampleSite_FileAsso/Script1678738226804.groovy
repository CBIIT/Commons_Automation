...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC36_Canine_StudyMGT-Breed_SampleSite_FileAsso.xlsx')   //changed for MGT
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/Breed/CokrSpnilChkbx')
WebUI.delay(3)
