...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC14_Canine_StudyMGT-Studytype_PrimDiseaseSite_StageOfDisease.xlsx')   //changed for MGT
...
'Selects the specific check box from \'StudyType\' filter.'
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/StudyType/Canine_Filter_StudyType-Genomics_Chkbx')
