...
//Study - MGT01/ Biobank-UCD SVM / Sample pathology - complex carcinoma / File format - bam
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC13_Canine_StudyMGT-Biobank-SampPatho-FileFormat.xlsx')   //changed for MGT
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SamplePathology/SimpleCarcinoma_Chkbx')
