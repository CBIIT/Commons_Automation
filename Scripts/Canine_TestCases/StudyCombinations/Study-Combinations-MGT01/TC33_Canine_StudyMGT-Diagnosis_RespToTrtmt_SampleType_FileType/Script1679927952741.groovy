...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC33_Canine_StudyMGT-Diagnosis_RespToTrtmt_SampleType_FileType.xlsx')   //changed for MGT
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/RESPONSETOTREATMENT_Ddn'), 5)
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/ResponseToTreatment/NotApplicable_Chkbx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/FileType/RNASeqFile_Chkbx')
