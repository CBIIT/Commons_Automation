...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC39_Canine_StudyMGT-SampleSite_SamplePath_FileAsso.xlsx')   //changed for MGT
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SamplePathology/SimpleCarcinoma_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SamplePathology/SimpleCarcinoma_Chkbx')
