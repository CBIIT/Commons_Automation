...
'Driver opened by Katalon is used in Selenium from this step.'
 ...
 //StudyMGT-PrimDiseaseSite_SamType_FileType

'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC24_Canine_StudyMGT-PrimDiseaseSite_SamType_FileType.xlsx')   //changed for MGT
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/PrimDiseaseSite/MammaryGland_Chkbx')
