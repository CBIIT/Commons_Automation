...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_Canine_StudyUBC01-ResponseToTreatment-NeutStatus.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/ResponseToTreatment/NotDetermined_Chkbx'), 5)
