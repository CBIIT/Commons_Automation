...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Canine_StudyORGANOIDS01_Diagnosis_StageOfDisease_NeuteredStatus_Breed.xlsx')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Study/Canine_Filter_Study-ORGANOIDS01_Chkbx')

//Stage of disease Drop down-Checkbox
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/StageOfDisease/NotApplicable_Chkbx'), 5)
...
//Diagnosis - Checkbox
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Diagnosis/HealthyControl_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Diagnosis/HealthyControl_Chkbx')

//NeuteredStatus - DropDwn - Checkbox
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/NeuteredStatus/No_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/NeuteredStatus/No_Chkbx')

//Breed - Dropdown - Checkbox
