...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC05_ICDC_COTC022_PrimDisSite-BoneAxial.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/PrimDiseaseSite/BoneAxial_Chkbx'), 5)
