...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_ICDC_TCL01_SampleType-TumoreCellLine.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleType/TumorCellLine_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTab'('Canine/Filter/SampleType/TumorCellLine_Chkbx')
