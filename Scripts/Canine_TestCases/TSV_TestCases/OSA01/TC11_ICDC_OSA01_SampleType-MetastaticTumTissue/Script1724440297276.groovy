...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC11_ICDC_OSA01_SampleType-MetastaticTumTissue.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleType/SAMPLETYPE_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/SampleType/SAMPLETYPE_Ddn')

WebUI.waitForElementPresent(findTestObject('Canine/Filter/SampleType/MetastaticTumorTissue_Chbx'), 5)
