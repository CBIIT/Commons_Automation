...
//Study IN (COTC022), Breed IN (Brozoi, GreatPyrenees), Diagnosis IN (OsteoSarcoma), Primary Disease Site IN (Bone (Appendicular))
WebUI.closeBrowser()

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC04_Canine_StudyCOTC022-Breed_Diagnosis_PrimDiseaseSite.xlsx')
