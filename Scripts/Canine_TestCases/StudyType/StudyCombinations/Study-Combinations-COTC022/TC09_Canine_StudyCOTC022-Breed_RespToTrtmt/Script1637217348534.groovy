...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC09_Canine_StudyCOTC022-Breed_RespToTrtmt.xlsx')

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Canine_PopUp_Continue_Btn')
System.out.println ("Closed the popup window");
//s.clinical_study_designation IN ['COTC022'] and  demo.breed in ['Chow Chow','Doberman Pinscher'] and
//  diag.best_response in ['Progressive Disease'] 
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Study/Canine_Filter_Study-COTC022_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/Study/Canine_Filter_Study')
...
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/ChowChow_Chkbx')
WebUI.delay(3);
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Doberman_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Doberman_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/Doberman_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/BREED_Ddn')
...
WebUI.waitForElementPresent(findTestObject('Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/ResponseToTreatment/ProgrDisease_Chkbx')
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Canine/Filter/ResponseToTreatment/RESPONSETOTREATMENT_Ddn')
