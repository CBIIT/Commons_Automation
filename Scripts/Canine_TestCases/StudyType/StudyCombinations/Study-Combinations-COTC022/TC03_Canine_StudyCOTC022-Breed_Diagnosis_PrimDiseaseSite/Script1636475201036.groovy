...
//Study IN (COTC022), Breed IN (AustralianShepherd, Newfoundland), DIAGNOSIS IN (Osteosarcoma), Primary Disease Site IN (Bone (Appendicular))
WebUI.closeBrowser()

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Canine_StudyCOTC022-Breed_Diagnosis_PrimDiseaseSite.xlsx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/AusShephd_Chkbx'), 30)

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/AusShephd_Chkbx'), 5)

CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/AusShephd_Chkbx')

WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Newfoundland_Chkbx'), 30)

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/Breed/Newfoundland_Chkbx'), 5)

CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/Breed/Newfoundland_Chkbx')
