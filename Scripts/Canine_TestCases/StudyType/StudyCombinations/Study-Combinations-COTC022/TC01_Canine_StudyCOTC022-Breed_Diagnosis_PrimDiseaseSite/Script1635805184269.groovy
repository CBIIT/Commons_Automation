...
//Study IN (COTC022), Breed IN (American Staffordshire Terrier, MixedBreed) Primary Disease Site IN (Bone (Appendicular)
WebUI.closeBrowser()

CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_StudyCOTC022-Breed_Diagnosis_PrimDiseaseSite.xlsx')
