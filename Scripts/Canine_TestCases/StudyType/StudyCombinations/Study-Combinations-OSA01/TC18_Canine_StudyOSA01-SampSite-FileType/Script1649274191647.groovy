...
//Study OSA01, Sample site (Lung) and File type in (Index File)
 
'This step takes the Query from input excel and fetches data from Neo4j database. \r\nSaves the results from neo4j and application in the same name mentioned in the input excel. '
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC18_Canine_StudyOSA01-SampSite-FileType.xlsx')   //changed for OSA
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleSite/Lung_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleSite/Lung_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/SampleSite/Lung_Chkbx'), 30)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/SampleSite/Lung_Chkbx')
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn'), 5)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')

'Selects the specific check box from \'File type\' filter.'
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/FileType/IndexFile_Chkbx'), 30)
WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/FileType/IndexFile_Chkbx'), 5)
WebUI.waitForElementClickable(findTestObject('Object Repository/Canine/Filter/FileType/IndexFile_Chkbx'), 30)
CustomKeywords.'utilities.TestRunner.clickTabCanineStat'('Object Repository/Canine/Filter/FileType/IndexFile_Chkbx')

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/FileType/FILETYPE_Ddn')
