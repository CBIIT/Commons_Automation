...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC02_Canine_SampleType-WholeBlood.xlsx')   //changed for MGT
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/WholeBlood_Chkbx'), 30)  //changed for MGT

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/WholeBlood_Chkbx'), 5)  //changed for MGT

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/SampleType/WholeBlood_Chkbx') //changed for MGT
