...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC01_Canine_SampleType-PrimMaligTumTissue.xlsx')   //changed for MGT
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/PrimMaligTumTissue_Chkbx'), 30)  //changed for MGT

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/PrimMaligTumTissue_Chkbx'), 5)  //changed for MGT

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/SampleType/PrimMaligTumTissue_Chkbx') //changed for MGT
