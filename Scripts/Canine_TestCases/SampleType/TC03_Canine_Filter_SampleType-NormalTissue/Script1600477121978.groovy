...
CustomKeywords.'utilities.TestRunner.RunKatalon'('TC03_Canine_SampleType-NormalTissue.xlsx')   //changed for MGT
...
WebUI.waitForElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/NormalTissue_Chkbx'), 30)  //changed for MGT

WebUI.verifyElementPresent(findTestObject('Object Repository/Canine/Filter/SampleType/NormalTissue_Chkbx'), 5)  //changed for MGT

CustomKeywords.'utilities.TestRunner.clickTab'('Object Repository/Canine/Filter/SampleType/NormalTissue_Chkbx') //changed for MGT
