...
CustomKeywords.'utilities.CrdcDHPbac.editPbacPermissions'('Fedlead', 'positive')
...
CustomKeywords.'utilities.CrdcDH.navigateToCrdc'()
WebUI.setViewPortSize(1920, 1080)
CustomKeywords.'utilities.CrdcDH.loginToCrdcOtp'('Fedlead')

//Run verifications
CustomKeywords.'utilities.CrdcDHPbac.verifyPermissionsFunctional'('Fedlead', 'positive')
