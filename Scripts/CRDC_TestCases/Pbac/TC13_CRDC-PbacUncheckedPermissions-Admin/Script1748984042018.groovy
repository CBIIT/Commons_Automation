...
//Login as Admin
CustomKeywords.'utilities.CrdcDH.loginToCrdcOtp'('Master')
...
CustomKeywords.'utilities.CrdcDHPbac.editPbacPermissions'('Admin', 'negative')
...
//Run verifications
CustomKeywords.'utilities.CrdcDHPbac.verifyPermissionsFunctional'('Admin', 'negative')

//Reset Admin permissions to allow further runs
CustomKeywords.'utilities.CrdcDH.logoutFromCrdc'()
WebUI.closeBrowser()
CustomKeywords.'utilities.CrdcDH.navigateToCrdc'()
WebUI.setViewPortSize(1920, 1080)
