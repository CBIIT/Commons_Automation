...
CustomKeywords.'utilities.CrdcDHPbac.createDataSubmission'("CTDC")
CustomKeywords.'utilities.TestRunner.clickTab'('CRDC/DataSubmissions/DataSubmissionName-Link')

//CustomKeywords.'utilities.CrdcDHPbac.prepareUniqueMetadataAndUpload'('InputFiles/CRDC/MetadataData/program.tsv', "program_acronym")

////Upload data
//CustomKeywords.'utilities.CrdcDHPbac.prepareUniqueMetadataAndUpload'('InputFiles/CRDC/MetadataData/TC01_program .tsv', "program_acronym")
//CustomKeywords.'utilities.Utils.waitForElementToDisappear'('CRDC/DataSubmissions/Validation/Uploading-Text', 15)
////CustomKeywords.'utilities.CrdcDHPbac.prepareUniqueMetadataAndUpload'('InputFiles/CRDC/MetadataData/study.tsv', "study_id")
////CustomKeywords.'utilities.Utils.waitForElementToDisappear'('CRDC/DataSubmissions/Validation/Uploading-Text', 15)
//
...
//
//
////Verify Validation Results Tab - Default  Message
...
//WebUI.verifyElementPresent(findTestObject("CRDC/DataSubmissions/Validation/ValidationResults-DefaultMesssage"), 15, FailureHandling.OPTIONAL)
////CustomKeywords.'utilities.CrdcDHPbac.verifyValidationResultsTable'()
//
//
////Verify if submit button is enabled
//CustomKeywords.'utilities.CrdcDHPbac.verifyButtonState'('CRDC/DataSubmissions/Submit-Btn', 'ENABLE')
