...
//Upload data
CustomKeywords.'utilities.CrdcDHPbac.uploadMetadataUI'('InputFiles/CRDC/MetadataData/WarningData/TC02_W_program.tsv')
CustomKeywords.'utilities.Utils.waitForElementToDisappear'('CRDC/DataSubmissions/Validation/Uploading-Text', 15)
CustomKeywords.'utilities.CrdcDHPbac.uploadMetadataUI'('InputFiles/CRDC/MetadataData/WarningData/TC02_W_study.tsv')
CustomKeywords.'utilities.Utils.waitForElementToDisappear'('CRDC/DataSubmissions/Validation/Uploading-Text', 15)
