...
//Upload data
CustomKeywords.'utilities.CrdcDHPbac.uploadMetadataUI'('InputFiles/CRDC/MetadataData/ErrorMsgdata/TC05_program.tsv')
CustomKeywords.'utilities.Utils.waitForElementToDisappear'('CRDC/DataSubmissions/Validation/Uploading-Text', 15)
CustomKeywords.'utilities.CrdcDHPbac.uploadMetadataUI'('InputFiles/CRDC/MetadataData/ErrorMsgdata/TC05_study.tsv')
CustomKeywords.'utilities.Utils.waitForElementToDisappear'('CRDC/DataSubmissions/Validation/Uploading-Text', 15)
...
CustomKeywords.'utilities.CrdcDHPbac.verifyValidationResultsTable'("Invalid string pattern","Error")
