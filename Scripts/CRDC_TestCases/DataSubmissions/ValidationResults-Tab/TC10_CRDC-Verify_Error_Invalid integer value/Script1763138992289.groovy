...
//Upload data
CustomKeywords.'utilities.CrdcDHPbac.uploadMetadataUI'('InputFiles/CRDC/MetadataData/ErrorMsgdata/TC10_participant.tsv')
CustomKeywords.'utilities.Utils.waitForElementToDisappear'('CRDC/DataSubmissions/Validation/Uploading-Text', 15)
CustomKeywords.'utilities.CrdcDHPbac.uploadMetadataUI'('InputFiles/CRDC/MetadataData/ErrorMsgdata/TC10_diagnosis.tsv')
CustomKeywords.'utilities.Utils.waitForElementToDisappear'('CRDC/DataSubmissions/Validation/Uploading-Text', 15)
...
CustomKeywords.'utilities.CrdcDHPbac.verifyValidationResultsTable'("Invalid integer value","Error")
CustomKeywords.'utilities.CrdcDHPbac.verifyValidationResultsTable'("Related node not found","Error")
CustomKeywords.'utilities.CrdcDHPbac.verifyValidationResultsTable'("Updating existing data","Warning")
