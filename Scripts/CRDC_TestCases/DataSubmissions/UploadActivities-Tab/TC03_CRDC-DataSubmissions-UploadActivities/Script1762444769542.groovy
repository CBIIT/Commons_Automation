...
//Verify Upload Activities Tab - Uploaded & Failed 
WebUI.waitForElementClickable(findTestObject('CRDC/DataSubmissions/Validation/UploadActivities-Tab'), 30)
CustomKeywords.'utilities.TestRunner.clickTab'('CRDC/DataSubmissions/Validation/UploadActivities-Tab')
CustomKeywords.'utilities.CrdcDH.verifyDataSubmissionTableHeaders'('CRDC/DataSubmissions/Validation/UploadActivities-Tab')
WebUI.verifyElementPresent(findTestObject("CRDC/DataSubmissions/Validation/Uploaded-Text"), 15, FailureHandling.OPTIONAL)
//WebUI.verifyElementPresent(findTestObject("CRDC/DataSubmissions/Validation/UploadFailed"), 15, FailureHandling.OPTIONAL)
